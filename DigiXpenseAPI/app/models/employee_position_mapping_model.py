...
class PublicEMPEmployees(Base):
    ...
    public_EMPEmployeePositionMaping: Mapped[List['PublicEMPEmployeePositionMaping']] = relationship('PublicEMPEmployeePositionMaping', uselist=True, back_populates='public_EMPEmployees')
...
class PublicSYSUsers(Base):
    ...
    public_STPEmployeePositions: Mapped[List['PublicSTPEmployeePositions']] = relationship('PublicSTPEmployeePositions', uselist=True, foreign_keys='[PublicSTPEmployeePositions.CreatedBy]', back_populates='public_SYSUsers')
    public_STPEmployeePositions_: Mapped[List['PublicSTPEmployeePositions']] = relationship('PublicSTPEmployeePositions', uselist=True, foreign_keys='[PublicSTPEmployeePositions.ModifiedBy]', back_populates='public_SYSUsers_')
    public_EMPEmployeePositionMaping: Mapped[List['PublicEMPEmployeePositionMaping']] = relationship('PublicEMPEmployeePositionMaping', uselist=True, foreign_keys='[PublicEMPEmployeePositionMaping.CreatedBy]', back_populates='public_SYSUsers')
    public_EMPEmployeePositionMaping_: Mapped[List['PublicEMPEmployeePositionMaping']] = relationship('PublicEMPEmployeePositionMaping', uselist=True, foreign_keys='[PublicEMPEmployeePositionMaping.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPEmployeePositions: Mapped[List['PublicSTPEmployeePositions']] = relationship('PublicSTPEmployeePositions', uselist=True, foreign_keys='[PublicSTPEmployeePositions.OrganizationId]', back_populates='public_STPOrganization')
    public_STPEmployeePositions_: Mapped[List['PublicSTPEmployeePositions']] = relationship('PublicSTPEmployeePositions', uselist=True, foreign_keys='[PublicSTPEmployeePositions.SubOrganizationId]', back_populates='public_STPOrganization_')
    public_EMPEmployeePositionMaping: Mapped[List['PublicEMPEmployeePositionMaping']] = relationship('PublicEMPEmployeePositionMaping', uselist=True, foreign_keys='[PublicEMPEmployeePositionMaping.OrganizationId]', back_populates='public_STPOrganization')
    public_EMPEmployeePositionMaping_: Mapped[List['PublicEMPEmployeePositionMaping']] = relationship('PublicEMPEmployeePositionMaping', uselist=True, foreign_keys='[PublicEMPEmployeePositionMaping.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSTPEmployeePositions(Base):
    __tablename__ = 'public.STPEmployeePositions'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPEmployeePositions_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPEmployeePositions_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPEmployeePositions_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPEmployeePositions_fk3'),
        PrimaryKeyConstraint('RecId', name='STPEmployeePositions_pk'),
        UniqueConstraint('PositionId', name='public.STPEmployeePositions_PositionId_key'),
        UniqueConstraint('PositionName', name='public.STPEmployeePositions_PositionName_key'),
        Index('EmployeePositions_PositionId_index', 'PositionId', 'OrganizationId', 'SubOrganizationId')
    )

    PositionId = mapped_column(String(30), nullable=False)
    PositionName = mapped_column(String(30), nullable=False)
    PositionDescription = mapped_column(String(250), nullable=False)
    ...
    public_SYSUsers: Mapped['PublicSYSUsers'] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPEmployeePositions')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPEmployeePositions_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPEmployeePositions')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPEmployeePositions_')
    public_EMPEmployeePositionMaping: Mapped[List['PublicEMPEmployeePositionMaping']] = relationship('PublicEMPEmployeePositionMaping', uselist=True, back_populates='public_STPEmployeePositions')


class PublicEMPEmployeePositionMaping(Base):
    __tablename__ = 'public.EMPEmployeePositionMaping'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='EMPEmployeePositionMaping_fk2'),
        ForeignKeyConstraint(['EmployeeId'], ['public.EMPEmployees.Id'], name='EMPEmployeePositionMaping_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='EMPEmployeePositionMaping_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmployeePositionMaping_fk4'),
        ForeignKeyConstraint(['PositionId'], ['public.STPEmployeePositions.PositionId'], name='EMPEmployeePositionMaping_fk1'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmployeePositionMaping_fk5'),
        PrimaryKeyConstraint('RecId', name='EMPEmployeePositionMaping_pk'),
        UniqueConstraint('PositionMappingId', name='public.EMPEmployeePositionMaping_PositionMappingId_key'),
        Index('PositionMaping_EmployeeId_index', 'EmployeeId', 'OrganizationId', 'SubOrganizationId'),
        Index('PositionMaping_PositionId_index', 'PositionId', 'OrganizationId', 'SubOrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    PositionMappingId = mapped_column(String(20), server_default=text("('PM-'::text || (nextval('employeepositionmaping_id_seq'::regclass))::text)"))
    EmployeeId = mapped_column(String(20))
    PositionId = mapped_column(String(20))
    EffectiveFrom = mapped_column(Date)
    EffectiveTo = mapped_column(Date)
    CreatedBy = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_EMPEmployeePositionMaping')
    public_EMPEmployees: Mapped[Optional['PublicEMPEmployees']] = relationship('PublicEMPEmployees', back_populates='public_EMPEmployeePositionMaping')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_EMPEmployeePositionMaping_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_EMPEmployeePositionMaping')
    public_STPEmployeePositions: Mapped[Optional['PublicSTPEmployeePositions']] = relationship('PublicSTPEmployeePositions', back_populates='public_EMPEmployeePositionMaping')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_EMPEmployeePositionMaping_')
