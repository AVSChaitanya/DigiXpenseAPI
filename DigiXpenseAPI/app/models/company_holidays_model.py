...
class PublicSYSUsers(Base):
    ...
    public_STPCompanyHolidays: Mapped[List['PublicSTPCompanyHolidays']] = relationship('PublicSTPCompanyHolidays', uselist=True, foreign_keys='[PublicSTPCompanyHolidays.CreatedBy]', back_populates='public_SYSUsers')
    public_STPCompanyHolidays_: Mapped[List['PublicSTPCompanyHolidays']] = relationship('PublicSTPCompanyHolidays', uselist=True, foreign_keys='[PublicSTPCompanyHolidays.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPCompanyHolidays: Mapped[List['PublicSTPCompanyHolidays']] = relationship('PublicSTPCompanyHolidays', uselist=True, foreign_keys='[PublicSTPCompanyHolidays.OrganizationId]', back_populates='public_STPOrganization')
    public_STPCompanyHolidays_: Mapped[List['PublicSTPCompanyHolidays']] = relationship('PublicSTPCompanyHolidays', uselist=True, foreign_keys='[PublicSTPCompanyHolidays.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSTPCompanyHolidays(Base):
    __tablename__ = 'public.STPCompanyHolidays'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPCompanyHolidays_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPCompanyHolidays_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPCompanyHolidays_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPCompanyHolidays_fk3'),
        PrimaryKeyConstraint('RecId', name='STPCompanyHolidays_pk'),
        UniqueConstraint('HolidayId', name='public.STPCompanyHolidays_HolidayId_key'),
        UniqueConstraint('HolidayName', name='public.STPCompanyHolidays_HolidayName_key'),
        Index('CompanyHolidays_HolidayId_index', 'HolidayId', 'OrganizationId', 'SubOrganizationId')
    )

    HolidayDate = mapped_column(Date, nullable=False)
    HolidayName = mapped_column(String(30), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    HolidayId = mapped_column(String(20), server_default=text("('HOL-'::text || (nextval('companyholidays_id_seq'::regclass))::text)"))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPCompanyHolidays')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPCompanyHolidays_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPCompanyHolidays')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPCompanyHolidays_')
