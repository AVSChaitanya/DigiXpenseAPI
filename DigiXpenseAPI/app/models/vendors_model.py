...
class PublicSYSUsers(Base):
    ...
    public_STPMerchantCategory: Mapped[List['PublicSTPMerchantCategory']] = relationship('PublicSTPMerchantCategory', uselist=True, foreign_keys='[PublicSTPMerchantCategory.CreatedBy]', back_populates='public_SYSUsers')
    public_STPMerchantCategory_: Mapped[List['PublicSTPMerchantCategory']] = relationship('PublicSTPMerchantCategory', uselist=True, foreign_keys='[PublicSTPMerchantCategory.ModifiedBy]', back_populates='public_SYSUsers_')
    public_STPMerchantGroup: Mapped[List['PublicSTPMerchantGroup']] = relationship('PublicSTPMerchantGroup', uselist=True, foreign_keys='[PublicSTPMerchantGroup.CreatedBy]', back_populates='public_SYSUsers')
    public_STPMerchantGroup_: Mapped[List['PublicSTPMerchantGroup']] = relationship('PublicSTPMerchantGroup', uselist=True, foreign_keys='[PublicSTPMerchantGroup.ModifiedBy]', back_populates='public_SYSUsers_')
    ...
    public_STPVendors: Mapped[List['PublicSTPVendors']] = relationship('PublicSTPVendors', uselist=True, foreign_keys='[PublicSTPVendors.CreatedBy]', back_populates='public_SYSUsers')
    public_STPVendors_: Mapped[List['PublicSTPVendors']] = relationship('PublicSTPVendors', uselist=True, foreign_keys='[PublicSTPVendors.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPMerchantCategory: Mapped[List['PublicSTPMerchantCategory']] = relationship('PublicSTPMerchantCategory', uselist=True, foreign_keys='[PublicSTPMerchantCategory.OrganizationId]', back_populates='public_STPOrganization')
    public_STPMerchantCategory_: Mapped[List['PublicSTPMerchantCategory']] = relationship('PublicSTPMerchantCategory', uselist=True, foreign_keys='[PublicSTPMerchantCategory.SubOrganizationId]', back_populates='public_STPOrganization_')
    public_STPMerchantGroup: Mapped[List['PublicSTPMerchantGroup']] = relationship('PublicSTPMerchantGroup', uselist=True, foreign_keys='[PublicSTPMerchantGroup.OrganizationId]', back_populates='public_STPOrganization')
    public_STPMerchantGroup_: Mapped[List['PublicSTPMerchantGroup']] = relationship('PublicSTPMerchantGroup', uselist=True, foreign_keys='[PublicSTPMerchantGroup.SubOrganizationId]', back_populates='public_STPOrganization_')
    ...
    public_STPVendors: Mapped[List['PublicSTPVendors']] = relationship('PublicSTPVendors', uselist=True, foreign_keys='[PublicSTPVendors.OrganizationId]', back_populates='public_STPOrganization')
    public_STPVendors_: Mapped[List['PublicSTPVendors']] = relationship('PublicSTPVendors', uselist=True, foreign_keys='[PublicSTPVendors.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicSTPMerchantCategory(Base):
    __tablename__ = 'public.STPMerchantCategory'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPMerchantCategory_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPMerchantCategory_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPMerchantCategory_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPMerchantCategory_fk3'),
        PrimaryKeyConstraint('RecId', name='STPMerchantCategory_pk'),
        UniqueConstraint('MerchantCategoryId', name='public.STPMerchantCategory_MerchantCategoryId_key'),
        UniqueConstraint('MerchantCategoryName', name='public.STPMerchantCategory_MerchantCategoryName_key'),
        Index('Merchant_MerchantCategoryId_index', 'MerchantCategoryId', 'OrganizationId', 'SubOrganizationId')
    )

    MerchantCategoryId = mapped_column(String(20), nullable=False)
    MerchantCategoryName = mapped_column(String(30), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    MerchantCategoryDescription = mapped_column(String(40))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPMerchantCategory')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPMerchantCategory_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPMerchantCategory')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPMerchantCategory_')
    public_STPMerchants: Mapped[List['PublicSTPMerchants']] = relationship('PublicSTPMerchants', uselist=True, back_populates='public_STPMerchantCategory')
    public_STPVendors: Mapped[List['PublicSTPVendors']] = relationship('PublicSTPVendors', uselist=True, back_populates='public_STPMerchantCategory')


class PublicSTPMerchantGroup(Base):
    __tablename__ = 'public.STPMerchantGroup'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPMerchantGroup_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPMerchantGroup_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPMerchantGroup_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPMerchantGroup_fk3'),
        PrimaryKeyConstraint('RecId', name='STPMerchantGroup_pk'),
        UniqueConstraint('MerchantGroupId', name='public.STPMerchantGroup_MerchantGroupId_key'),
        UniqueConstraint('MerchantGroupName', name='public.STPMerchantGroup_MerchantGroupName_key'),
        Index('Merchant_MerchantGroupId_index', 'MerchantGroupId', 'OrganizationId', 'SubOrganizationId')
    )

    MerchantGroupId = mapped_column(String(30), nullable=False)
    MerchantGroupName = mapped_column(String(30), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    MerchantGroupDescription = mapped_column(String(40))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPMerchantGroup')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPMerchantGroup_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPMerchantGroup')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPMerchantGroup_')
    public_STPMerchants: Mapped[List['PublicSTPMerchants']] = relationship('PublicSTPMerchants', uselist=True, back_populates='public_STPMerchantGroup')
    public_STPVendors: Mapped[List['PublicSTPVendors']] = relationship('PublicSTPVendors', uselist=True, back_populates='public_STPMerchantGroup')
...
class PublicEXPExpenseCategory(Base):
    ...
    public_STPMerchants: Mapped[List['PublicSTPMerchants']] = relationship('PublicSTPMerchants', uselist=True, back_populates='public_EXPExpenseCategory')
    public_STPVendors: Mapped[List['PublicSTPVendors']] = relationship('PublicSTPVendors', uselist=True, back_populates='public_EXPExpenseCategory')


class PublicSTPMerchants(Base):
    __tablename__ = 'public.STPMerchants'
    __table_args__ = (
        ForeignKeyConstraint(['ExpenseCategoryId'], ['public.EXPExpenseCategory.CategoryId'], name='STPMerchants_fk3'),
        ForeignKeyConstraint(['MerchantCategoryId'], ['public.STPMerchantCategory.MerchantCategoryId'], name='STPMerchants_fk2'),
        ForeignKeyConstraint(['MerchantGroupId'], ['public.STPMerchantGroup.MerchantGroupId'], name='STPMerchants_fk1'),
        PrimaryKeyConstraint('RecId', name='STPMerchants_pk'),
        UniqueConstraint('MerchantId', name='public.STPMerchants_MerchantId_key')
    )

    MerchantId = mapped_column(String(20), nullable=False)
    RecId = mapped_column(Integer)
    MerchantNames = mapped_column(String(30))
    MerchantGroupId = mapped_column(String(20))
    MerchantCategoryId = mapped_column(String(60))
    ExpenseCategoryId = mapped_column(String(60))
    ContactName = mapped_column(String(120))
    Email = mapped_column(String(100))
    ContactNumber = mapped_column(String(20))
    AddressLine1 = mapped_column(String(300))
    AddressLine2 = mapped_column(String(300))
    City = mapped_column(String(30))
    State = mapped_column(String(30))
    PostalCode = mapped_column(String(15))
    Country = mapped_column(String(30))
    TaxNumber = mapped_column(String(50))
    PaymentTerms = mapped_column(String(50))
    Notes = mapped_column(String(250))
    IsActive = mapped_column(Boolean, server_default=text('true'))

    public_EXPExpenseCategory: Mapped[Optional['PublicEXPExpenseCategory']] = relationship('PublicEXPExpenseCategory', back_populates='public_STPMerchants')
    public_STPMerchantCategory: Mapped[Optional['PublicSTPMerchantCategory']] = relationship('PublicSTPMerchantCategory', back_populates='public_STPMerchants')
    public_STPMerchantGroup: Mapped[Optional['PublicSTPMerchantGroup']] = relationship('PublicSTPMerchantGroup', back_populates='public_STPMerchants')
    public_STPVendors: Mapped[List['PublicSTPVendors']] = relationship('PublicSTPVendors', uselist=True, back_populates='public_STPMerchants')


class PublicSTPVendors(Base):
    __tablename__ = 'public.STPVendors'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPVendors_fk3'),
        ForeignKeyConstraint(['ExpenseCategoryId'], ['public.EXPExpenseCategory.CategoryId'], name='STPVendors_fk2'),
        ForeignKeyConstraint(['Group'], ['public.STPMerchantGroup.MerchantGroupId'], name='STPVendors_fk0'),
        ForeignKeyConstraint(['Id'], ['public.STPMerchants.MerchantId'], name='STPVendors_fk7'),
        ForeignKeyConstraint(['MerchantCategoryId'], ['public.STPMerchantCategory.MerchantCategoryId'], name='STPVendors_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPVendors_fk4'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPVendors_fk5'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPVendors_fk6'),
        PrimaryKeyConstraint('RecId', name='STPVendors_pk'),
        UniqueConstraint('TaxNumber', name='public.STPVendors_TaxNumber_key'),
        Index('Vendors_Id_index', 'Id', 'OrganizationId', 'SubOrganizationId')
    )

    Name = mapped_column(String(20), nullable=False)
    City = mapped_column(String(30), nullable=False)
    Country = mapped_column(String(30), nullable=False)
    TaxNumber = mapped_column(String(50), nullable=False)
    RecId = mapped_column(Integer)
    Id = mapped_column(String(20), nullable=False, server_default=text("'1'::character varying"))
    Group = mapped_column(String(20))
    MerchantCategoryId = mapped_column(String(60))
    ExpenseCategoryId = mapped_column(String(60))
    ContactName = mapped_column(String(20))
    ...
    PostalCode = mapped_column(String(15))
    PaymentTerms = mapped_column(String(50))
    Notes = mapped_column(String(100))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPVendors')
    public_EXPExpenseCategory: Mapped[Optional['PublicEXPExpenseCategory']] = relationship('PublicEXPExpenseCategory', back_populates='public_STPVendors')
    public_STPMerchantGroup: Mapped[Optional['PublicSTPMerchantGroup']] = relationship('PublicSTPMerchantGroup', back_populates='public_STPVendors')
    public_STPMerchants: Mapped['PublicSTPMerchants'] = relationship('PublicSTPMerchants', back_populates='public_STPVendors')
    public_STPMerchantCategory: Mapped[Optional['PublicSTPMerchantCategory']] = relationship('PublicSTPMerchantCategory', back_populates='public_STPVendors')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPVendors_')
    public_STPOrganization: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPVendors')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPVendors_')
