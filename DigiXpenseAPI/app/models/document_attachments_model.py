...
class PublicSYSUsers(Base):
    ...
    public_SYSStorageProviders: Mapped[List['PublicSYSStorageProviders']] = relationship('PublicSYSStorageProviders', uselist=True, foreign_keys='[PublicSYSStorageProviders.CreatedBy]', back_populates='public_SYSUsers')
    public_SYSStorageProviders_: Mapped[List['PublicSYSStorageProviders']] = relationship('PublicSYSStorageProviders', uselist=True, foreign_keys='[PublicSYSStorageProviders.ModifiedBy]', back_populates='public_SYSUsers_')
    public_SYSDocumentAttachments: Mapped[List['PublicSYSDocumentAttachments']] = relationship('PublicSYSDocumentAttachments', uselist=True, foreign_keys='[PublicSYSDocumentAttachments.CreatedBy]', back_populates='public_SYSUsers')
    public_SYSDocumentAttachments_: Mapped[List['PublicSYSDocumentAttachments']] = relationship('PublicSYSDocumentAttachments', uselist=True, foreign_keys='[PublicSYSDocumentAttachments.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_SYSStorageProviders: Mapped[List['PublicSYSStorageProviders']] = relationship('PublicSYSStorageProviders', uselist=True, foreign_keys='[PublicSYSStorageProviders.OrganizationId]', back_populates='public_STPOrganization')
    public_SYSStorageProviders_: Mapped[List['PublicSYSStorageProviders']] = relationship('PublicSYSStorageProviders', uselist=True, foreign_keys='[PublicSYSStorageProviders.SubOrganizationId]', back_populates='public_STPOrganization_')
    public_SYSDocumentAttachments: Mapped['PublicSYSDocumentAttachments'] = relationship('PublicSYSDocumentAttachments', uselist=False, foreign_keys='[PublicSYSDocumentAttachments.OrgId]', back_populates='public_STPOrganization')
    public_SYSDocumentAttachments_: Mapped[List['PublicSYSDocumentAttachments']] = relationship('PublicSYSDocumentAttachments', uselist=True, foreign_keys='[PublicSYSDocumentAttachments.OrganizationId]', back_populates='public_STPOrganization_')
    public_SYSDocumentAttachments1: Mapped[List['PublicSYSDocumentAttachments']] = relationship('PublicSYSDocumentAttachments', uselist=True, foreign_keys='[PublicSYSDocumentAttachments.SubOrganizationId]', back_populates='public_STPOrganization1')


class PublicSYSStorageProviders(Base):
    __tablename__ = 'public.SYSStorageProviders'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='StorageProviders_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='StorageProviders_fk2'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='StorageProviders_fk3'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='StorageProviders_fk4'),
        PrimaryKeyConstraint('RecId', name='StorageProviders_pk'),
        UniqueConstraint('ProviderId', name='unique_provider_id')
    )
    ...
    EffectiveFrom = mapped_column(Date)
    EffectiveTo = mapped_column(Date)
    MaxFileSize = mapped_column(Integer)
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ...
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_SYSStorageProviders')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_SYSStorageProviders_')
    public_SYSDocumentAttachments: Mapped['PublicSYSDocumentAttachments'] = relationship('PublicSYSDocumentAttachments', uselist=False, back_populates='public_SYSStorageProviders')


class PublicSYSDocumentAttachments(Base):
    __tablename__ = 'public.SYSDocumentAttachments'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='SYSDocumentAttachments_fk5'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='SYSDocumentAttachments_fk2'),
        ForeignKeyConstraint(['OrgId'], ['public.STPOrganization.OrganizationId'], name='SYSDocumentAttachments_fk0'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSDocumentAttachments_fk3'),
        ForeignKeyConstraint(['ProviderId'], ['public.SYSStorageProviders.ProviderId'], name='SYSDocumentAttachments_fk1'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSDocumentAttachments_fk4'),
        PrimaryKeyConstraint('RecId', name='SYSDocumentAttachments_pk'),
        UniqueConstraint('DocumentId', name='public.SYSDocumentAttachments_DocumentId_key'),
        UniqueConstraint('OrgId', name='public.SYSDocumentAttachments_OrgId_key'),
        UniqueConstraint('ProviderId', name='public.SYSDocumentAttachments_ProviderId_key')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    DocumentId = mapped_column(String(20), server_default=text("('DOC-'::text || (nextval('document_id_seq'::regclass))::text)"))
    OrgId = mapped_column(Integer)
    ProviderId = mapped_column(String(20))
    DocumentPath = mapped_column(String(400))
    DocumentType = mapped_column(Enum('Expense', 'Payment', 'Others', name='documenttype'))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_SYSDocumentAttachments')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_SYSDocumentAttachments_')
    public_STPOrganization: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[OrgId], back_populates='public_SYSDocumentAttachments')
    public_STPOrganization_: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_SYSDocumentAttachments_')
    public_SYSStorageProviders: Mapped[Optional['PublicSYSStorageProviders']] = relationship('PublicSYSStorageProviders', back_populates='public_SYSDocumentAttachments')
    public_STPOrganization1: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_SYSDocumentAttachments1')
