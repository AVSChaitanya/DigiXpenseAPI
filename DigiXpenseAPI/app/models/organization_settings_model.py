...
class PublicSTPLanguageGlobal(Base):
    ...
    public_STPOrganizationSettings: Mapped[List['PublicSTPOrganizationSettings']] = relationship('PublicSTPOrganizationSettings', uselist=True, back_populates='public_STPLanguageGlobal')
...
class PublicSTPTimezones(Base):
    ...
    public_STPOrganizationSettings: Mapped[List['PublicSTPOrganizationSettings']] = relationship('PublicSTPOrganizationSettings', uselist=True, back_populates='public_STPTimezones')
...
class PublicSYSUsers(Base):
    ...
    public_EXPExchangeRateProviders: Mapped[List['PublicEXPExchangeRateProviders']] = relationship('PublicEXPExchangeRateProviders', uselist=True, foreign_keys='[PublicEXPExchangeRateProviders.CreatedBy]', back_populates='public_SYSUsers')
    public_EXPExchangeRateProviders_: Mapped[List['PublicEXPExchangeRateProviders']] = relationship('PublicEXPExchangeRateProviders', uselist=True, foreign_keys='[PublicEXPExchangeRateProviders.ModifiedBy]', back_populates='public_SYSUsers_')
    ...
    public_TAXTaxGroups: Mapped[List['PublicTAXTaxGroups']] = relationship('PublicTAXTaxGroups', uselist=True, foreign_keys='[PublicTAXTaxGroups.CreatedBy]', back_populates='public_SYSUsers')
    public_TAXTaxGroups_: Mapped[List['PublicTAXTaxGroups']] = relationship('PublicTAXTaxGroups', uselist=True, foreign_keys='[PublicTAXTaxGroups.ModifiedBy]', back_populates='public_SYSUsers_')
    ...
    public_STPOrganizationSettings: Mapped[List['PublicSTPOrganizationSettings']] = relationship('PublicSTPOrganizationSettings', uselist=True, foreign_keys='[PublicSTPOrganizationSettings.CreatedBy]', back_populates='public_SYSUsers')
    public_STPOrganizationSettings_: Mapped[List['PublicSTPOrganizationSettings']] = relationship('PublicSTPOrganizationSettings', uselist=True, foreign_keys='[PublicSTPOrganizationSettings.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPCountries(Base):
    ...
    public_TAXTaxGroups: Mapped[List['PublicTAXTaxGroups']] = relationship('PublicTAXTaxGroups', uselist=True, back_populates='public_STPCountries')
...
class PublicSTPOrganization(Base):
    ...
    public_EXPExchangeRateProviders: Mapped[List['PublicEXPExchangeRateProviders']] = relationship('PublicEXPExchangeRateProviders', uselist=True, foreign_keys='[PublicEXPExchangeRateProviders.OrganizationId]', back_populates='public_STPOrganization')
    public_EXPExchangeRateProviders_: Mapped[List['PublicEXPExchangeRateProviders']] = relationship('PublicEXPExchangeRateProviders', uselist=True, foreign_keys='[PublicEXPExchangeRateProviders.SubOrganizationId]', back_populates='public_STPOrganization_')
    ...
    public_TAXTaxGroups: Mapped[List['PublicTAXTaxGroups']] = relationship('PublicTAXTaxGroups', uselist=True, foreign_keys='[PublicTAXTaxGroups.OrganizationId]', back_populates='public_STPOrganization')
    public_TAXTaxGroups_: Mapped[List['PublicTAXTaxGroups']] = relationship('PublicTAXTaxGroups', uselist=True, foreign_keys='[PublicTAXTaxGroups.SubOrganizationId]', back_populates='public_STPOrganization_')
    ...
    public_STPOrganizationSettings: Mapped[List['PublicSTPOrganizationSettings']] = relationship('PublicSTPOrganizationSettings', uselist=True, foreign_keys='[PublicSTPOrganizationSettings.OrgId]', back_populates='public_STPOrganization')
    public_STPOrganizationSettings_: Mapped[List['PublicSTPOrganizationSettings']] = relationship('PublicSTPOrganizationSettings', uselist=True, foreign_keys='[PublicSTPOrganizationSettings.OrganizationId]', back_populates='public_STPOrganization_')
    public_STPOrganizationSettings1: Mapped[List['PublicSTPOrganizationSettings']] = relationship('PublicSTPOrganizationSettings', uselist=True, foreign_keys='[PublicSTPOrganizationSettings.SubOrganizationId]', back_populates='public_STPOrganization1')


class PublicEXPExchangeRateProviders(Base):
    __tablename__ = 'public.EXPExchangeRateProviders'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='EXPExchangeRateProviders_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='EXPExchangeRateProviders_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='EXPExchangeRateProviders_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='EXPExchangeRateProviders_fk3'),
        PrimaryKeyConstraint('RecId', name='EXPExchangeRateProviders_pk'),
        UniqueConstraint('Providerid', name='public.EXPExchangeRateProviders_Providerid_key'),
        Index('Providers_Provider_index', 'Provider', 'OrganizationId', 'SubOrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    Providerid = mapped_column(String(20), server_default=text("('PROV-'::text || (nextval('exchangerateproviders_id_seq'::regclass))::text)"))
    Provider = mapped_column(String(225))
    ProviderURL = mapped_column(String(225))
    CreatedDatetime = mapped_column(DateTime)
    ModifiedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedBy = mapped_column(String(20))
    IsActive = mapped_column(Boolean, server_default=text('true'))
    SubOrganizationId = mapped_column(Integer)
    ProviderType = mapped_column(Enum('Manual', 'Open Exchange API', 'Banks', name='providertype'))

    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_EXPExchangeRateProviders')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_EXPExchangeRateProviders_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_EXPExchangeRateProviders')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_EXPExchangeRateProviders_')
    public_STPOrganizationSettings: Mapped[List['PublicSTPOrganizationSettings']] = relationship('PublicSTPOrganizationSettings', uselist=True, back_populates='public_EXPExchangeRateProviders')
...
class PublicTAXTaxGroups(Base):
    __tablename__ = 'public.TAXTaxGroups'
    __table_args__ = (
        ForeignKeyConstraint(['Country'], ['public.STPCountries.CountryId'], name='TAXTaxGroups_fk0'),
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='TAXTaxGroups_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='TAXTaxGroups_fk2'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='TAXTaxGroups_fk3'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='TAXTaxGroups_fk4'),
        PrimaryKeyConstraint('RecId', name='TAXTaxGroups_pk'),
        UniqueConstraint('TaxGroup', name='public.TAXTaxGroups_TaxGroup_key'),
        UniqueConstraint('TaxGroupId', name='public.TAXTaxGroups_TaxGroupId_key')
    )
    ...
    public_STPCountries: Mapped['PublicSTPCountries'] = relationship('PublicSTPCountries', back_populates='public_TAXTaxGroups')
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_TAXTaxGroups')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_TAXTaxGroups_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_TAXTaxGroups')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_TAXTaxGroups_')
    public_STPOrganizationSettings: Mapped[List['PublicSTPOrganizationSettings']] = relationship('PublicSTPOrganizationSettings', uselist=True, back_populates='public_TAXTaxGroups')
...
class PublicSTPPaymentMethod(Base):
    ...
    public_STPOrganizationSettings: Mapped[List['PublicSTPOrganizationSettings']] = relationship('PublicSTPOrganizationSettings', uselist=True, back_populates='public_STPPaymentMethod')


class PublicSTPOrganizationSettings(Base):
    __tablename__ = 'public.STPOrganizationSettings'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPOrganizationSettings_fk9'),
        ForeignKeyConstraint(['DefaultLanguageId'], ['public.STPLanguageGlobal.LanguageId'], name='STPOrganizationSettings_fk4'),
        ForeignKeyConstraint(['DefaultPaymentMethodId'], ['public.STPPaymentMethod.PaymentMethodId'], name='STPOrganizationSettings_fk5'),
        ForeignKeyConstraint(['DefaultTimeZone'], ['public.STPTimezones.TimezoneId'], name='STPOrganizationSettings_fk3'),
        ForeignKeyConstraint(['ExchangeRateProvider'], ['public.EXPExchangeRateProviders.Providerid'], name='STPOrganizationSettings_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPOrganizationSettings_fk10'),
        ForeignKeyConstraint(['OrgId'], ['public.STPOrganization.OrganizationId'], name='STPOrganizationSettings_fk0'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPOrganizationSettings_fk7'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPOrganizationSettings_fk8'),
        ForeignKeyConstraint(['TaxGroupId'], ['public.TAXTaxGroups.TaxGroupId'], name='STPOrganizationSettings_fk6'),
        PrimaryKeyConstraint('RecId', name='STPOrganizationSettings_pk'),
        Index('OrganizationSettings_OrgId_index', 'OrgId', 'OrganizationId', 'SubOrganizationId')
    )

    OrgId = mapped_column(Integer, nullable=False)
    TaxGroupId = mapped_column(String(20), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    FiscalYear = mapped_column(Enum('JAN-DEC', 'FEB-JAN', 'MAR-FEB', 'APR-MAR', 'MAY-APR', 'APR-MAY', 'MAY-JUN', 'JUN-JUL', 'JUL-AUG', 'AUG-SEP', 'SEP-OCT', 'OCT-NOV', 'NOV-DEC', 'DEC-JAN', name='globalfiscalyearid'))
    DefaultTimeZone = mapped_column(String(20))
    DefaultLanguageId = mapped_column(String(20))
    DecimalSeperator = mapped_column(Enum('.', ',', name='decimalseperator'))
    RoundingMethod = mapped_column(Enum('Normal', 'Upward', 'Downward', name='roundingmethod'))
    DecimalPlace = mapped_column(Enum('0', '1', '2', '3', '4', '5', '6', name='decimalplace'))
    AllowDomains = mapped_column(String(500))
    EnableProject = mapped_column(Boolean, server_default=text('true'))
    NumberOfDecimal = mapped_column(Integer)
    ShowAnalyticsOnList = mapped_column(Boolean, server_default=text('true'))
    DefaultPaymentMethodId = mapped_column(String(20))
    AllowThemesSettings = mapped_column(Boolean, server_default=text('true'))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    IsActive = mapped_column(Boolean, server_default=text('true'))
    SubOrganizationId = mapped_column(Integer)
    ExchangeRateProvider = mapped_column(String(20))
    DefaultDateFormat = mapped_column(Enum('mm/dd/yyyy', 'dd/mm/yyyy', 'yyyy/mm/dd', 'mm-dd-yyyy', 'dd-mm-yyyy', 'yyyy-mm-dd', 'mm.dd.yyyy', 'dd.mm.yyyy', 'yyyy.mm.dd', 'MM/dd/yyyy', 'dd/MM/yyyy', 'yyyy/MM/dd', 'MM-dd-yyyy', 'dd-MM-yyyy', 'yyyy-MM-dd', 'MM.dd.yyyy', 'dd.MM.yyyy', 'yyyy.MM.dd', name='defaultdateformat'))

    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPOrganizationSettings')
    public_STPLanguageGlobal: Mapped[Optional['PublicSTPLanguageGlobal']] = relationship('PublicSTPLanguageGlobal', back_populates='public_STPOrganizationSettings')
    public_STPPaymentMethod: Mapped[Optional['PublicSTPPaymentMethod']] = relationship('PublicSTPPaymentMethod', back_populates='public_STPOrganizationSettings')
    public_STPTimezones: Mapped[Optional['PublicSTPTimezones']] = relationship('PublicSTPTimezones', back_populates='public_STPOrganizationSettings')
    public_EXPExchangeRateProviders: Mapped[Optional['PublicEXPExchangeRateProviders']] = relationship('PublicEXPExchangeRateProviders', back_populates='public_STPOrganizationSettings')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPOrganizationSettings_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrgId], back_populates='public_STPOrganizationSettings')
    public_STPOrganization_: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPOrganizationSettings_')
    public_STPOrganization1: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPOrganizationSettings1')
    public_TAXTaxGroups: Mapped['PublicTAXTaxGroups'] = relationship('PublicTAXTaxGroups', back_populates='public_STPOrganizationSettings')
