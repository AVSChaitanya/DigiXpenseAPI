...
class PublicSYSUsers(Base):
    ...
    public_STPOrgNotificationTypes: Mapped[List['PublicSTPOrgNotificationTypes']] = relationship('PublicSTPOrgNotificationTypes', uselist=True, foreign_keys='[PublicSTPOrgNotificationTypes.CreatedBy]', back_populates='public_SYSUsers')
    public_STPOrgNotificationTypes_: Mapped[List['PublicSTPOrgNotificationTypes']] = relationship('PublicSTPOrgNotificationTypes', uselist=True, foreign_keys='[PublicSTPOrgNotificationTypes.ModifiedBy]', back_populates='public_SYSUsers_')
    public_STPOrgnotificationPreferences: Mapped[List['PublicSTPOrgnotificationPreferences']] = relationship('PublicSTPOrgnotificationPreferences', uselist=True, foreign_keys='[PublicSTPOrgnotificationPreferences.CreatedBy]', back_populates='public_SYSUsers')
    public_STPOrgnotificationPreferences_: Mapped[List['PublicSTPOrgnotificationPreferences']] = relationship('PublicSTPOrgnotificationPreferences', uselist=True, foreign_keys='[PublicSTPOrgnotificationPreferences.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPOrgNotificationTypes: Mapped[List['PublicSTPOrgNotificationTypes']] = relationship('PublicSTPOrgNotificationTypes', uselist=True, foreign_keys='[PublicSTPOrgNotificationTypes.OrganizationId]', back_populates='public_STPOrganization')
    public_STPOrgNotificationTypes_: Mapped[List['PublicSTPOrgNotificationTypes']] = relationship('PublicSTPOrgNotificationTypes', uselist=True, foreign_keys='[PublicSTPOrgNotificationTypes.SubOrganizationId]', back_populates='public_STPOrganization_')
    public_STPOrgnotificationPreferences: Mapped[List['PublicSTPOrgnotificationPreferences']] = relationship('PublicSTPOrgnotificationPreferences', uselist=True, foreign_keys='[PublicSTPOrgnotificationPreferences.OrgId]', back_populates='public_STPOrganization')
    public_STPOrgnotificationPreferences_: Mapped[List['PublicSTPOrgnotificationPreferences']] = relationship('PublicSTPOrgnotificationPreferences', uselist=True, foreign_keys='[PublicSTPOrgnotificationPreferences.OrganizationId]', back_populates='public_STPOrganization_')
    public_STPOrgnotificationPreferences1: Mapped[List['PublicSTPOrgnotificationPreferences']] = relationship('PublicSTPOrgnotificationPreferences', uselist=True, foreign_keys='[PublicSTPOrgnotificationPreferences.SubOrganizationId]', back_populates='public_STPOrganization1')


class PublicSTPOrgNotificationTypes(Base):
    __tablename__ = 'public.STPOrgNotificationTypes'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPOrgNotificationTypes_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPOrgNotificationTypes_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPOrgNotificationTypes_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPOrgNotificationTypes_fk3'),
        PrimaryKeyConstraint('RecId', name='STPOrgNotificationTypes_pk'),
        UniqueConstraint('NotificationTypeId', name='public.STPOrgNotificationTypes_NotificationTypeId_key'),
        Index('NotificationTypes_Area_index', 'Area', 'OrganizationId', 'SubOrganizationId'),
        Index('NotificationTypes_NotificationTypeId_index', 'NotificationTypeId', 'OrganizationId', 'SubOrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    NotificationTypeId = mapped_column(String(20), server_default=text("('NT-'::text || (nextval('orgnotificationtypes_id_seq'::regclass))::text)"))
    Area = mapped_column(Enum('Expense Requisition', 'Travel Requisition', 'Cash Advance Requisition', name='area'))
    Context = mapped_column(String(160))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPOrgNotificationTypes')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPOrgNotificationTypes_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPOrgNotificationTypes')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPOrgNotificationTypes_')
    public_STPOrgnotificationPreferences: Mapped[List['PublicSTPOrgnotificationPreferences']] = relationship('PublicSTPOrgnotificationPreferences', uselist=True, back_populates='public_STPOrgNotificationTypes')


class PublicSTPOrgnotificationPreferences(Base):
    __tablename__ = 'public.STPOrgnotificationPreferences'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPOrgNotificationPrefferances_fk2'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPOrgNotificationPrefferances_fk3'),
        ForeignKeyConstraint(['OrgId'], ['public.STPOrganization.OrganizationId'], name='STPOrgNotificationPrefferances_fk1'),
        ForeignKeyConstraint(['OrgNotificationTypeId'], ['public.STPOrgNotificationTypes.NotificationTypeId'], name='STPOrgNotificationPrefferances_fk0'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPOrgNotificationPrefferances_fk4'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPOrgNotificationPrefferances_fk5'),
        PrimaryKeyConstraint('RecId', name='STPOrgNotificationPrefferances_pk'),
        Index('Prefferances_OrgId_index', 'OrgId', 'OrganizationId', 'SubOrganizationId'),
        Index('Prefferances_OrgNotificationTypeId_index', 'OrgNotificationTypeId', 'OrganizationId', 'SubOrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer, Sequence('public.STPOrgnotificationPrefferances_RecId_seq'))
    OrgNotificationTypeId = mapped_column(String(20))
    OrgId = mapped_column(Integer)
    IsEnabled = mapped_column(Boolean, server_default=text('true'))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPOrgnotificationPreferences')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPOrgnotificationPreferences_')
    public_STPOrganization: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[OrgId], back_populates='public_STPOrgnotificationPreferences')
    public_STPOrgNotificationTypes: Mapped[Optional['PublicSTPOrgNotificationTypes']] = relationship('PublicSTPOrgNotificationTypes', back_populates='public_STPOrgnotificationPreferences')
    public_STPOrganization_: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPOrgnotificationPreferences_')
    public_STPOrganization1: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPOrgnotificationPreferences1')
