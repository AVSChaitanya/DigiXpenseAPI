...
class PublicSTPStates(Base):
    ...
    public_STPCities: Mapped[List['PublicSTPCities']] = relationship('PublicSTPCities', uselist=True, back_populates='public_STPStates')
...
class PublicSYSUsers(Base):
    ...
    public_STPCities: Mapped[List['PublicSTPCities']] = relationship('PublicSTPCities', uselist=True, foreign_keys='[PublicSTPCities.CreatedBy]', back_populates='public_SYSUsers')
    public_STPCities_: Mapped[List['PublicSTPCities']] = relationship('PublicSTPCities', uselist=True, foreign_keys='[PublicSTPCities.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPCities: Mapped[List['PublicSTPCities']] = relationship('PublicSTPCities', uselist=True, foreign_keys='[PublicSTPCities.OrganizationId]', back_populates='public_STPOrganization')
    public_STPCities_: Mapped[List['PublicSTPCities']] = relationship('PublicSTPCities', uselist=True, foreign_keys='[PublicSTPCities.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSTPCities(Base):
    __tablename__ = 'public.STPCities'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPCities_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPCities_fk2'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPCities_fk3'),
        ForeignKeyConstraint(['StateId'], ['public.STPStates.StateId'], name='STPCities_fk0'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPStates_fk4'),
        PrimaryKeyConstraint('RecId', name='STPCities_pk'),
        UniqueConstraint('CityId', name='public.STPCities_CityId_key'),
        UniqueConstraint('CityName', name='public.STPCities_CityName_key')
    )

    CityName = mapped_column(String(30), nullable=False)
    StateId = mapped_column(String(30), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    CityId = mapped_column(String(20), server_default=text("('CITY-'::text || (nextval('cities_id_seq'::regclass))::text)"))
    CreatedDatetime = mapped_column(DateTime)
    ModifiedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPCities')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPCities_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPCities')
    public_STPStates: Mapped['PublicSTPStates'] = relationship('PublicSTPStates', back_populates='public_STPCities')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPCities_')
