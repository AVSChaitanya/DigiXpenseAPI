...
class PublicSYSUsers(Base):
    ...
    public_STPOrganizationBranding: Mapped[List['PublicSTPOrganizationBranding']] = relationship('PublicSTPOrganizationBranding', uselist=True, foreign_keys='[PublicSTPOrganizationBranding.CreatedBy]', back_populates='public_SYSUsers')
    public_STPOrganizationBranding_: Mapped[List['PublicSTPOrganizationBranding']] = relationship('PublicSTPOrganizationBranding', uselist=True, foreign_keys='[PublicSTPOrganizationBranding.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPOrganizationBranding: Mapped[List['PublicSTPOrganizationBranding']] = relationship('PublicSTPOrganizationBranding', uselist=True, foreign_keys='[PublicSTPOrganizationBranding.OrgId]', back_populates='public_STPOrganization')
    public_STPOrganizationBranding_: Mapped[List['PublicSTPOrganizationBranding']] = relationship('PublicSTPOrganizationBranding', uselist=True, foreign_keys='[PublicSTPOrganizationBranding.OrganizationId]', back_populates='public_STPOrganization_')
    public_STPOrganizationBranding1: Mapped[List['PublicSTPOrganizationBranding']] = relationship('PublicSTPOrganizationBranding', uselist=True, foreign_keys='[PublicSTPOrganizationBranding.SubOrganizationId]', back_populates='public_STPOrganization1')


class PublicSTPOrganizationBranding(Base):
    __tablename__ = 'public.STPOrganizationBranding'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPOrgBranding_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPOrgBranding_fk1'),
        ForeignKeyConstraint(['OrgId'], ['public.STPOrganization.OrganizationId'], name='STPOrgBranding_fk4'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPOrgBranding_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPOrgBranding_fk3'),
        PrimaryKeyConstraint('RecId', name='STPOrgBranding_pk'),
        UniqueConstraint('OrganizationBrandingId', name='public.STPOrganizationBranding_OrganizationBrandingId_key'),
        Index('OrganizationBranding_OrgId_index', 'OrgId', 'OrganizationId', 'SubOrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    OrganizationBrandingId = mapped_column(String(30), server_default=text("('OB-'::text || (nextval('organizationbranding_id_seq'::regclass))::text)"))
    ThemeDirection = mapped_column(Boolean, server_default=text('true'))
    ThemeMenuType = mapped_column(Enum('Horizontal Layout', 'Vertical Layout', name='thememenutype'))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPOrganizationBranding')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPOrganizationBranding_')
    public_STPOrganization: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[OrgId], back_populates='public_STPOrganizationBranding')
    public_STPOrganization_: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPOrganizationBranding_')
    public_STPOrganization1: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPOrganizationBranding1')
