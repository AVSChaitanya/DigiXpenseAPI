...
class PublicSYSUsers(Base):
    ...
    public_STPTermsofPayments: Mapped[List['PublicSTPTermsofPayments']] = relationship('PublicSTPTermsofPayments', uselist=True, foreign_keys='[PublicSTPTermsofPayments.CreatedBy]', back_populates='public_SYSUsers')
    public_STPTermsofPayments_: Mapped[List['PublicSTPTermsofPayments']] = relationship('PublicSTPTermsofPayments', uselist=True, foreign_keys='[PublicSTPTermsofPayments.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPTermsofPayments: Mapped[List['PublicSTPTermsofPayments']] = relationship('PublicSTPTermsofPayments', uselist=True, foreign_keys='[PublicSTPTermsofPayments.OrganizationId]', back_populates='public_STPOrganization')
    public_STPTermsofPayments_: Mapped[List['PublicSTPTermsofPayments']] = relationship('PublicSTPTermsofPayments', uselist=True, foreign_keys='[PublicSTPTermsofPayments.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicSTPPaymentMethod(Base):
    ...
    public_STPTermsofPayments: Mapped[List['PublicSTPTermsofPayments']] = relationship('PublicSTPTermsofPayments', uselist=True, back_populates='public_STPPaymentMethod')


class PublicSTPTermsofPayments(Base):
    __tablename__ = 'public.STPTermsofPayments'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPTermsofPayments_fk2'),
        ForeignKeyConstraint(['DefaultPaymentMethod'], ['public.STPPaymentMethod.PaymentMethodId'], name='STPTermsofPayments_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPTermsofPayments_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPTermsofPayments_fk4'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPTermsofPayments_fk5'),
        PrimaryKeyConstraint('RecId', name='STPTermsofPayments_pk')
    )
    ...
    DefaultPaymentMethod = mapped_column(String(20))
    Months = mapped_column(Integer)
    Days = mapped_column(Integer)
    CashPayment = mapped_column(String(120))
    PaymentDay = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPTermsofPayments')
    public_STPPaymentMethod: Mapped[Optional['PublicSTPPaymentMethod']] = relationship('PublicSTPPaymentMethod', back_populates='public_STPTermsofPayments')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPTermsofPayments_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPTermsofPayments')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPTermsofPayments_')
