...
class PublicSYSUsers(Base):
    ...
    public_EXPOrgReceiptLessExpRules: Mapped[List['PublicEXPOrgReceiptLessExpRules']] = relationship('PublicEXPOrgReceiptLessExpRules', uselist=True, foreign_keys='[PublicEXPOrgReceiptLessExpRules.CreatedBy]', back_populates='public_SYSUsers')
    public_EXPOrgReceiptLessExpRules_: Mapped[List['PublicEXPOrgReceiptLessExpRules']] = relationship('PublicEXPOrgReceiptLessExpRules', uselist=True, foreign_keys='[PublicEXPOrgReceiptLessExpRules.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_EXPOrgReceiptLessExpRules: Mapped[List['PublicEXPOrgReceiptLessExpRules']] = relationship('PublicEXPOrgReceiptLessExpRules', uselist=True, foreign_keys='[PublicEXPOrgReceiptLessExpRules.OrganizationId]', back_populates='public_STPOrganization')
    public_EXPOrgReceiptLessExpRules_: Mapped[List['PublicEXPOrgReceiptLessExpRules']] = relationship('PublicEXPOrgReceiptLessExpRules', uselist=True, foreign_keys='[PublicEXPOrgReceiptLessExpRules.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicEXPExpenseCategory(Base):
    ...
    public_EXPOrgReceiptLessExpRules: Mapped[List['PublicEXPOrgReceiptLessExpRules']] = relationship('PublicEXPOrgReceiptLessExpRules', uselist=True, back_populates='public_EXPExpenseCategory')


class PublicEXPOrgReceiptLessExpRules(Base):
    __tablename__ = 'public.EXPOrgReceiptLessExpRules'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='EXPOrgReceiptLessExpRules_fk2'),
        ForeignKeyConstraint(['ExpenseCategory'], ['public.EXPExpenseCategory.CategoryId'], name='EXPOrgReceiptLessExpRules_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='EXPOrgReceiptLessExpRules_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='EXPOrgReceiptLessExpRules_fk4'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='EXPOrgReceiptLessExpRules_fk5'),
        PrimaryKeyConstraint('RecId', name='EXPOrgReceiptLessExpRules_pk'),
        UniqueConstraint('Id', name='public.EXPOrgReceiptLessExpRules_Id_key'),
        Index('OrgReceLessRules_EmployeeGrade_index', 'EmployeeGrade', 'OrganizationId', 'SubOrganizationId'),
        Index('OrgReceLessRules_ExpenseCategory_index', 'ExpenseCategory', 'OrganizationId', 'SubOrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    Id = mapped_column(String(10), server_default=text("('EORL-'::text || (nextval('orgrece_id_seq'::regclass))::text)"))
    ExpenseCategory = mapped_column(String(30))
    AmountLimit = mapped_column(Double(53))
    EmployeeGrade = mapped_column(String(30))
    ActiveFrom = mapped_column(Date)
    ActiveTo = mapped_column(Date)
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    IsActive = mapped_column(Boolean, server_default=text('true'))
    SubOrganizationId = mapped_column(Integer)
    EnableAndDisable = mapped_column(Boolean, server_default=text('true'))

    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_EXPOrgReceiptLessExpRules')
    public_EXPExpenseCategory: Mapped[Optional['PublicEXPExpenseCategory']] = relationship('PublicEXPExpenseCategory', back_populates='public_EXPOrgReceiptLessExpRules')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_EXPOrgReceiptLessExpRules_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_EXPOrgReceiptLessExpRules')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_EXPOrgReceiptLessExpRules_')
