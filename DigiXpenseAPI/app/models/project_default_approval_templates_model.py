...
class PublicSTPCompanyBranches(Base):
    ...
    public_STPProjectDefaultApprovalTemplates: Mapped[List['PublicSTPProjectDefaultApprovalTemplates']] = relationship('PublicSTPProjectDefaultApprovalTemplates', uselist=True, back_populates='public_STPCompanyBranches')
...
class PublicSYSUsers(Base):
    ...
    public_STPProjectDefaultApprovalTemplates: Mapped[List['PublicSTPProjectDefaultApprovalTemplates']] = relationship('PublicSTPProjectDefaultApprovalTemplates', uselist=True, foreign_keys='[PublicSTPProjectDefaultApprovalTemplates.CreatedBy]', back_populates='public_SYSUsers')
    public_STPProjectDefaultApprovalTemplates_: Mapped[List['PublicSTPProjectDefaultApprovalTemplates']] = relationship('PublicSTPProjectDefaultApprovalTemplates', uselist=True, foreign_keys='[PublicSTPProjectDefaultApprovalTemplates.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPProjectDefaultApprovalTemplates: Mapped[List['PublicSTPProjectDefaultApprovalTemplates']] = relationship('PublicSTPProjectDefaultApprovalTemplates', uselist=True, foreign_keys='[PublicSTPProjectDefaultApprovalTemplates.OrganizationId]', back_populates='public_STPOrganization')
    public_STPProjectDefaultApprovalTemplates_: Mapped[List['PublicSTPProjectDefaultApprovalTemplates']] = relationship('PublicSTPProjectDefaultApprovalTemplates', uselist=True, foreign_keys='[PublicSTPProjectDefaultApprovalTemplates.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicSTPProjects(Base):
    ...
    public_STPProjectDefaultApprovalTemplates: Mapped[List['PublicSTPProjectDefaultApprovalTemplates']] = relationship('PublicSTPProjectDefaultApprovalTemplates', uselist=True, back_populates='public_STPProjects')
...
class PublicEXPExpenseCategory(Base):
    ...
    public_STPProjectDefaultApprovalTemplates: Mapped[List['PublicSTPProjectDefaultApprovalTemplates']] = relationship('PublicSTPProjectDefaultApprovalTemplates', uselist=True, back_populates='public_EXPExpenseCategory')


class PublicSTPProjectDefaultApprovalTemplates(Base):
    __tablename__ = 'public.STPProjectDefaultApprovalTemplates'
    __table_args__ = (
        ForeignKeyConstraint(['Branch'], ['public.STPCompanyBranches.BranchId'], name='STPProjectDefaultApprovalTemplates_fk5'),
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPProjectDefaultApprovalTemplates_fk2'),
        ForeignKeyConstraint(['ExpenseCategoryId'], ['public.EXPExpenseCategory.CategoryId'], name='STPProjectDefaultApprovalTemplates_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPProjectDefaultApprovalTemplates_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPProjectDefaultApprovalTemplates_fk4'),
        ForeignKeyConstraint(['ProjectId'], ['public.STPProjects.ProjectId'], name='STPProjectDefaultApprovalTemplates_fk0'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPProjectDefaultApprovalTemplates_fk6'),
        PrimaryKeyConstraint('RecId', name='STPProjectDefaultApprovalTemplates_pk'),
        Index('ProjectApprovalTemp_Branch_index', 'Branch', 'OrganizationId', 'SubOrganizationId', unique=True),
        Index('ProjectApprovalTemp_ProjectId_index', 'ProjectId', 'OrganizationId', 'SubOrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    ProjectId = mapped_column(String(20))
    ExpenseApprovalTemplate = mapped_column(String(400))
    CashAdvanceApprovalTemplate = mapped_column(String(400))
    TravelRequisitionApprovalTemplate = mapped_column(String(400))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    IsActive = mapped_column(Boolean, server_default=text('true'))
    SubOrganizationId = mapped_column(Integer)
    Branch = mapped_column(String(20))
    ExpenseCategoryId = mapped_column(String(30))

    public_STPCompanyBranches: Mapped[Optional['PublicSTPCompanyBranches']] = relationship('PublicSTPCompanyBranches', back_populates='public_STPProjectDefaultApprovalTemplates')
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPProjectDefaultApprovalTemplates')
    public_EXPExpenseCategory: Mapped[Optional['PublicEXPExpenseCategory']] = relationship('PublicEXPExpenseCategory', back_populates='public_STPProjectDefaultApprovalTemplates')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPProjectDefaultApprovalTemplates_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPProjectDefaultApprovalTemplates')
    public_STPProjects: Mapped[Optional['PublicSTPProjects']] = relationship('PublicSTPProjects', back_populates='public_STPProjectDefaultApprovalTemplates')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPProjectDefaultApprovalTemplates_')
