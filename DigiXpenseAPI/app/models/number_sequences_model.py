...
class PublicSYSUsers(Base):
    ...
    public_STPNumberSequences: Mapped[List['PublicSTPNumberSequences']] = relationship('PublicSTPNumberSequences', uselist=True, foreign_keys='[PublicSTPNumberSequences.CreatedBy]', back_populates='public_SYSUsers')
    public_STPNumberSequences_: Mapped[List['PublicSTPNumberSequences']] = relationship('PublicSTPNumberSequences', uselist=True, foreign_keys='[PublicSTPNumberSequences.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPNumberSequences: Mapped[List['PublicSTPNumberSequences']] = relationship('PublicSTPNumberSequences', uselist=True, foreign_keys='[PublicSTPNumberSequences.OrganizationId]', back_populates='public_STPOrganization')
    public_STPNumberSequences_: Mapped[List['PublicSTPNumberSequences']] = relationship('PublicSTPNumberSequences', uselist=True, foreign_keys='[PublicSTPNumberSequences.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSTPNumberSequences(Base):
    __tablename__ = 'public.STPNumberSequences'
    __table_args__ = (
        ...
        PrimaryKeyConstraint('RecId', name='STPNumberSequences_pk')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    Module = mapped_column(String(120))
    Area = mapped_column(Enum('Expense Requisition', 'Travel Requisition', 'Cash Advance Requisition', name='area'))
    StartNumber = mapped_column(String(120))
    NextNumber = mapped_column(String(120))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPNumberSequences')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPNumberSequences_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPNumberSequences')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPNumberSequences_')
