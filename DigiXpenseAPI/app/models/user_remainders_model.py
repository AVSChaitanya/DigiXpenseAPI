...
from sqlalchemy import Boolean, Column, Date, DateTime, Enum, ForeignKeyConstraint, Index, Integer, Numeric, PrimaryKeyConstraint, String, Text, Time, UniqueConstraint, text
...
class PublicSYSUsers(Base):
    ...
    public_STPUserRemainders: Mapped[List['PublicSTPUserRemainders']] = relationship('PublicSTPUserRemainders', uselist=True, foreign_keys='[PublicSTPUserRemainders.CreatedBy]', back_populates='public_SYSUsers')
    public_STPUserRemainders_: Mapped[List['PublicSTPUserRemainders']] = relationship('PublicSTPUserRemainders', uselist=True, foreign_keys='[PublicSTPUserRemainders.ModifiedBy]', back_populates='public_SYSUsers_')
    public_STPUserRemainders1: Mapped[List['PublicSTPUserRemainders']] = relationship('PublicSTPUserRemainders', uselist=True, foreign_keys='[PublicSTPUserRemainders.UserId]', back_populates='public_SYSUsers1')
...
class PublicSTPOrganization(Base):
    ...
    public_STPUserRemainders: Mapped[List['PublicSTPUserRemainders']] = relationship('PublicSTPUserRemainders', uselist=True, foreign_keys='[PublicSTPUserRemainders.OrganizationId]', back_populates='public_STPOrganization')
    public_STPUserRemainders_: Mapped[List['PublicSTPUserRemainders']] = relationship('PublicSTPUserRemainders', uselist=True, foreign_keys='[PublicSTPUserRemainders.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSTPUserRemainders(Base):
    __tablename__ = 'public.STPUserRemainders'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPUserReminders_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPUserReminders_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPUserReminders_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPUserReminders_fk3'),
        ForeignKeyConstraint(['UserId'], ['public.SYSUsers.UserId'], name='STPUserReminders_fk4'),
        PrimaryKeyConstraint('RecId', name='STPUserReminders_pk'),
        UniqueConstraint('RemainderID', name='public.STPUserRemainders_RemainderID_key'),
        Index('UserRemainders_UserId_index', 'UserId', 'OrganizationId', 'SubOrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    RemainderID = mapped_column(String(20), server_default=text("('REM-'::text || (nextval('userremainders_id_seq'::regclass))::text)"))
    UserId = mapped_column(String(20))
    Remainder = mapped_column(Enum('Expense Report Submission', 'Budget Status Updates', 'Pending Reimbursements', 'Unapproved Requests', 'Overdue Approval', 'Unreported Expense', name='remainder'))
    RemainderType = mapped_column(Enum('Weekly', 'Monthly', name='remaindertype'))
    RemainderMessage = mapped_column(Text)
    WeekDay = mapped_column(Enum('Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday', 'None', name='weekday'))
    DayInMonth = mapped_column(Enum('First Day', 'Last Day', '2nd', '3rd', '4th', '5th', '6th', '7th', '8th', '9th', '10th', '11th', '12th', '13th', '14th', '15th', '16th', '17th', '18th', '19th', '20th', '21st', '22nd', '23rd', '24th', '25th', '26th', '27th', '28th', '29th', '30th', 'None', name='dayinmonth'))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPUserRemainders')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPUserRemainders_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPUserRemainders')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPUserRemainders_')
    public_SYSUsers1: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[UserId], back_populates='public_STPUserRemainders1')
