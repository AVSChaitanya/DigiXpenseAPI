...
class PublicSYSUsers(Base):
    ...
    public_SYSWorkflowTemplateTable: Mapped[List['PublicSYSWorkflowTemplateTable']] = relationship('PublicSYSWorkflowTemplateTable', uselist=True, foreign_keys='[PublicSYSWorkflowTemplateTable.CreatedBy]', back_populates='public_SYSUsers')
    public_SYSWorkflowTemplateTable_: Mapped[List['PublicSYSWorkflowTemplateTable']] = relationship('PublicSYSWorkflowTemplateTable', uselist=True, foreign_keys='[PublicSYSWorkflowTemplateTable.ModifiedBy]', back_populates='public_SYSUsers_')
    public_SYSWorkFlowTrackingTable: Mapped[List['PublicSYSWorkFlowTrackingTable']] = relationship('PublicSYSWorkFlowTrackingTable', uselist=True, foreign_keys='[PublicSYSWorkFlowTrackingTable.CreatedBy]', back_populates='public_SYSUsers')
    public_SYSWorkFlowTrackingTable_: Mapped[List['PublicSYSWorkFlowTrackingTable']] = relationship('PublicSYSWorkFlowTrackingTable', uselist=True, foreign_keys='[PublicSYSWorkFlowTrackingTable.ModifiedBy]', back_populates='public_SYSUsers_')
    public_SYSWorkFlowTrackingWorkItems: Mapped[List['PublicSYSWorkFlowTrackingWorkItems']] = relationship('PublicSYSWorkFlowTrackingWorkItems', uselist=True, foreign_keys='[PublicSYSWorkFlowTrackingWorkItems.ApproverId]', back_populates='public_SYSUsers')
    public_SYSWorkFlowTrackingWorkItems_: Mapped[List['PublicSYSWorkFlowTrackingWorkItems']] = relationship('PublicSYSWorkFlowTrackingWorkItems', uselist=True, foreign_keys='[PublicSYSWorkFlowTrackingWorkItems.CreatedBy]', back_populates='public_SYSUsers_')
    public_SYSWorkFlowTrackingWorkItems1: Mapped[List['PublicSYSWorkFlowTrackingWorkItems']] = relationship('PublicSYSWorkFlowTrackingWorkItems', uselist=True, foreign_keys='[PublicSYSWorkFlowTrackingWorkItems.ModifiedBy]', back_populates='public_SYSUsers1')
...
class PublicSTPOrganization(Base):
    ...
    public_SYSWorkflowTemplateTable: Mapped[List['PublicSYSWorkflowTemplateTable']] = relationship('PublicSYSWorkflowTemplateTable', uselist=True, foreign_keys='[PublicSYSWorkflowTemplateTable.OrganizationId]', back_populates='public_STPOrganization')
    public_SYSWorkflowTemplateTable_: Mapped[List['PublicSYSWorkflowTemplateTable']] = relationship('PublicSYSWorkflowTemplateTable', uselist=True, foreign_keys='[PublicSYSWorkflowTemplateTable.SubOrganizationId]', back_populates='public_STPOrganization_')
    public_SYSWorkFlowTrackingTable: Mapped[List['PublicSYSWorkFlowTrackingTable']] = relationship('PublicSYSWorkFlowTrackingTable', uselist=True, foreign_keys='[PublicSYSWorkFlowTrackingTable.OrganizationId]', back_populates='public_STPOrganization')
    public_SYSWorkFlowTrackingTable_: Mapped[List['PublicSYSWorkFlowTrackingTable']] = relationship('PublicSYSWorkFlowTrackingTable', uselist=True, foreign_keys='[PublicSYSWorkFlowTrackingTable.SubOrganizationId]', back_populates='public_STPOrganization_')
    public_SYSWorkFlowTrackingWorkItems: Mapped[List['PublicSYSWorkFlowTrackingWorkItems']] = relationship('PublicSYSWorkFlowTrackingWorkItems', uselist=True, foreign_keys='[PublicSYSWorkFlowTrackingWorkItems.OrganizationId]', back_populates='public_STPOrganization')
    public_SYSWorkFlowTrackingWorkItems_: Mapped[List['PublicSYSWorkFlowTrackingWorkItems']] = relationship('PublicSYSWorkFlowTrackingWorkItems', uselist=True, foreign_keys='[PublicSYSWorkFlowTrackingWorkItems.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSYSWorkflowTemplateTable(Base):
    __tablename__ = 'public.SYSWorkflowTemplateTable'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='SYSWorkflowTemplateTable-fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='SYSWorkflowTemplateTable_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSWorkflowTemplateTable_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSWorkflowTemplateTable_fk3'),
        PrimaryKeyConstraint('RecId', name='SYSWorkflowTemplateTable_pk'),
        UniqueConstraint('WorkflowId', name='public.SYSWorkflowTemplateTable_WorkflowId_key'),
        Index('WorkflowTemplate_WorkflowId_index', 'WorkflowId', 'OrganizationId', 'SubOrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    WorkflowId = mapped_column(String(20), server_default=text("('WF'::text || (nextval('workflowtemplatetable_id_seq'::regclass))::text)"))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_SYSWorkflowTemplateTable')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_SYSWorkflowTemplateTable_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_SYSWorkflowTemplateTable')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_SYSWorkflowTemplateTable_')
    public_SYSWorkFlowTrackingTable: Mapped[List['PublicSYSWorkFlowTrackingTable']] = relationship('PublicSYSWorkFlowTrackingTable', uselist=True, back_populates='public_SYSWorkflowTemplateTable')


class PublicSYSWorkFlowTrackingTable(Base):
    __tablename__ = 'public.SYSWorkFlowTrackingTable'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='SYSworkFlowTrackingTable_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='SYSworkFlowTrackingTable_fk2'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSworkFlowTrackingTable_fk3'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSworkFlowTrackingTable_fk4'),
        ForeignKeyConstraint(['WorkFlowTemplateId'], ['public.SYSWorkflowTemplateTable.WorkflowId'], name='SYSworkFlowTrackingTable_fk0'),
        PrimaryKeyConstraint('RecId', name='SYSworkFlowTrackingTable_pk'),
        UniqueConstraint('TrackingId', name='public.SYSWorkFlowTrackingTable_TrackingId_key'),
        Index('WorkFlowTracking_WorkFlowTemplateId_index', 'WorkFlowTemplateId', 'OrganizationId', 'SubOrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    TrackingId = mapped_column(String(20), server_default=text("('T'::text || (nextval('workflowtrackingtable_id_seq'::regclass))::text)"))
    TrackingContext = mapped_column(Enum('Expense Requisition', 'Cash Advance Requisition', 'Travel Requisition', name='trackingcontext'))
    ContextRcid = mapped_column(String(20))
    WorkFlowTemplateId = mapped_column(String(20))
    WorkFlowTrackingStatus = mapped_column(Enum('Created', 'In Review', 'Approved', 'Rejected', 'completed', name='workflowtrackingstatus'))
    StartDateTime = mapped_column(DateTime)
    CompletedDateTime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_SYSWorkFlowTrackingTable')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_SYSWorkFlowTrackingTable_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_SYSWorkFlowTrackingTable')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_SYSWorkFlowTrackingTable_')
    public_SYSWorkflowTemplateTable: Mapped[Optional['PublicSYSWorkflowTemplateTable']] = relationship('PublicSYSWorkflowTemplateTable', back_populates='public_SYSWorkFlowTrackingTable')
    public_SYSWorkFlowTrackingWorkItems: Mapped['PublicSYSWorkFlowTrackingWorkItems'] = relationship('PublicSYSWorkFlowTrackingWorkItems', uselist=False, back_populates='public_SYSWorkFlowTrackingTable')


class PublicSYSWorkFlowTrackingWorkItems(Base):
    __tablename__ = 'public.SYSWorkFlowTrackingWorkItems'
    __table_args__ = (
        ForeignKeyConstraint(['ApproverId'], ['public.SYSUsers.UserId'], name='SYSworkFlowTrackingWorkItems_fk1'),
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='SYSworkFlowTrackingWorkItems_fk2'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='SYSworkFlowTrackingWorkItems_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSworkFlowTrackingWorkItems_fk4'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSworkFlowTrackingWorkItems_fk5'),
        ForeignKeyConstraint(['WorkFlowTrackingId'], ['public.SYSWorkFlowTrackingTable.TrackingId'], name='SYSworkFlowTrackingWorkItems_fk0'),
        PrimaryKeyConstraint('RecId', name='SYSworkFlowTrackingWorkItems_pk'),
        UniqueConstraint('WorkFlowTrackingId', name='public.SYSWorkFlowTrackingWorkItems_WorkFlowTrackingId_key'),
        Index('WorkFlowTracking_ApproverId_index', 'ApproverId', 'OrganizationId', 'SubOrganizationId'),
        Index('WorkFlowTracking_WorkFlowTrackingId_index', 'WorkFlowTrackingId', 'OrganizationId', 'SubOrganizationId'),
        Index('WorkFlowTracking_WorkFlowTrackingWorkItemId_index', 'WorkFlowTrackingWorkItemId', 'OrganizationId', 'SubOrganizationId')
    )

    WorkFlowTrackingId = mapped_column(String(20), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    WorkFlowTrackingWorkItemId = mapped_column(String(20))
    StepId = mapped_column(Integer)
    ApproverId = mapped_column(String(20))
    WorkFlowStatus = mapped_column(Enum('Created', 'Approved', 'Rejected', 'Cancelled', 'Escalated', name='workflowstatus'))
    CreatedBy = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ApproverId], back_populates='public_SYSWorkFlowTrackingWorkItems')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_SYSWorkFlowTrackingWorkItems_')
    public_SYSUsers1: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_SYSWorkFlowTrackingWorkItems1')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_SYSWorkFlowTrackingWorkItems')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_SYSWorkFlowTrackingWorkItems_')
    public_SYSWorkFlowTrackingTable: Mapped['PublicSYSWorkFlowTrackingTable'] = relationship('PublicSYSWorkFlowTrackingTable', back_populates='public_SYSWorkFlowTrackingWorkItems')
