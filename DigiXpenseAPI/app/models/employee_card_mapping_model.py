...
class PublicEMPEmployees(Base):
    ...
    public_EMPEmployeeCardMapping: Mapped[List['PublicEMPEmployeeCardMapping']] = relationship('PublicEMPEmployeeCardMapping', uselist=True, back_populates='public_EMPEmployees')
...
class PublicSYSUsers(Base):
    ...
    public_EMPEmployeeCardMapping: Mapped[List['PublicEMPEmployeeCardMapping']] = relationship('PublicEMPEmployeeCardMapping', uselist=True, foreign_keys='[PublicEMPEmployeeCardMapping.CreatedBy]', back_populates='public_SYSUsers')
    public_EMPEmployeeCardMapping_: Mapped[List['PublicEMPEmployeeCardMapping']] = relationship('PublicEMPEmployeeCardMapping', uselist=True, foreign_keys='[PublicEMPEmployeeCardMapping.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_EMPEmployeeCardMapping: Mapped[List['PublicEMPEmployeeCardMapping']] = relationship('PublicEMPEmployeeCardMapping', uselist=True, foreign_keys='[PublicEMPEmployeeCardMapping.OrganizationId]', back_populates='public_STPOrganization')
    public_EMPEmployeeCardMapping_: Mapped[List['PublicEMPEmployeeCardMapping']] = relationship('PublicEMPEmployeeCardMapping', uselist=True, foreign_keys='[PublicEMPEmployeeCardMapping.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicSTPCards(Base):
    ...
    public_EMPEmployeeCardMapping: Mapped[List['PublicEMPEmployeeCardMapping']] = relationship('PublicEMPEmployeeCardMapping', uselist=True, back_populates='public_STPCards')


class PublicEMPEmployeeCardMapping(Base):
    __tablename__ = 'public.EMPEmployeeCardMapping'
    __table_args__ = (
        ForeignKeyConstraint(['CardId'], ['public.STPCards.CardId'], name='EMPEmployeeCardMapping_fk1'),
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='EMPEmployeeCardMapping_fk2'),
        ForeignKeyConstraint(['EmployeeId'], ['public.EMPEmployees.Id'], name='EMPEmployeeCardMapping_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='EMPEmployeeCardMapping_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmployeeCardMapping_fk4'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmployeeCardMapping_fk5'),
        PrimaryKeyConstraint('RecId', name='EMPEmployeeCardMapping_pk'),
        UniqueConstraint('CardMappingId', name='public.EMPEmployeeCardMapping_CardMappingId_key'),
        Index('CardMapping_CardId_index', 'CardId', 'OrganizationId', 'SubOrganizationId'),
        Index('CardMapping_EmployeeId_index', 'EmployeeId', 'OrganizationId', 'SubOrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    CardMappingId = mapped_column(String(20), server_default=text("('CM-'::text || (nextval('employeecardmapping_id_seq'::regclass))::text)"))
    EmployeeId = mapped_column(String(20))
    CardId = mapped_column(String(20))
    MappingType = mapped_column(String(30))
    EffectiveFrom = mapped_column(Date)
    EffectiveTo = mapped_column(Date)
    CreatedBy = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    ...
    public_STPCards: Mapped[Optional['PublicSTPCards']] = relationship('PublicSTPCards', back_populates='public_EMPEmployeeCardMapping')
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_EMPEmployeeCardMapping')
    public_EMPEmployees: Mapped[Optional['PublicEMPEmployees']] = relationship('PublicEMPEmployees', back_populates='public_EMPEmployeeCardMapping')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_EMPEmployeeCardMapping_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_EMPEmployeeCardMapping')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_EMPEmployeeCardMapping_')
