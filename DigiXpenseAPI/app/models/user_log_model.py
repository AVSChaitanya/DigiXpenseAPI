...
class PublicSYSUsers(Base):
    ...
    public_STPUserLog: Mapped[List['PublicSTPUserLog']] = relationship('PublicSTPUserLog', uselist=True, foreign_keys='[PublicSTPUserLog.CreatedBy]', back_populates='public_SYSUsers')
    public_STPUserLog_: Mapped[List['PublicSTPUserLog']] = relationship('PublicSTPUserLog', uselist=True, foreign_keys='[PublicSTPUserLog.ModifiedBy]', back_populates='public_SYSUsers_')
    public_STPUserLog1: Mapped[List['PublicSTPUserLog']] = relationship('PublicSTPUserLog', uselist=True, foreign_keys='[PublicSTPUserLog.UserId]', back_populates='public_SYSUsers1')
...
class PublicSTPOrganization(Base):
    ...
    public_STPUserLog: Mapped[List['PublicSTPUserLog']] = relationship('PublicSTPUserLog', uselist=True, foreign_keys='[PublicSTPUserLog.OrganizationId]', back_populates='public_STPOrganization')
    public_STPUserLog_: Mapped[List['PublicSTPUserLog']] = relationship('PublicSTPUserLog', uselist=True, foreign_keys='[PublicSTPUserLog.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSTPUserLog(Base):
    __tablename__ = 'public.STPUserLog'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPUserLog_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPUserLog_fk2'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPUserLog_fk3'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPUserLog_fk4'),
        ForeignKeyConstraint(['UserId'], ['public.SYSUsers.UserId'], name='STPUserLog_fk0'),
        PrimaryKeyConstraint('RecId', name='STPUserLog_pk'),
        UniqueConstraint('LogId', name='public.STPUserLog_LogId_key'),
        Index('UserLog_UserId_index', 'UserId', 'OrganizationId', 'SubOrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    LogId = mapped_column(String(20), server_default=text("('LI-'::text || (nextval('userlog_id_seq'::regclass))::text)"))
    UserId = mapped_column(String(20))
    IPAddress = mapped_column(String(500))
    LoginType = mapped_column(Enum('System', 'User', name='logintype'))
    TokenExpiryDateTime = mapped_column(DateTime)
    ...
    ModifiedBy = mapped_column(String(20))
    SubOrganizationId = mapped_column(Integer)
    TokenPurpose = mapped_column(String(60))
    LoginDateTime = mapped_column(DateTime)
    JWTToken = mapped_column(Text)

    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPUserLog')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPUserLog_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPUserLog')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPUserLog_')
    public_SYSUsers1: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[UserId], back_populates='public_STPUserLog1')
