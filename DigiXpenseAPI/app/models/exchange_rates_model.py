...
class PublicSTPGlobalCurrency(Base):
    ...
    public_FINExchangeRates: Mapped[List['PublicFINExchangeRates']] = relationship('PublicFINExchangeRates', uselist=True, foreign_keys='[PublicFINExchangeRates.FromCurrency]', back_populates='public_STPGlobalCurrency')
    public_FINExchangeRates_: Mapped[List['PublicFINExchangeRates']] = relationship('PublicFINExchangeRates', uselist=True, foreign_keys='[PublicFINExchangeRates.ToCurrency]', back_populates='public_STPGlobalCurrency_')
    public_FINExchangeRates1: Mapped[List['PublicFINExchangeRates']] = relationship('PublicFINExchangeRates', uselist=True, foreign_keys='[PublicFINExchangeRates.TriangulationCurrency]', back_populates='public_STPGlobalCurrency1')
...
class PublicSYSUsers(Base):
    ...
    public_FINExchangeRates: Mapped[List['PublicFINExchangeRates']] = relationship('PublicFINExchangeRates', uselist=True, foreign_keys='[PublicFINExchangeRates.CreatedBy]', back_populates='public_SYSUsers')
    public_FINExchangeRates_: Mapped[List['PublicFINExchangeRates']] = relationship('PublicFINExchangeRates', uselist=True, foreign_keys='[PublicFINExchangeRates.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_FINExchangeRates: Mapped[List['PublicFINExchangeRates']] = relationship('PublicFINExchangeRates', uselist=True, foreign_keys='[PublicFINExchangeRates.OrganizationId]', back_populates='public_STPOrganization')
    public_FINExchangeRates_: Mapped[List['PublicFINExchangeRates']] = relationship('PublicFINExchangeRates', uselist=True, foreign_keys='[PublicFINExchangeRates.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicFINExchangeRates(Base):
    __tablename__ = 'public.FINExchangeRates'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='FINExchangeRates_fk5'),
        ForeignKeyConstraint(['FromCurrency'], ['public.STPGlobalCurrency.CurrencyCode'], name='FINExchangeRates_fk2'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='FINExchangeRates_fk6'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='FINExchangeRates_fk7'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='FINExchangeRates_fk8'),
        ForeignKeyConstraint(['ToCurrency'], ['public.STPGlobalCurrency.CurrencyCode'], name='FINExchangeRates_fk3'),
        ForeignKeyConstraint(['TriangulationCurrency'], ['public.STPGlobalCurrency.GlobalCurrencyId'], name='FINExchangeRates_fk4'),
        PrimaryKeyConstraint('RecId', name='FINExchangeRates_pk'),
        UniqueConstraint('RateId', name='public.FINExchangeRates_RateId_key'),
        Index('ExchangeRates_FromCurrency_index', 'FromCurrency', 'OrganizationId', 'SubOrganizationId'),
        Index('ExchangeRates_ToCurrency_index', 'ToCurrency', 'OrganizationId', 'SubOrganizationId'),
        Index('ExchangeRates_Valid_index', 'ValidFrom', 'ValidTo', 'OrganizationId', 'SubOrganizationId')
    )

    FromCurrency = mapped_column(String(30), nullable=False)
    ToCurrency = mapped_column(String(30), nullable=False)
    Rate = mapped_column(Double(53), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    RateId = mapped_column(String(20), server_default=text("('RATE-'::text || (nextval('rateid_id_seq'::regclass))::text)"))
    RateType = mapped_column(String(20))
    TriangulationCurrency = mapped_column(String(30))
    ValidFrom = mapped_column(Date)
    ValidTo = mapped_column(Date)
    CreatedDatetime = mapped_column(DateTime)
    ModifiedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_FINExchangeRates')
    public_STPGlobalCurrency: Mapped['PublicSTPGlobalCurrency'] = relationship('PublicSTPGlobalCurrency', foreign_keys=[FromCurrency], back_populates='public_FINExchangeRates')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_FINExchangeRates_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_FINExchangeRates')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_FINExchangeRates_')
    public_STPGlobalCurrency_: Mapped['PublicSTPGlobalCurrency'] = relationship('PublicSTPGlobalCurrency', foreign_keys=[ToCurrency], back_populates='public_FINExchangeRates_')
    public_STPGlobalCurrency1: Mapped[Optional['PublicSTPGlobalCurrency']] = relationship('PublicSTPGlobalCurrency', foreign_keys=[TriangulationCurrency], back_populates='public_FINExchangeRates1')
