...
class PublicEMPEmployees(Base):
    ...
    public_EMPEmployeeGradeMapping: Mapped[List['PublicEMPEmployeeGradeMapping']] = relationship('PublicEMPEmployeeGradeMapping', uselist=True, back_populates='public_EMPEmployees')
...
class PublicSYSUsers(Base):
    ...
    public_EMPEmployeeGradeMapping: Mapped[List['PublicEMPEmployeeGradeMapping']] = relationship('PublicEMPEmployeeGradeMapping', uselist=True, foreign_keys='[PublicEMPEmployeeGradeMapping.CreatedBy]', back_populates='public_SYSUsers')
    public_EMPEmployeeGradeMapping_: Mapped[List['PublicEMPEmployeeGradeMapping']] = relationship('PublicEMPEmployeeGradeMapping', uselist=True, foreign_keys='[PublicEMPEmployeeGradeMapping.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_EMPEmployeeGradeMapping: Mapped[List['PublicEMPEmployeeGradeMapping']] = relationship('PublicEMPEmployeeGradeMapping', uselist=True, foreign_keys='[PublicEMPEmployeeGradeMapping.OrganizationId]', back_populates='public_STPOrganization')
    public_EMPEmployeeGradeMapping_: Mapped[List['PublicEMPEmployeeGradeMapping']] = relationship('PublicEMPEmployeeGradeMapping', uselist=True, foreign_keys='[PublicEMPEmployeeGradeMapping.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicEMPEmployeeGrades(Base):
    ...
    public_EMPEmployeeGradeMapping: Mapped[List['PublicEMPEmployeeGradeMapping']] = relationship('PublicEMPEmployeeGradeMapping', uselist=True, back_populates='public_EMPEmployeeGrades')


class PublicEMPEmployeeGradeMapping(Base):
    __tablename__ = 'public.EMPEmployeeGradeMapping'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='EMPEmployeeGradeMapping_fk2'),
        ForeignKeyConstraint(['EmployeeId'], ['public.EMPEmployees.Id'], name='EMPEmployeeGradeMapping_fk0'),
        ForeignKeyConstraint(['GradeId'], ['public.EMPEmployeeGrades.GradeId'], name='EMPEmployeeGradeMapping_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='EMPEmployeeGradeMapping_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmployeeGradeMapping_fk4'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmployeeGradeMapping_fk5'),
        PrimaryKeyConstraint('RecId', name='EMPEmployeeGradeMapping_pk'),
        UniqueConstraint('GradeMappingId', name='public.EMPEmployeeGradeMapping_GradeMappingId_key'),
        Index('GradeMapping_EmployeeId_index', 'EmployeeId', 'OrganizationId', 'SubOrganizationId'),
        Index('GradeMapping_GradeId_index', 'GradeId', 'OrganizationId', 'SubOrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    GradeMappingId = mapped_column(String(20), server_default=text("('GM-'::text || (nextval('employeegrademapping_id_seq'::regclass))::text)"))
    EmployeeId = mapped_column(String(20))
    GradeId = mapped_column(String(20))
    EffectiveFrom = mapped_column(Date)
    EffectiveTo = mapped_column(Date)
    CreatedBy = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_EMPEmployeeGradeMapping')
    public_EMPEmployees: Mapped[Optional['PublicEMPEmployees']] = relationship('PublicEMPEmployees', back_populates='public_EMPEmployeeGradeMapping')
    public_EMPEmployeeGrades: Mapped[Optional['PublicEMPEmployeeGrades']] = relationship('PublicEMPEmployeeGrades', back_populates='public_EMPEmployeeGradeMapping')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_EMPEmployeeGradeMapping_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_EMPEmployeeGradeMapping')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_EMPEmployeeGradeMapping_')
