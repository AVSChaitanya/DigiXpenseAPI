...
class PublicEMPEmployees(Base):
    ...
    public_EMPEmployeeAddress: Mapped[List['PublicEMPEmployeeAddress']] = relationship('PublicEMPEmployeeAddress', uselist=True, back_populates='public_EMPEmployees')
...
class PublicSTPStates(Base):
    ...
    public_EMPEmployeeAddress: Mapped[List['PublicEMPEmployeeAddress']] = relationship('PublicEMPEmployeeAddress', uselist=True, back_populates='public_STPStates')
...
class PublicSYSUsers(Base):
    ...
    public_EMPEmployeeAddress: Mapped[List['PublicEMPEmployeeAddress']] = relationship('PublicEMPEmployeeAddress', uselist=True, foreign_keys='[PublicEMPEmployeeAddress.CreatedBy]', back_populates='public_SYSUsers')
    public_EMPEmployeeAddress_: Mapped[List['PublicEMPEmployeeAddress']] = relationship('PublicEMPEmployeeAddress', uselist=True, foreign_keys='[PublicEMPEmployeeAddress.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPCountries(Base):
    ...
    public_EMPEmployeeAddress: Mapped[List['PublicEMPEmployeeAddress']] = relationship('PublicEMPEmployeeAddress', uselist=True, back_populates='public_STPCountries')
...
class PublicSTPOrganization(Base):
    ...
    public_EMPEmployeeAddress: Mapped[List['PublicEMPEmployeeAddress']] = relationship('PublicEMPEmployeeAddress', uselist=True, foreign_keys='[PublicEMPEmployeeAddress.OrganizationId]', back_populates='public_STPOrganization')
    public_EMPEmployeeAddress_: Mapped[List['PublicEMPEmployeeAddress']] = relationship('PublicEMPEmployeeAddress', uselist=True, foreign_keys='[PublicEMPEmployeeAddress.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicEMPEmployeeAddress(Base):
    __tablename__ = 'public.EMPEmployeeAddress'
    __table_args__ = (
        ForeignKeyConstraint(['Country'], ['public.STPCountries.CountryId'], name='EMPEmployeeAddress_fk1'),
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='EMPEmployeeAddress_fk3'),
        ForeignKeyConstraint(['EmployeeId'], ['public.EMPEmployees.Id'], name='EMPEmployeeAddress_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='EMPEmployeeAddress_fk4'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmployeeAddress_fk5'),
        ForeignKeyConstraint(['StateId'], ['public.STPStates.StateId'], name='EMPEmployeeAddress_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmployeeAddress_fk6'),
        PrimaryKeyConstraint('RecId', name='EMPEmployeeAddress_pk'),
        UniqueConstraint('AddressId', name='public.EMPEmployeeAddress_AddressId_key'),
        Index('EmployeeAddress_EmployeeId_index', 'EmployeeId', 'OrganizationId', 'SubOrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    AddressId = mapped_column(String(20), server_default=text("('ADDR-'::text || (nextval('employeeaddress_id_seq'::regclass))::text)"))
    EmployeeId = mapped_column(String(20))
    Country = mapped_column(String(30))
    StateId = mapped_column(String(30))
    Street = mapped_column(String(30))
    City = mapped_column(String(300))
    PostalCode = mapped_column(String(300))
    CreatedDatetime = mapped_column(DateTime)
    ModifiedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedBy = mapped_column(String(20))
    IsActive = mapped_column(Boolean, server_default=text('true'))
    SubOrganizationId = mapped_column(Integer)
    Addresspurpose = mapped_column(Enum('Permanent', 'Contact', name='addresspurpose'))

    public_STPCountries: Mapped[Optional['PublicSTPCountries']] = relationship('PublicSTPCountries', back_populates='public_EMPEmployeeAddress')
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_EMPEmployeeAddress')
    public_EMPEmployees: Mapped[Optional['PublicEMPEmployees']] = relationship('PublicEMPEmployees', back_populates='public_EMPEmployeeAddress')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_EMPEmployeeAddress_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_EMPEmployeeAddress')
    public_STPStates: Mapped[Optional['PublicSTPStates']] = relationship('PublicSTPStates', back_populates='public_EMPEmployeeAddress')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_EMPEmployeeAddress_')
