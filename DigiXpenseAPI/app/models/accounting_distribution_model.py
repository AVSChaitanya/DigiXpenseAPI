...
class PublicSTPDimensionValues(Base):
    ...
    public_FINAccountingDistribution: Mapped[List['PublicFINAccountingDistribution']] = relationship('PublicFINAccountingDistribution', uselist=True, back_populates='public_STPDimensionValues')
...
class PublicSTPGlobalCurrency(Base):
    ...
    public_FINAccountingDistribution: Mapped[List['PublicFINAccountingDistribution']] = relationship('PublicFINAccountingDistribution', uselist=True, back_populates='public_STPGlobalCurrency')
...
class PublicSYSUsers(Base):
    ...
    public_FINAccountingDistribution: Mapped[List['PublicFINAccountingDistribution']] = relationship('PublicFINAccountingDistribution', uselist=True, foreign_keys='[PublicFINAccountingDistribution.CreatedBy]', back_populates='public_SYSUsers')
    public_FINAccountingDistribution_: Mapped[List['PublicFINAccountingDistribution']] = relationship('PublicFINAccountingDistribution', uselist=True, foreign_keys='[PublicFINAccountingDistribution.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_FINAccountingDistribution: Mapped[List['PublicFINAccountingDistribution']] = relationship('PublicFINAccountingDistribution', uselist=True, foreign_keys='[PublicFINAccountingDistribution.OrganizationId]', back_populates='public_STPOrganization')
    public_FINAccountingDistribution_: Mapped[List['PublicFINAccountingDistribution']] = relationship('PublicFINAccountingDistribution', uselist=True, foreign_keys='[PublicFINAccountingDistribution.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicFINAccountingDistribution(Base):
    __tablename__ = 'public.FINAccountingDistribution'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='FINAccountingDistribution_fk2'),
        ForeignKeyConstraint(['CurrencyCodeId'], ['public.STPGlobalCurrency.GlobalCurrencyId'], name='FINAccountingDistribution_fk0'),
        ForeignKeyConstraint(['DimensionValueId'], ['public.STPDimensionValues.DimensionValueId'], name='FINAccountingDistribution_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='FINAccountingDistribution_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='FINAccountingDistribution_fk4'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='FINAccountingDistribution_fk5'),
        PrimaryKeyConstraint('RecId', name='FINAccountingDistribution_pk'),
        UniqueConstraint('AccountingDistributionId', name='public.FINAccountingDistribution_AccountingDistributionId_key'),
        Index('AccountDistribution_DimensionValueId_index', 'DimensionValueId', 'OrganizationId', 'SubOrganizationId')
    )

    TransAmount = mapped_column(Double(53), nullable=False)
    Source = mapped_column(String(50), nullable=False)
    ReferenceId = mapped_column(String(30), nullable=False)
    DimensionValueId = mapped_column(String(30), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    AccountingDistributionId = mapped_column(String(20), server_default=text("('AD'::text || (nextval('accountingdistribution_id_seq'::regclass))::text)"))
    ReportAmount = mapped_column(Double(53))
    CurrencyCodeId = mapped_column(String(30))
    AllocationFactor = mapped_column(String(50))
    LineNumber = mapped_column(String(20))
    CreatedBy = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_FINAccountingDistribution')
    public_STPGlobalCurrency: Mapped[Optional['PublicSTPGlobalCurrency']] = relationship('PublicSTPGlobalCurrency', back_populates='public_FINAccountingDistribution')
    public_STPDimensionValues: Mapped['PublicSTPDimensionValues'] = relationship('PublicSTPDimensionValues', back_populates='public_FINAccountingDistribution')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_FINAccountingDistribution_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_FINAccountingDistribution')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_FINAccountingDistribution_')
