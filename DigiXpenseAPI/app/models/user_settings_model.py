...
class PublicSTPGlobalCurrency(Base):
    ...
    public_STPUserSettings: Mapped[List['PublicSTPUserSettings']] = relationship('PublicSTPUserSettings', uselist=True, back_populates='public_STPGlobalCurrency')
...
class PublicSTPLanguageGlobal(Base):
    ...
    public_STPUserSettings: Mapped[List['PublicSTPUserSettings']] = relationship('PublicSTPUserSettings', uselist=True, back_populates='public_STPLanguageGlobal')
...
class PublicSTPTimezones(Base):
    ...
    public_STPUserSettings: Mapped[List['PublicSTPUserSettings']] = relationship('PublicSTPUserSettings', uselist=True, back_populates='public_STPTimezones')
...
class PublicSYSUsers(Base):
    ...
    public_STPUserSettings: Mapped[List['PublicSTPUserSettings']] = relationship('PublicSTPUserSettings', uselist=True, foreign_keys='[PublicSTPUserSettings.CreatedBy]', back_populates='public_SYSUsers')
    public_STPUserSettings_: Mapped[List['PublicSTPUserSettings']] = relationship('PublicSTPUserSettings', uselist=True, foreign_keys='[PublicSTPUserSettings.ModifiedBy]', back_populates='public_SYSUsers_')
    public_STPUserSettings1: Mapped[List['PublicSTPUserSettings']] = relationship('PublicSTPUserSettings', uselist=True, foreign_keys='[PublicSTPUserSettings.UserId]', back_populates='public_SYSUsers1')
...
class PublicSTPOrganization(Base):
    ...
    public_STPUserSettings: Mapped[List['PublicSTPUserSettings']] = relationship('PublicSTPUserSettings', uselist=True, foreign_keys='[PublicSTPUserSettings.OrganizationId]', back_populates='public_STPOrganization')
    public_STPUserSettings_: Mapped[List['PublicSTPUserSettings']] = relationship('PublicSTPUserSettings', uselist=True, foreign_keys='[PublicSTPUserSettings.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicSTPPaymentMethod(Base):
    ...
    public_STPUserSettings: Mapped[List['PublicSTPUserSettings']] = relationship('PublicSTPUserSettings', uselist=True, back_populates='public_STPPaymentMethod')


class PublicSTPUserSettings(Base):
    __tablename__ = 'public.STPUserSettings'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPUserSetting_fk6'),
        ForeignKeyConstraint(['DefaultCurrency'], ['public.STPGlobalCurrency.GlobalCurrencyId'], name='STPUserSetting_fk1'),
        ForeignKeyConstraint(['DefaultLanguageId'], ['public.STPLanguageGlobal.LanguageId'], name='STPUserSetting_fk4'),
        ForeignKeyConstraint(['DefaultPaymentMethodId'], ['public.STPPaymentMethod.PaymentMethodId'], name='STPUserSetting_fk5'),
        ForeignKeyConstraint(['DefaultTimeZone'], ['public.STPTimezones.TimezoneId'], name='STPUserSetting_fk3'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPUserSetting_fk7'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPUserSetting_fk8'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPUserSetting_fk9'),
        ForeignKeyConstraint(['UserId'], ['public.SYSUsers.UserId'], name='STPUserSetting_fk'),
        PrimaryKeyConstraint('RecId', name='STPUserSetting_pk'),
        Index('UserSetting_UserId_index', 'UserId', 'OrganizationId', 'SubOrganizationId', unique=True)
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer, Sequence('public.STPUserSetting_RecId_seq'))
    UserId = mapped_column(String(20))
    DefaultCurrency = mapped_column(String(20))
    DefaultTimeZone = mapped_column(String(20))
    DefaultLanguageId = mapped_column(String(20))
    DecimalSeperator = mapped_column(Enum('.', ',', name='decimalseperator'))
    EmailsForRecieptForwarding = mapped_column(Text)
    ShowAnalyticsOnList = mapped_column(Boolean, server_default=text('true'))
    DefaultPaymentMethodId = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ThemeDirection = mapped_column(Boolean, server_default=text('true'))
    ThemeColor = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    IsActive = mapped_column(Boolean, server_default=text('true'))
    SubOrganizationId = mapped_column(Integer)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPUserSettings')
    public_STPGlobalCurrency: Mapped[Optional['PublicSTPGlobalCurrency']] = relationship('PublicSTPGlobalCurrency', back_populates='public_STPUserSettings')
    public_STPLanguageGlobal: Mapped[Optional['PublicSTPLanguageGlobal']] = relationship('PublicSTPLanguageGlobal', back_populates='public_STPUserSettings')
    public_STPPaymentMethod: Mapped[Optional['PublicSTPPaymentMethod']] = relationship('PublicSTPPaymentMethod', back_populates='public_STPUserSettings')
    public_STPTimezones: Mapped[Optional['PublicSTPTimezones']] = relationship('PublicSTPTimezones', back_populates='public_STPUserSettings')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPUserSettings_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPUserSettings')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPUserSettings_')
    public_SYSUsers1: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[UserId], back_populates='public_STPUserSettings1')
