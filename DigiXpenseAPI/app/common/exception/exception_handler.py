...
from DigiXpenseAPI.app.common.exception.errors import BaseExceptionMixin
from DigiXpenseAPI.app.common.log import log
from DigiXpenseAPI.app.common.response.response_code import StandardResponseCode, CustomResponseCode
from DigiXpenseAPI.app.common.response.response_schema import response_base, ResponseModel
from DigiXpenseAPI.app.core.conf import settings


def register_exception(app: FastAPI):
    @DigiXpenseAPI.app.exception_handler(HTTPException)
    ...
    @DigiXpenseAPI.app.exception_handler(RequestValidationError)
    async def validation_exception_handler(request: Request, exc: RequestValidationError):
        ...
        for raw_error in exc.raw_errors:
            ...
            if isinstance(raw_exc, ValidationError):
                ...
                # Handling special types of exception template information -> DigiXpenseAPI/app/schemas/base.py: SCHEMA_ERROR_MSG_TEMPLATES
        ...
        content = ResponseModel(
            ...
            msg='The request parameter is illegal' if len(message) == 0 else f'The request parameter is illegal: {message}',
    ...
    @DigiXpenseAPI.app.exception_handler(Exception)
    ...
    if settings.MIDDLEWARE_CORS:
        ...
        @DigiXpenseAPI.app.exception_handler(StandardResponseCode.HTTP_500)
