...
class PublicSYSUsers(Base):
    ...
    public_STPDimensionHierarchy: Mapped[List['PublicSTPDimensionHierarchy']] = relationship('PublicSTPDimensionHierarchy', uselist=True, foreign_keys='[PublicSTPDimensionHierarchy.CreatedBy]', back_populates='public_SYSUsers')
    public_STPDimensionHierarchy_: Mapped[List['PublicSTPDimensionHierarchy']] = relationship('PublicSTPDimensionHierarchy', uselist=True, foreign_keys='[PublicSTPDimensionHierarchy.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPDimensionHierarchy: Mapped[List['PublicSTPDimensionHierarchy']] = relationship('PublicSTPDimensionHierarchy', uselist=True, foreign_keys='[PublicSTPDimensionHierarchy.OrganizationId]', back_populates='public_STPOrganization')
    public_STPDimensionHierarchy_: Mapped[List['PublicSTPDimensionHierarchy']] = relationship('PublicSTPDimensionHierarchy', uselist=True, foreign_keys='[PublicSTPDimensionHierarchy.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSTPDimensionHierarchy(Base):
    __tablename__ = 'public.STPDimensionHierarchy'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPDimensionHierachy_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPDimensionHierachy_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPDimensionHierachy_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPDimensionHierachy_fk3'),
        PrimaryKeyConstraint('RecId', name='STPDimensionHierachy_pk')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer, Sequence('public.STPDimensionHierachy_RecId_seq'))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPDimensionHierarchy')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPDimensionHierarchy_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPDimensionHierarchy')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPDimensionHierarchy_')
