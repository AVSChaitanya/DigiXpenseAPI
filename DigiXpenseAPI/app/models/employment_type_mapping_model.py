...
class PublicEMPEmployees(Base):
    ...
    public_EMPEmploymentTypeMapping: Mapped[List['PublicEMPEmploymentTypeMapping']] = relationship('PublicEMPEmploymentTypeMapping', uselist=True, back_populates='public_EMPEmployees')
...
class PublicSYSUsers(Base):
    ...
    public_EMPEmploymentType: Mapped[List['PublicEMPEmploymentType']] = relationship('PublicEMPEmploymentType', uselist=True, foreign_keys='[PublicEMPEmploymentType.CreatedBy]', back_populates='public_SYSUsers')
    public_EMPEmploymentType_: Mapped[List['PublicEMPEmploymentType']] = relationship('PublicEMPEmploymentType', uselist=True, foreign_keys='[PublicEMPEmploymentType.ModifiedBy]', back_populates='public_SYSUsers_')
    public_EMPEmploymentTypeMapping: Mapped[List['PublicEMPEmploymentTypeMapping']] = relationship('PublicEMPEmploymentTypeMapping', uselist=True, foreign_keys='[PublicEMPEmploymentTypeMapping.CreatedBy]', back_populates='public_SYSUsers')
    public_EMPEmploymentTypeMapping_: Mapped[List['PublicEMPEmploymentTypeMapping']] = relationship('PublicEMPEmploymentTypeMapping', uselist=True, foreign_keys='[PublicEMPEmploymentTypeMapping.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_EMPEmploymentType: Mapped[List['PublicEMPEmploymentType']] = relationship('PublicEMPEmploymentType', uselist=True, foreign_keys='[PublicEMPEmploymentType.OrganizationId]', back_populates='public_STPOrganization')
    public_EMPEmploymentType_: Mapped[List['PublicEMPEmploymentType']] = relationship('PublicEMPEmploymentType', uselist=True, foreign_keys='[PublicEMPEmploymentType.SubOrganizationId]', back_populates='public_STPOrganization_')
    public_EMPEmploymentTypeMapping: Mapped[List['PublicEMPEmploymentTypeMapping']] = relationship('PublicEMPEmploymentTypeMapping', uselist=True, foreign_keys='[PublicEMPEmploymentTypeMapping.OrganizationId]', back_populates='public_STPOrganization')
    public_EMPEmploymentTypeMapping_: Mapped[List['PublicEMPEmploymentTypeMapping']] = relationship('PublicEMPEmploymentTypeMapping', uselist=True, foreign_keys='[PublicEMPEmploymentTypeMapping.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicEMPEmploymentType(Base):
    __tablename__ = 'public.EMPEmploymentType'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='EMPEmploymentType_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='EMPEmploymentType_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmploymentType_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmploymentType_fk3'),
        PrimaryKeyConstraint('RecId', name='EMPEmploymentType_pk'),
        UniqueConstraint('EmployementTypeId', name='public.EMPEmploymentType_EmployementTypeId_key'),
        UniqueConstraint('EmploymentTypeName', name='public.EMPEmploymentType_EmploymentTypeName_key'),
        Index('EmploymentType_EmployementTypeId_index', 'EmployementTypeId', 'OrganizationId', 'SubOrganizationId')
    )

    EmployementTypeId = mapped_column(String(20), nullable=False)
    EmploymentTypeName = mapped_column(String(20), nullable=False)
    EmploymentTypeDescription = mapped_column(String(250), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    CreatedBy = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_EMPEmploymentType')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_EMPEmploymentType_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_EMPEmploymentType')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_EMPEmploymentType_')
    public_EMPEmploymentTypeMapping: Mapped[List['PublicEMPEmploymentTypeMapping']] = relationship('PublicEMPEmploymentTypeMapping', uselist=True, back_populates='public_EMPEmploymentType')


class PublicEMPEmploymentTypeMapping(Base):
    __tablename__ = 'public.EMPEmploymentTypeMapping'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='EMPEmploymentTypeMapping_fk2'),
        ForeignKeyConstraint(['EmployeeId'], ['public.EMPEmployees.Id'], name='EMPEmploymentTypeMapping_fk0'),
        ForeignKeyConstraint(['EmploymentTypeId'], ['public.EMPEmploymentType.EmployementTypeId'], name='EMPEmploymentTypeMapping_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='EMPEmploymentTypeMapping_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmploymentTypeMapping_fk4'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmploymentTypeMapping_fk5'),
        PrimaryKeyConstraint('RecId', name='EMPEmploymentTypeMapping_pk'),
        UniqueConstraint('EmployementTypeMappingId', name='public.EMPEmploymentTypeMapping_EmployementTypeMappingId_key'),
        Index('TypeMapping_EmployeeId_index', 'EmployeeId', 'OrganizationId', 'SubOrganizationId'),
        Index('TypeMapping_EmploymentTypeId_index', 'EmploymentTypeId', 'OrganizationId', 'SubOrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    EmployementTypeMappingId = mapped_column(String(20), server_default=text("('ETM-'::text || (nextval('employementtypemapping_id_seq'::regclass))::text)"))
    EmployeeId = mapped_column(String(20))
    EmploymentTypeId = mapped_column(String(20))
    EffectiveFrom = mapped_column(Date)
    EffectiveTo = mapped_column(Date)
    CreatedBy = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_EMPEmploymentTypeMapping')
    public_EMPEmployees: Mapped[Optional['PublicEMPEmployees']] = relationship('PublicEMPEmployees', back_populates='public_EMPEmploymentTypeMapping')
    public_EMPEmploymentType: Mapped[Optional['PublicEMPEmploymentType']] = relationship('PublicEMPEmploymentType', back_populates='public_EMPEmploymentTypeMapping')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_EMPEmploymentTypeMapping_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_EMPEmploymentTypeMapping')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_EMPEmploymentTypeMapping_')
