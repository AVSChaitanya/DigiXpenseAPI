...
class PublicSYSUsers(Base):
    ...
    public_TRVTripCategory: Mapped[List['PublicTRVTripCategory']] = relationship('PublicTRVTripCategory', uselist=True, foreign_keys='[PublicTRVTripCategory.CreatedBy]', back_populates='public_SYSUsers')
    public_TRVTripCategory_: Mapped[List['PublicTRVTripCategory']] = relationship('PublicTRVTripCategory', uselist=True, foreign_keys='[PublicTRVTripCategory.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_TRVTripCategory: Mapped[List['PublicTRVTripCategory']] = relationship('PublicTRVTripCategory', uselist=True, foreign_keys='[PublicTRVTripCategory.OrganizationId]', back_populates='public_STPOrganization')
    public_TRVTripCategory_: Mapped[List['PublicTRVTripCategory']] = relationship('PublicTRVTripCategory', uselist=True, foreign_keys='[PublicTRVTripCategory.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicTRVTripCategory(Base):
    __tablename__ = 'public.TRVTripCategory'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='TRVTripCategory_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='TRVTripCategory_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='TRVTripCategory_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='TRVTripCategory_fk3'),
        PrimaryKeyConstraint('RecId', name='TRVTripCategory_pk'),
        UniqueConstraint('CategoryName', name='public.TRVTripCategory_CategoryName_key'),
        UniqueConstraint('TrvCategoryId', name='public.TRVTripCategory_TrvCategoryId_key')
    )

    TrvCategoryId = mapped_column(String(30), nullable=False)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_TRVTripCategory')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_TRVTripCategory_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_TRVTripCategory')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_TRVTripCategory_')
