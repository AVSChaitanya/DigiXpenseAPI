...
class PublicSYSUsers(Base):
    ...
    public_FINExchangeRateType: Mapped[List['PublicFINExchangeRateType']] = relationship('PublicFINExchangeRateType', uselist=True, foreign_keys='[PublicFINExchangeRateType.CreatedBy]', back_populates='public_SYSUsers')
    public_FINExchangeRateType_: Mapped[List['PublicFINExchangeRateType']] = relationship('PublicFINExchangeRateType', uselist=True, foreign_keys='[PublicFINExchangeRateType.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_FINExchangeRateType: Mapped[List['PublicFINExchangeRateType']] = relationship('PublicFINExchangeRateType', uselist=True, foreign_keys='[PublicFINExchangeRateType.OrganizationId]', back_populates='public_STPOrganization')
    public_FINExchangeRateType_: Mapped[List['PublicFINExchangeRateType']] = relationship('PublicFINExchangeRateType', uselist=True, foreign_keys='[PublicFINExchangeRateType.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicFINExchangeRateType(Base):
    __tablename__ = 'public.FINExchangeRateType'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='FINExchangeRateType_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='FINExchangeRateType_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='FINExchangeRateType_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='FINExchangeRateType_fk3'),
        PrimaryKeyConstraint('RecId', name='FINExchangeRateType_pk'),
        UniqueConstraint('RateTypeId', name='public.FINExchangeRateType_RateTypeId_key'),
        Index('ExchangeRateType_RateTypeId_index', 'RateTypeId', 'OrganizationId')
    )

    Description = mapped_column(String(250), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    RateTypeId = mapped_column(String(20), server_default=text("('RT-'::text || (nextval('exchangeratetype_id_seq'::regclass))::text)"))
    IsDefault = mapped_column(Boolean, server_default=text('false'))
    CreatedBy = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_FINExchangeRateType')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_FINExchangeRateType_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_FINExchangeRateType')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_FINExchangeRateType_')
