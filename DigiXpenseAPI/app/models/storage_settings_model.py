...
class PublicSYSUsers(Base):
    ...
    public_SYSStorageSettings: Mapped[List['PublicSYSStorageSettings']] = relationship('PublicSYSStorageSettings', uselist=True, foreign_keys='[PublicSYSStorageSettings.CreatedBy]', back_populates='public_SYSUsers')
    public_SYSStorageSettings_: Mapped[List['PublicSYSStorageSettings']] = relationship('PublicSYSStorageSettings', uselist=True, foreign_keys='[PublicSYSStorageSettings.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_SYSStorageSettings: Mapped[List['PublicSYSStorageSettings']] = relationship('PublicSYSStorageSettings', uselist=True, foreign_keys='[PublicSYSStorageSettings.OrgId]', back_populates='public_STPOrganization')
    public_SYSStorageSettings_: Mapped[List['PublicSYSStorageSettings']] = relationship('PublicSYSStorageSettings', uselist=True, foreign_keys='[PublicSYSStorageSettings.OrganizationId]', back_populates='public_STPOrganization_')
    public_SYSStorageSettings1: Mapped[List['PublicSYSStorageSettings']] = relationship('PublicSYSStorageSettings', uselist=True, foreign_keys='[PublicSYSStorageSettings.SubOrganizationId]', back_populates='public_STPOrganization1')
...
class PublicSYSStorageProviders(Base):
    ...
    public_SYSStorageSettings: Mapped[List['PublicSYSStorageSettings']] = relationship('PublicSYSStorageSettings', uselist=True, back_populates='public_SYSStorageProviders')


class PublicSYSStorageSettings(Base):
    __tablename__ = 'public.SYSStorageSettings'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='SYSStorageSettings_fk2'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='SYSStorageSettings_fk3'),
        ForeignKeyConstraint(['OrgId'], ['public.STPOrganization.OrganizationId'], name='SYSStorageSettings_fk0'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSStorageSettings_fk4'),
        ForeignKeyConstraint(['ProviderId'], ['public.SYSStorageProviders.ProviderId'], name='SYSStorageSettings_fk1'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSStorageSettings_fk5'),
        PrimaryKeyConstraint('RecId', name='SYSStorageSettings_pk'),
        UniqueConstraint('SettingId', name='public.SYSStorageSettings_SettingId_key')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    SettingId = mapped_column(String(20), server_default=text("('SEI-'::text || (nextval('storagesettings_id_seq'::regclass))::text)"))
    OrgId = mapped_column(Integer)
    ProviderId = mapped_column(String(20))
    AccessKey = mapped_column(String(200))
    SecretKey = mapped_column(String(200))
    BucketName = mapped_column(String(220))
    AdditionalSettings = mapped_column(Text)
    IsActive = mapped_column(Boolean, server_default=text('true'))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_SYSStorageSettings')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_SYSStorageSettings_')
    public_STPOrganization: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[OrgId], back_populates='public_SYSStorageSettings')
    public_STPOrganization_: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_SYSStorageSettings_')
    public_SYSStorageProviders: Mapped[Optional['PublicSYSStorageProviders']] = relationship('PublicSYSStorageProviders', back_populates='public_SYSStorageSettings')
    public_STPOrganization1: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_SYSStorageSettings1')
