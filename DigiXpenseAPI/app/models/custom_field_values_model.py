...
class PublicSYSUsers(Base):
    ...
    public_STPCustomFieldValues: Mapped[List['PublicSTPCustomFieldValues']] = relationship('PublicSTPCustomFieldValues', uselist=True, foreign_keys='[PublicSTPCustomFieldValues.CreatedBy]', back_populates='public_SYSUsers')
    public_STPCustomFieldValues_: Mapped[List['PublicSTPCustomFieldValues']] = relationship('PublicSTPCustomFieldValues', uselist=True, foreign_keys='[PublicSTPCustomFieldValues.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPCustomFieldValues: Mapped[List['PublicSTPCustomFieldValues']] = relationship('PublicSTPCustomFieldValues', uselist=True, foreign_keys='[PublicSTPCustomFieldValues.OrganizationId]', back_populates='public_STPOrganization')
    public_STPCustomFieldValues_: Mapped[List['PublicSTPCustomFieldValues']] = relationship('PublicSTPCustomFieldValues', uselist=True, foreign_keys='[PublicSTPCustomFieldValues.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicSTPCustomFields(Base):
    ...
    public_STPCustomFieldValues: Mapped[List['PublicSTPCustomFieldValues']] = relationship('PublicSTPCustomFieldValues', uselist=True, back_populates='public_STPCustomFields')


class PublicSTPCustomFieldValues(Base):
    __tablename__ = 'public.STPCustomFieldValues'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPCustomFieldValues_fk2'),
        ForeignKeyConstraint(['FieldId'], ['public.STPCustomFields.FieldId'], name='STPCustomFieldValues_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPCustomFieldValues_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPCustomFieldValues_fk3'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPCustomFieldValues_fk4'),
        PrimaryKeyConstraint('RecId', name='STPCustomFieldValues_pk')
    )
    ...
    FieldValue = mapped_column(Text)
    FieldName = mapped_column(Enum('Merchant', 'Category', 'Project', 'Paid With', 'Comment', 'Country', 'Vat Amount', 'Vat Percentage', name='fieldname'))
    RefRecId = mapped_column(Integer)
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    IsActive = mapped_column(Boolean, server_default=text('false'))
    SubOrganizationId = mapped_column(Integer)

    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPCustomFieldValues')
    public_STPCustomFields: Mapped[Optional['PublicSTPCustomFields']] = relationship('PublicSTPCustomFields', back_populates='public_STPCustomFieldValues')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPCustomFieldValues_')
