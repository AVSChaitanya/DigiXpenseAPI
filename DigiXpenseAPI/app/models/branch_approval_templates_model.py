...
class PublicSTPCompanyBranches(Base):
    ...
    public_STPBranchDefaultApprovalTemplates: Mapped[List['PublicSTPBranchDefaultApprovalTemplates']] = relationship('PublicSTPBranchDefaultApprovalTemplates', uselist=True, back_populates='public_STPCompanyBranches')
...
class PublicSYSUsers(Base):
    ...
    public_STPBranchDefaultApprovalTemplates: Mapped[List['PublicSTPBranchDefaultApprovalTemplates']] = relationship('PublicSTPBranchDefaultApprovalTemplates', uselist=True, foreign_keys='[PublicSTPBranchDefaultApprovalTemplates.CreatedBy]', back_populates='public_SYSUsers')
    public_STPBranchDefaultApprovalTemplates_: Mapped[List['PublicSTPBranchDefaultApprovalTemplates']] = relationship('PublicSTPBranchDefaultApprovalTemplates', uselist=True, foreign_keys='[PublicSTPBranchDefaultApprovalTemplates.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPBranchDefaultApprovalTemplates: Mapped[List['PublicSTPBranchDefaultApprovalTemplates']] = relationship('PublicSTPBranchDefaultApprovalTemplates', uselist=True, foreign_keys='[PublicSTPBranchDefaultApprovalTemplates.OrganizationId]', back_populates='public_STPOrganization')
    public_STPBranchDefaultApprovalTemplates_: Mapped[List['PublicSTPBranchDefaultApprovalTemplates']] = relationship('PublicSTPBranchDefaultApprovalTemplates', uselist=True, foreign_keys='[PublicSTPBranchDefaultApprovalTemplates.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSTPBranchDefaultApprovalTemplates(Base):
    __tablename__ = 'public.STPBranchDefaultApprovalTemplates'
    __table_args__ = (
        ForeignKeyConstraint(['BranchId'], ['public.STPCompanyBranches.BranchId'], name='STPBranchDefaultApprovalTemplates_fk0'),
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPBranchDefaultApprovalTemplates_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPBranchDefaultApprovalTemplates_fk2'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPBranchDefaultApprovalTemplates_fk3'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPBranchDefaultApprovalTemplates_fk4'),
        PrimaryKeyConstraint('RecId', name='STPBranchDefaultApprovalTemplates_pk'),
        Index('BranchDefaultApproval_BranchId_index', 'BranchId', 'OrganizationId', 'SubOrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    BranchId = mapped_column(String(20))
    ...
    public_STPCompanyBranches: Mapped[Optional['PublicSTPCompanyBranches']] = relationship('PublicSTPCompanyBranches', back_populates='public_STPBranchDefaultApprovalTemplates')
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPBranchDefaultApprovalTemplates')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPBranchDefaultApprovalTemplates_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPBranchDefaultApprovalTemplates')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPBranchDefaultApprovalTemplates_')
