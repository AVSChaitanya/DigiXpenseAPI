...
class PublicSYSUsers(Base):
    ...
    public_TRVTripBudget: Mapped[List['PublicTRVTripBudget']] = relationship('PublicTRVTripBudget', uselist=True, foreign_keys='[PublicTRVTripBudget.CreatedBy]', back_populates='public_SYSUsers')
    public_TRVTripBudget_: Mapped[List['PublicTRVTripBudget']] = relationship('PublicTRVTripBudget', uselist=True, foreign_keys='[PublicTRVTripBudget.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicTRVTripTable(Base):
    ...
    public_TRVTripBudget: Mapped[List['PublicTRVTripBudget']] = relationship('PublicTRVTripBudget', uselist=True, back_populates='public_TRVTripTable')
...
class PublicSTPOrganization(Base):
    ...
    public_TRVTripBudget: Mapped[List['PublicTRVTripBudget']] = relationship('PublicTRVTripBudget', uselist=True, foreign_keys='[PublicTRVTripBudget.OrganizationId]', back_populates='public_STPOrganization')
    public_TRVTripBudget_: Mapped[List['PublicTRVTripBudget']] = relationship('PublicTRVTripBudget', uselist=True, foreign_keys='[PublicTRVTripBudget.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicEXPExpenseCategory(Base):
    ...
    public_TRVTripBudget: Mapped[List['PublicTRVTripBudget']] = relationship('PublicTRVTripBudget', uselist=True, back_populates='public_EXPExpenseCategory')


class PublicTRVTripBudget(Base):
    __tablename__ = 'public.TRVTripBudget'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='TRVTripBudget_fk2'),
        ForeignKeyConstraint(['ExpenseCategoryId'], ['public.EXPExpenseCategory.CategoryId'], name='TRVTripBudget_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='TRVTripBudget_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='TRVTripBudget_fk4'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='TRVTripBudget_fk5'),
        ForeignKeyConstraint(['TripId'], ['public.TRVTripTable.TripId'], name='TRVTripBudget_fk0'),
        PrimaryKeyConstraint('RecId', name='TRVTripBudget_pk')
    )

    TripId = mapped_column(String(30), nullable=False)
    ExpenseCategoryId = mapped_column(String(30), nullable=False)
    BudgetAmount = mapped_column(Double(53), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    CreatedBy = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_TRVTripBudget')
    public_EXPExpenseCategory: Mapped['PublicEXPExpenseCategory'] = relationship('PublicEXPExpenseCategory', back_populates='public_TRVTripBudget')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_TRVTripBudget_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_TRVTripBudget')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_TRVTripBudget_')
    public_TRVTripTable: Mapped['PublicTRVTripTable'] = relationship('PublicTRVTripTable', back_populates='public_TRVTripBudget')
