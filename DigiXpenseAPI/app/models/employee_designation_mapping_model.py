...
class PublicEMPEmployees(Base):
    ...
    public_EMPEmployeeDesignationMapping: Mapped[List['PublicEMPEmployeeDesignationMapping']] = relationship('PublicEMPEmployeeDesignationMapping', uselist=True, back_populates='public_EMPEmployees')
...
class PublicSYSUsers(Base):
    ...
    public_EMPEmployeeDesignation: Mapped[List['PublicEMPEmployeeDesignation']] = relationship('PublicEMPEmployeeDesignation', uselist=True, foreign_keys='[PublicEMPEmployeeDesignation.CreatedBy]', back_populates='public_SYSUsers')
    public_EMPEmployeeDesignation_: Mapped[List['PublicEMPEmployeeDesignation']] = relationship('PublicEMPEmployeeDesignation', uselist=True, foreign_keys='[PublicEMPEmployeeDesignation.ModifiedBy]', back_populates='public_SYSUsers_')
    public_EMPEmployeeDesignationMapping: Mapped[List['PublicEMPEmployeeDesignationMapping']] = relationship('PublicEMPEmployeeDesignationMapping', uselist=True, foreign_keys='[PublicEMPEmployeeDesignationMapping.CreatedBy]', back_populates='public_SYSUsers')
    public_EMPEmployeeDesignationMapping_: Mapped[List['PublicEMPEmployeeDesignationMapping']] = relationship('PublicEMPEmployeeDesignationMapping', uselist=True, foreign_keys='[PublicEMPEmployeeDesignationMapping.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_EMPEmployeeDesignation: Mapped[List['PublicEMPEmployeeDesignation']] = relationship('PublicEMPEmployeeDesignation', uselist=True, foreign_keys='[PublicEMPEmployeeDesignation.OrganizationId]', back_populates='public_STPOrganization')
    public_EMPEmployeeDesignation_: Mapped[List['PublicEMPEmployeeDesignation']] = relationship('PublicEMPEmployeeDesignation', uselist=True, foreign_keys='[PublicEMPEmployeeDesignation.SubOrganizationId]', back_populates='public_STPOrganization_')
    public_EMPEmployeeDesignationMapping: Mapped[List['PublicEMPEmployeeDesignationMapping']] = relationship('PublicEMPEmployeeDesignationMapping', uselist=True, foreign_keys='[PublicEMPEmployeeDesignationMapping.OrganizationId]', back_populates='public_STPOrganization')
    public_EMPEmployeeDesignationMapping_: Mapped[List['PublicEMPEmployeeDesignationMapping']] = relationship('PublicEMPEmployeeDesignationMapping', uselist=True, foreign_keys='[PublicEMPEmployeeDesignationMapping.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicEMPEmployeeDesignation(Base):
    __tablename__ = 'public.EMPEmployeeDesignation'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='EMPEmployeeDesignation_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='EMPEmployeeDesignation_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmployeeDesignation_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmployeeDesignation_fk3'),
        PrimaryKeyConstraint('RecId', name='EMPEmployeeDesignation_pk'),
        UniqueConstraint('DesignationId', name='public.EMPEmployeeDesignation_DesignationId_key'),
        UniqueConstraint('DesignationName', name='public.EMPEmployeeDesignation_DesignationName_key'),
        Index('Designation_DesignationId_index', 'DesignationId', 'OrganizationId', 'SubOrganizationId'),
        Index('Designation_DesignationName_index', 'DesignationName', 'OrganizationId', 'SubOrganizationId')
    )

    DesignationId = mapped_column(String(20), nullable=False)
    DesignationName = mapped_column(String(20), nullable=False)
    Description = mapped_column(String(250), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    RequiredSkills = mapped_column(String(60))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_EMPEmployeeDesignation')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_EMPEmployeeDesignation_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_EMPEmployeeDesignation')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_EMPEmployeeDesignation_')
    public_EMPEmployeeDesignationMapping: Mapped[List['PublicEMPEmployeeDesignationMapping']] = relationship('PublicEMPEmployeeDesignationMapping', uselist=True, back_populates='public_EMPEmployeeDesignation')


class PublicEMPEmployeeDesignationMapping(Base):
    __tablename__ = 'public.EMPEmployeeDesignationMapping'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='EMPEmployeeDesignationMapping_fk2'),
        ForeignKeyConstraint(['DesignationId'], ['public.EMPEmployeeDesignation.DesignationId'], name='EMPEmployeeDesignationMapping_fk1'),
        ForeignKeyConstraint(['EmployeeId'], ['public.EMPEmployees.Id'], name='EMPEmployeeDesignationMapping_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='EMPEmployeeDesignationMapping_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmployeeDesignationMapping_fk4'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmployeeDesignationMapping_fk5'),
        PrimaryKeyConstraint('RecId', name='EMPEmployeeDesignationMapping_pk'),
        UniqueConstraint('DesignationMappingId', name='public.EMPEmployeeDesignationMapping_DesignationMappingId_key'),
        Index('DesignationMapping_EmployeeId_index', 'EmployeeId', 'OrganizationId', 'SubOrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    DesignationMappingId = mapped_column(String(20), server_default=text("('DM-'::text || (nextval('employeedesignationmapping_id_seq'::regclass))::text)"))
    EmployeeId = mapped_column(String(20))
    DesignationId = mapped_column(String(20))
    EffectiveFrom = mapped_column(Date)
    EffectiveTo = mapped_column(Date)
    CreatedBy = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_EMPEmployeeDesignationMapping')
    public_EMPEmployeeDesignation: Mapped[Optional['PublicEMPEmployeeDesignation']] = relationship('PublicEMPEmployeeDesignation', back_populates='public_EMPEmployeeDesignationMapping')
    public_EMPEmployees: Mapped[Optional['PublicEMPEmployees']] = relationship('PublicEMPEmployees', back_populates='public_EMPEmployeeDesignationMapping')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_EMPEmployeeDesignationMapping_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_EMPEmployeeDesignationMapping')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_EMPEmployeeDesignationMapping_')
