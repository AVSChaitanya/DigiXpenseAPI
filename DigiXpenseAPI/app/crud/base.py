...
class CRUDBase(Generic[ModelType, CreateSchemaType, UpdateSchemaType]):
    ...
    async def get_(
       ...
       Get a piece of data by primary key id or name
        ...
        :return:
        """
        assert pk is not None or name is not None, 'Query error, pk and name parameters cannot exist at the same time'
        assert pk is None or name is None, 'Query error, pk and name parameters cannot be empty at the same time'
