...
from sqlalchemy import Boolean, Column, Date, DateTime, Double, Enum, ForeignKeyConstraint, Index, Integer, LargeBinary, Numeric, PrimaryKeyConstraint, String, Text, UniqueConstraint, text
...
class PublicSTPDimensionValues(Base):
    ...
    public_TRVTripTrans: Mapped[List['PublicTRVTripTrans']] = relationship('PublicTRVTripTrans', uselist=True, back_populates='public_STPDimensionValues')
...
class PublicSTPDimensions(Base):
    ...
    public_TRVTripTrans: Mapped[List['PublicTRVTripTrans']] = relationship('PublicTRVTripTrans', uselist=True, back_populates='public_STPDimensions')
...
class PublicSTPGlobalCurrency(Base):
    ...
    public_TRVTripTrans: Mapped[List['PublicTRVTripTrans']] = relationship('PublicTRVTripTrans', uselist=True, back_populates='public_STPGlobalCurrency')
...
class PublicSTPTimezones(Base):
    ...
    public_TRVTripTrans: Mapped[List['PublicTRVTripTrans']] = relationship('PublicTRVTripTrans', uselist=True, back_populates='public_STPTimezones')
...
class PublicSYSApprovals(Base):
    ...
    public_TRVTripTrans: Mapped[List['PublicTRVTripTrans']] = relationship('PublicTRVTripTrans', uselist=True, back_populates='public_SYSApprovals')
...
class PublicSYSUsers(Base):
    ...
    public_TRVTripTrans: Mapped[List['PublicTRVTripTrans']] = relationship('PublicTRVTripTrans', uselist=True, foreign_keys='[PublicTRVTripTrans.CreatedBy]', back_populates='public_SYSUsers')
    public_TRVTripTrans_: Mapped[List['PublicTRVTripTrans']] = relationship('PublicTRVTripTrans', uselist=True, foreign_keys='[PublicTRVTripTrans.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicTRVTripTable(Base):
    ...
    public_TRVTripTrans: Mapped[List['PublicTRVTripTrans']] = relationship('PublicTRVTripTrans', uselist=True, back_populates='public_TRVTripTable')
...
class PublicSTPOrganization(Base):
    ...
    public_TRVTripTrans: Mapped[List['PublicTRVTripTrans']] = relationship('PublicTRVTripTrans', uselist=True, foreign_keys='[PublicTRVTripTrans.OrganizationId]', back_populates='public_STPOrganization')
    public_TRVTripTrans_: Mapped[List['PublicTRVTripTrans']] = relationship('PublicTRVTripTrans', uselist=True, foreign_keys='[PublicTRVTripTrans.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicEXPExpenseCategory(Base):
    ...
    public_TRVTripTrans: Mapped[List['PublicTRVTripTrans']] = relationship('PublicTRVTripTrans', uselist=True, back_populates='public_EXPExpenseCategory')


class PublicTRVTripTrans(Base):
    __tablename__ = 'public.TRVTripTrans'
    __table_args__ = (
        ForeignKeyConstraint(['ApprovalId'], ['public.SYSApprovals.ApprovalId'], name='TRVTripTrans_fk5'),
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='TRVTripTrans_fk7'),
        ForeignKeyConstraint(['CurrencyId'], ['public.STPGlobalCurrency.GlobalCurrencyId'], name='TRVTripTrans_fk6'),
        ForeignKeyConstraint(['DimensionId'], ['public.STPDimensions.DimensionId'], name='TRVTripTrans_fk2'),
        ForeignKeyConstraint(['DimensionValueId'], ['public.STPDimensionValues.DimensionValueId'], name='TRVTripTrans_fk3'),
        ForeignKeyConstraint(['ExpenseCategoryId'], ['public.EXPExpenseCategory.CategoryId'], name='TRVTripTrans_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='TRVTripTrans_fk8'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='TRVTripTrans_fk9'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='TRVTripTrans_fk10'),
        ForeignKeyConstraint(['TimezoneId'], ['public.STPTimezones.TimezoneId'], name='TRVTripTrans_fk4'),
        ForeignKeyConstraint(['TripId'], ['public.TRVTripTable.TripId'], name='TRVTripTrans_fk0'),
        PrimaryKeyConstraint('RecId', name='TRVTripTrans_pk'),
        UniqueConstraint('TravelTransId', name='public.TRVTripTrans_TravelTransId_key')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    TravelTransId = mapped_column(String(20), server_default=text("('TRAV-'::text || (nextval('triptrans_id_seq'::regclass))::text)"))
    TripId = mapped_column(String(30))
    ExpenseCategoryId = mapped_column(String(30))
    ...
    TimezoneId = mapped_column(String(20))
    CurrencyId = mapped_column(String(30))
    TaxAmount = mapped_column(Double(53))
    TaxRate = mapped_column(Double(53))
    IsBillable = mapped_column(Boolean, server_default=text('true'))
    ...
    public_SYSApprovals: Mapped[Optional['PublicSYSApprovals']] = relationship('PublicSYSApprovals', back_populates='public_TRVTripTrans')
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_TRVTripTrans')
    public_STPGlobalCurrency: Mapped[Optional['PublicSTPGlobalCurrency']] = relationship('PublicSTPGlobalCurrency', back_populates='public_TRVTripTrans')
    public_STPDimensions: Mapped[Optional['PublicSTPDimensions']] = relationship('PublicSTPDimensions', back_populates='public_TRVTripTrans')
    public_STPDimensionValues: Mapped[Optional['PublicSTPDimensionValues']] = relationship('PublicSTPDimensionValues', back_populates='public_TRVTripTrans')
    public_EXPExpenseCategory: Mapped[Optional['PublicEXPExpenseCategory']] = relationship('PublicEXPExpenseCategory', back_populates='public_TRVTripTrans')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_TRVTripTrans_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_TRVTripTrans')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_TRVTripTrans_')
    public_STPTimezones: Mapped[Optional['PublicSTPTimezones']] = relationship('PublicSTPTimezones', back_populates='public_TRVTripTrans')
    public_TRVTripTable: Mapped[Optional['PublicTRVTripTable']] = relationship('PublicTRVTripTable', back_populates='public_TRVTripTrans')
