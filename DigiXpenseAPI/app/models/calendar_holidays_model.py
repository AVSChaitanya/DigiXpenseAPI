...
class PublicSYSUsers(Base):
    ...
    public_STPCalendar: Mapped[List['PublicSTPCalendar']] = relationship('PublicSTPCalendar', uselist=True, foreign_keys='[PublicSTPCalendar.CreatedBy]', back_populates='public_SYSUsers')
    public_STPCalendar_: Mapped[List['PublicSTPCalendar']] = relationship('PublicSTPCalendar', uselist=True, foreign_keys='[PublicSTPCalendar.ModifiedBy]', back_populates='public_SYSUsers_')
    public_STPCalendarHolidays: Mapped[List['PublicSTPCalendarHolidays']] = relationship('PublicSTPCalendarHolidays', uselist=True, foreign_keys='[PublicSTPCalendarHolidays.CreatedBy]', back_populates='public_SYSUsers')
    public_STPCalendarHolidays_: Mapped[List['PublicSTPCalendarHolidays']] = relationship('PublicSTPCalendarHolidays', uselist=True, foreign_keys='[PublicSTPCalendarHolidays.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPCalendar: Mapped[List['PublicSTPCalendar']] = relationship('PublicSTPCalendar', uselist=True, foreign_keys='[PublicSTPCalendar.OrganizationId]', back_populates='public_STPOrganization')
    public_STPCalendar_: Mapped[List['PublicSTPCalendar']] = relationship('PublicSTPCalendar', uselist=True, foreign_keys='[PublicSTPCalendar.SubOrganizationId]', back_populates='public_STPOrganization_')
    public_STPCalendarHolidays: Mapped[List['PublicSTPCalendarHolidays']] = relationship('PublicSTPCalendarHolidays', uselist=True, foreign_keys='[PublicSTPCalendarHolidays.OrganizationId]', back_populates='public_STPOrganization')
    public_STPCalendarHolidays_: Mapped[List['PublicSTPCalendarHolidays']] = relationship('PublicSTPCalendarHolidays', uselist=True, foreign_keys='[PublicSTPCalendarHolidays.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSTPCalendar(Base):
    __tablename__ = 'public.STPCalendar'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPCalendar_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPCalendar_fk2'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPCalendar_fk3'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPCalendar_fk4'),
        PrimaryKeyConstraint('RecId', name='STPCalendar_pk'),
        UniqueConstraint('CalendarId', name='public.STPCalendar_CalendarId_key'),
        Index('Calendar_CalendarId_index', 'CalendarId', 'OrganizationId', 'SubOrganizationId')
    )

    CalendarName = mapped_column(String(60), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    CalendarId = mapped_column(String(20))
    CalendarDescription = mapped_column(String(500))
    WorkingTimeTemplate = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPCalendar')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPCalendar_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPCalendar')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPCalendar_')
    public_STPCalendarHolidays: Mapped[List['PublicSTPCalendarHolidays']] = relationship('PublicSTPCalendarHolidays', uselist=True, back_populates='public_STPCalendar')


class PublicSTPCalendarHolidays(Base):
    __tablename__ = 'public.STPCalendarHolidays'
    __table_args__ = (
        ForeignKeyConstraint(['CalendarId'], ['public.STPCalendar.CalendarId'], name='STPCalendarHolidays_fk0'),
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPCalendarHolidays_fk2'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPCalendarHolidays_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPCalendarHolidays_fk4'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPCalendarHolidays_fk5'),
        PrimaryKeyConstraint('RecId', name='STPCalendarHolidays_pk'),
        Index('CalendarHolidays_CalendarId_index', 'CalendarId', 'Date', 'OrganizationId', 'SubOrganizationId', unique=True)
    )

    CalendarId = mapped_column(String(20), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    ...
    IsActive = mapped_column(Boolean, server_default=text('true'))
    SubOrganizationId = mapped_column(Integer)
    HolidayType = mapped_column(Enum('National Holidays', 'Religious Holidays', 'Secular Holidays', 'Statutory Holidays', 'Civic Holidays', name='holidaytype'))

    public_STPCalendar: Mapped['PublicSTPCalendar'] = relationship('PublicSTPCalendar', back_populates='public_STPCalendarHolidays')
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPCalendarHolidays')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPCalendarHolidays_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPCalendarHolidays')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPCalendarHolidays_')
