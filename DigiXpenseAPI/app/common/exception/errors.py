...
When business code executes abnormally, you can use raise xxxError to trigger internal errors. It implements exceptions with background tasks as much as possible, but it does not apply to **custom response status codes**
...
from DigiXpenseAPI.app.common.response.response_code import CustomErrorCode, StandardResponseCode
