...
class PublicSYSUsers(Base):
    ...
    public_TAXTaxValues: Mapped[List['PublicTAXTaxValues']] = relationship('PublicTAXTaxValues', uselist=True, foreign_keys='[PublicTAXTaxValues.CreatedBy]', back_populates='public_SYSUsers')
    public_TAXTaxValues_: Mapped[List['PublicTAXTaxValues']] = relationship('PublicTAXTaxValues', uselist=True, foreign_keys='[PublicTAXTaxValues.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_TAXTaxValues: Mapped[List['PublicTAXTaxValues']] = relationship('PublicTAXTaxValues', uselist=True, foreign_keys='[PublicTAXTaxValues.OrganizationId]', back_populates='public_STPOrganization')
    public_TAXTaxValues_: Mapped[List['PublicTAXTaxValues']] = relationship('PublicTAXTaxValues', uselist=True, foreign_keys='[PublicTAXTaxValues.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicTAXTaxCodes(Base):
    ...
    public_TAXTaxValues: Mapped[List['PublicTAXTaxValues']] = relationship('PublicTAXTaxValues', uselist=True, back_populates='public_TAXTaxCodes')


class PublicTAXTaxValues(Base):
    __tablename__ = 'public.TAXTaxValues'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='TAXTaxValues_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='TAXTaxValues_fk2'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='TAXTaxValues_fk3'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='TAXTaxValues_fk4'),
        ForeignKeyConstraint(['TaxCodeId'], ['public.TAXTaxCodes.TaxCode'], name='TAXTaxValues_fk0'),
        PrimaryKeyConstraint('RecId', name='TAXTaxValues_pk'),
        Index('TaxValues_TaxValueId_index', 'TaxValueId', 'TaxCodeId', 'OrganizationId', 'SubOrganizationId', unique=True)
    )

    TaxCodeId = mapped_column(String(20), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    TaxValueId = mapped_column(String(30), server_default=text("('TAXVALUE-'::text || (nextval('taxvalues_id_seq'::regclass))::text)"))
    MinimumAmount = mapped_column(Double(53))
    MaximumAmount = mapped_column(Double(53))
    TaxPercentage = mapped_column(Double(53))
    Cumulative = mapped_column(Boolean, server_default=text('true'))
    CreatedBy = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_TAXTaxValues')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_TAXTaxValues_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_TAXTaxValues')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_TAXTaxValues_')
    public_TAXTaxCodes: Mapped['PublicTAXTaxCodes'] = relationship('PublicTAXTaxCodes', back_populates='public_TAXTaxValues')
