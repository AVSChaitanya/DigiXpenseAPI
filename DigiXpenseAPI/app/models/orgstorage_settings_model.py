...
class PublicSYSUsers(Base):
    ...
    public_STPOrgStorageSettings: Mapped[List['PublicSTPOrgStorageSettings']] = relationship('PublicSTPOrgStorageSettings', uselist=True, foreign_keys='[PublicSTPOrgStorageSettings.CreatedBy]', back_populates='public_SYSUsers')
    public_STPOrgStorageSettings_: Mapped[List['PublicSTPOrgStorageSettings']] = relationship('PublicSTPOrgStorageSettings', uselist=True, foreign_keys='[PublicSTPOrgStorageSettings.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPOrgStorageSettings: Mapped[List['PublicSTPOrgStorageSettings']] = relationship('PublicSTPOrgStorageSettings', uselist=True, foreign_keys='[PublicSTPOrgStorageSettings.OrganizationId]', back_populates='public_STPOrganization')
    public_STPOrgStorageSettings_: Mapped[List['PublicSTPOrgStorageSettings']] = relationship('PublicSTPOrgStorageSettings', uselist=True, foreign_keys='[PublicSTPOrgStorageSettings.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSTPOrgStorageSettings(Base):
    __tablename__ = 'public.STPOrgStorageSettings'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPStorageSettings_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPStorageSettings_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPStorageSettings_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPStorageSettings_fk3'),
        PrimaryKeyConstraint('RecId', name='STPStorageSettings_pk'),
        UniqueConstraint('OrgStorageSettingId', name='public.STPOrgStorageSettings_OrgStorageSettingId_key'),
        Index('OrgStorageSettings_StorageLocation_index', 'StorageLocation', 'OrgStorageSettingId', 'OrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    OrgStorageSettingId = mapped_column(String(10), server_default=text("('OSS-'::text || (nextval('orgstoragesetting_id_seq'::regclass))::text)"))
    StorageLocation = mapped_column(String(200))
    LocalStoragePath = mapped_column(String(200))
    AzureBlobConnection = mapped_column(String(300))
    AWSStorageConnection = mapped_column(String(300))
    MaxFileSizeDB = mapped_column(String(100))
    MaxFileSizeCloud = mapped_column(String(100))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPOrgStorageSettings')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPOrgStorageSettings_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPOrgStorageSettings')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPOrgStorageSettings_')
