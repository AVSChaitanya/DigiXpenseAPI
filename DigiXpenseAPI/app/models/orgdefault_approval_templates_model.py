...
class PublicSYSUsers(Base):
    ...
    public_STPOrgDefaultApprovalTemplates: Mapped[List['PublicSTPOrgDefaultApprovalTemplates']] = relationship('PublicSTPOrgDefaultApprovalTemplates', uselist=True, foreign_keys='[PublicSTPOrgDefaultApprovalTemplates.CreatedBy]', back_populates='public_SYSUsers')
    public_STPOrgDefaultApprovalTemplates_: Mapped[List['PublicSTPOrgDefaultApprovalTemplates']] = relationship('PublicSTPOrgDefaultApprovalTemplates', uselist=True, foreign_keys='[PublicSTPOrgDefaultApprovalTemplates.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPOrgDefaultApprovalTemplates: Mapped[List['PublicSTPOrgDefaultApprovalTemplates']] = relationship('PublicSTPOrgDefaultApprovalTemplates', uselist=True, foreign_keys='[PublicSTPOrgDefaultApprovalTemplates.OrgId]', back_populates='public_STPOrganization')
    public_STPOrgDefaultApprovalTemplates_: Mapped[List['PublicSTPOrgDefaultApprovalTemplates']] = relationship('PublicSTPOrgDefaultApprovalTemplates', uselist=True, foreign_keys='[PublicSTPOrgDefaultApprovalTemplates.OrganizationId]', back_populates='public_STPOrganization_')
    public_STPOrgDefaultApprovalTemplates1: Mapped[List['PublicSTPOrgDefaultApprovalTemplates']] = relationship('PublicSTPOrgDefaultApprovalTemplates', uselist=True, foreign_keys='[PublicSTPOrgDefaultApprovalTemplates.SubOrganizationId]', back_populates='public_STPOrganization1')


class PublicSTPOrgDefaultApprovalTemplates(Base):
    __tablename__ = 'public.STPOrgDefaultApprovalTemplates'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPOrgDefaultApprovalTemplates_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPOrgDefaultApprovalTemplates_fk1'),
        ForeignKeyConstraint(['OrgId'], ['public.STPOrganization.OrganizationId'], name='STPOrgDefaultApprovalTemplates_fk4'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPOrgDefaultApprovalTemplates_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPOrgDefaultApprovalTemplates_fk3'),
        PrimaryKeyConstraint('RecId', name='STPOrgDefaultApprovalTemplates_pk'),
        Index('ApprovalTemplates_OrgId_index', 'OrgId', 'OrganizationId', 'SubOrganizationId')
    )
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPOrgDefaultApprovalTemplates')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPOrgDefaultApprovalTemplates_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrgId], back_populates='public_STPOrgDefaultApprovalTemplates')
    public_STPOrganization_: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPOrgDefaultApprovalTemplates_')
    public_STPOrganization1: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPOrgDefaultApprovalTemplates1')
