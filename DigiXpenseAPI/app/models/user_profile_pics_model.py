...
from sqlalchemy import Boolean, Column, Date, DateTime, Enum, ForeignKeyConstraint, Index, Integer, LargeBinary, Numeric, PrimaryKeyConstraint, String, Text, UniqueConstraint, text
...
class PublicSYSUsers(Base):
    ...
    public_STPUserProfilePics: Mapped[List['PublicSTPUserProfilePics']] = relationship('PublicSTPUserProfilePics', uselist=True, foreign_keys='[PublicSTPUserProfilePics.CreatedBy]', back_populates='public_SYSUsers')
    public_STPUserProfilePics_: Mapped[List['PublicSTPUserProfilePics']] = relationship('PublicSTPUserProfilePics', uselist=True, foreign_keys='[PublicSTPUserProfilePics.ModifiedBy]', back_populates='public_SYSUsers_')
    public_STPUserProfilePics1: Mapped[List['PublicSTPUserProfilePics']] = relationship('PublicSTPUserProfilePics', uselist=True, foreign_keys='[PublicSTPUserProfilePics.UserId]', back_populates='public_SYSUsers1')
...
class PublicSTPOrganization(Base):
    ...
    public_STPUserProfilePics: Mapped[List['PublicSTPUserProfilePics']] = relationship('PublicSTPUserProfilePics', uselist=True, foreign_keys='[PublicSTPUserProfilePics.OrganizationId]', back_populates='public_STPOrganization')
    public_STPUserProfilePics_: Mapped[List['PublicSTPUserProfilePics']] = relationship('PublicSTPUserProfilePics', uselist=True, foreign_keys='[PublicSTPUserProfilePics.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSTPUserProfilePics(Base):
    __tablename__ = 'public.STPUserProfilePics'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPUserProfilePics_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPUserProfilePics_fk2'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPUserProfilePics_fk3'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPUserProfilePics_fk4'),
        ForeignKeyConstraint(['UserId'], ['public.SYSUsers.UserId'], name='STPUserProfilePics_fk0'),
        PrimaryKeyConstraint('RecId', name='STPUserProfilePics_pk'),
        Index('UserProfilePics_UserId_index', 'UserId', 'OrganizationId', 'SubOrganizationId')
    )
    ...
    ProfilePicture = mapped_column(LargeBinary)
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPUserProfilePics')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPUserProfilePics_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPUserProfilePics')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPUserProfilePics_')
    public_SYSUsers1: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[UserId], back_populates='public_STPUserProfilePics1')
