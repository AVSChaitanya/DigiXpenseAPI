...
class PublicSYSUsers(Base):
    ...
    public_STPDocumentContentTypes: Mapped[List['PublicSTPDocumentContentTypes']] = relationship('PublicSTPDocumentContentTypes', uselist=True, foreign_keys='[PublicSTPDocumentContentTypes.CreatedBy]', back_populates='public_SYSUsers')
    public_STPDocumentContentTypes_: Mapped[List['PublicSTPDocumentContentTypes']] = relationship('PublicSTPDocumentContentTypes', uselist=True, foreign_keys='[PublicSTPDocumentContentTypes.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPDocumentContentTypes: Mapped[List['PublicSTPDocumentContentTypes']] = relationship('PublicSTPDocumentContentTypes', uselist=True, foreign_keys='[PublicSTPDocumentContentTypes.OrganizationId]', back_populates='public_STPOrganization')
    public_STPDocumentContentTypes_: Mapped[List['PublicSTPDocumentContentTypes']] = relationship('PublicSTPDocumentContentTypes', uselist=True, foreign_keys='[PublicSTPDocumentContentTypes.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSTPDocumentContentTypes(Base):
    __tablename__ = 'public.STPDocumentContentTypes'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPDocumentContentTypes_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPDocumentContentTypes_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPDocumentContentTypes_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPDocumentContentTypes_fk3'),
        PrimaryKeyConstraint('RecId', name='STPDocumentContentTypes_pk'),
        Index('DocumentContentTypes_ContentType_index', 'ContentType', 'OrganizationId', 'SubOrganizationId', unique=True)
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    ContentType = mapped_column(String(100))
    Extension = mapped_column(String(50))
    Enabled = mapped_column(String(50))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPDocumentContentTypes')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPDocumentContentTypes_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPDocumentContentTypes')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPDocumentContentTypes_')
