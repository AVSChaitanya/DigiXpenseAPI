...
class PublicSYSUsers(Base):
    ...
    public_STPProjectGroups: Mapped[List['PublicSTPProjectGroups']] = relationship('PublicSTPProjectGroups', uselist=True, foreign_keys='[PublicSTPProjectGroups.CreatedBy]', back_populates='public_SYSUsers')
    public_STPProjectGroups_: Mapped[List['PublicSTPProjectGroups']] = relationship('PublicSTPProjectGroups', uselist=True, foreign_keys='[PublicSTPProjectGroups.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPProjectGroups: Mapped[List['PublicSTPProjectGroups']] = relationship('PublicSTPProjectGroups', uselist=True, foreign_keys='[PublicSTPProjectGroups.OrganizationId]', back_populates='public_STPOrganization')
    public_STPProjectGroups_: Mapped[List['PublicSTPProjectGroups']] = relationship('PublicSTPProjectGroups', uselist=True, foreign_keys='[PublicSTPProjectGroups.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicFINLedgerAccount(Base):
    ...
    public_STPProjectGroups: Mapped[List['PublicSTPProjectGroups']] = relationship('PublicSTPProjectGroups', uselist=True, back_populates='public_FINLedgerAccount')


class PublicSTPProjectGroups(Base):
    __tablename__ = 'public.STPProjectGroups'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPProjectGroups_fk2'),
        ForeignKeyConstraint(['LedgerAccount'], ['public.FINLedgerAccount.LedgerAccountId'], name='STPProjectGroups_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPProjectGroups_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPProjectGroups_fk4'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPProjectGroups_fk5'),
        PrimaryKeyConstraint('RecId', name='STPProjectGroups_pk'),
        UniqueConstraint('ProjectGroupId', name='unique_project_group_id')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    ProjectName = mapped_column(String(120))
    Description = mapped_column(String(250))
    LedgerAccount = mapped_column(String(40))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPProjectGroups')
    public_FINLedgerAccount: Mapped[Optional['PublicFINLedgerAccount']] = relationship('PublicFINLedgerAccount', back_populates='public_STPProjectGroups')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPProjectGroups_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPProjectGroups')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPProjectGroups_')
