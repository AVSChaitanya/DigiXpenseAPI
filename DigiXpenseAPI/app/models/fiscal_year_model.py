...
class PublicSYSUsers(Base):
    ...
    public_STPFiscalYear: Mapped[List['PublicSTPFiscalYear']] = relationship('PublicSTPFiscalYear', uselist=True, foreign_keys='[PublicSTPFiscalYear.CreatedBy]', back_populates='public_SYSUsers')
    public_STPFiscalYear_: Mapped[List['PublicSTPFiscalYear']] = relationship('PublicSTPFiscalYear', uselist=True, foreign_keys='[PublicSTPFiscalYear.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPFiscalYear: Mapped[List['PublicSTPFiscalYear']] = relationship('PublicSTPFiscalYear', uselist=True, foreign_keys='[PublicSTPFiscalYear.OrganizationId]', back_populates='public_STPOrganization')
    public_STPFiscalYear_: Mapped[List['PublicSTPFiscalYear']] = relationship('PublicSTPFiscalYear', uselist=True, foreign_keys='[PublicSTPFiscalYear.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSTPFiscalYear(Base):
    __tablename__ = 'public.STPFiscalYear'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPFiscalYear_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPFiscalYear_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPFiscalYear_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPFiscalYear_fk3'),
        PrimaryKeyConstraint('RecId', name='STPFiscalYear_pk'),
        UniqueConstraint('FiscalYearId', name='public.STPFiscalYear_FiscalYearId_key'),
        Index('FiscalYear_FiscalYearId_index', 'FiscalYearId', 'OrganizationId', 'SubOrganizationId')
    )

    FiscalYearId = mapped_column(String(30), nullable=False)
    YearStart = mapped_column(Date, nullable=False)
    YearEnd = mapped_column(Date, nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    PeriodOpenClose = mapped_column(Boolean, server_default=text('true'))
    CreatedDatetime = mapped_column(DateTime)
    ModifiedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPFiscalYear')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPFiscalYear_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPFiscalYear')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPFiscalYear_')
