...
class PublicSYSUsers(Base):
    ...
    public_SYSUserRoleMappings: Mapped[List['PublicSYSUserRoleMappings']] = relationship('PublicSYSUserRoleMappings', uselist=True, foreign_keys='[PublicSYSUserRoleMappings.CreatedBy]', back_populates='public_SYSUsers')
    public_SYSUserRoleMappings_: Mapped[List['PublicSYSUserRoleMappings']] = relationship('PublicSYSUserRoleMappings', uselist=True, foreign_keys='[PublicSYSUserRoleMappings.ModifiedBy]', back_populates='public_SYSUsers_')
    public_SYSUserRoleMappings1: Mapped[List['PublicSYSUserRoleMappings']] = relationship('PublicSYSUserRoleMappings', uselist=True, foreign_keys='[PublicSYSUserRoleMappings.UserId]', back_populates='public_SYSUsers1')
...
class PublicSTPOrganization(Base):
    ...
    public_SYSUserRoleMappings: Mapped[List['PublicSYSUserRoleMappings']] = relationship('PublicSYSUserRoleMappings', uselist=True, foreign_keys='[PublicSYSUserRoleMappings.OrganizationId]', back_populates='public_STPOrganization')
    public_SYSUserRoleMappings_: Mapped[List['PublicSYSUserRoleMappings']] = relationship('PublicSYSUserRoleMappings', uselist=True, foreign_keys='[PublicSYSUserRoleMappings.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicSYSRoles(Base):
    ...
    public_SYSUserRoleMappings: Mapped[List['PublicSYSUserRoleMappings']] = relationship('PublicSYSUserRoleMappings', uselist=True, back_populates='public_SYSRoles')


class PublicSYSUserRoleMappings(Base):
    __tablename__ = 'public.SYSUserRoleMappings'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='SYSUserRoleMappings_fk2'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='SYSUserRoleMappings_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSUserRoleMappings_fk4'),
        ForeignKeyConstraint(['RoleId'], ['public.SYSRoles.RoleId'], name='SYSUserRoleMappings_fk0'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSUserRoleMappings_fk5'),
        ForeignKeyConstraint(['UserId'], ['public.SYSUsers.UserId'], name='SYSUserRoleMappings_fk1'),
        PrimaryKeyConstraint('RecId', name='SYSUserRoleMappings_pk'),
        UniqueConstraint('RoleMappingId', name='public.SYSUserRoleMappings_RoleMappingId_key'),
        Index('RoleMappings_RoleId_index', 'RoleId', 'OrganizationId', 'SubOrganizationId'),
        Index('RoleMappings_UserId_index', 'UserId', 'OrganizationId', 'SubOrganizationId')
    )
    ...
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    RoleMappingId = mapped_column(String(30), server_default=text("('ROLEMAP-'::text || (nextval('userrolemappings_id_seq'::regclass))::text)"))
    EffectiveFrom = mapped_column(Date)
    EffectiveTo = mapped_column(Date)
    CreatedBy = mapped_column(String(20))
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_SYSUserRoleMappings')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_SYSUserRoleMappings_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_SYSUserRoleMappings')
    public_SYSRoles: Mapped['PublicSYSRoles'] = relationship('PublicSYSRoles', back_populates='public_SYSUserRoleMappings')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_SYSUserRoleMappings_')
    public_SYSUsers1: Mapped['PublicSYSUsers'] = relationship('PublicSYSUsers', foreign_keys=[UserId], back_populates='public_SYSUserRoleMappings1')
