...
class PublicEMPEmployees(Base):
    ...
    public_EMPTrvprojectEmplMapping: Mapped[List['PublicEMPTrvprojectEmplMapping']] = relationship('PublicEMPTrvprojectEmplMapping', uselist=True, back_populates='public_EMPEmployees')
...
class PublicSYSUsers(Base):
    ...
    public_EMPTrvprojectEmplMapping: Mapped[List['PublicEMPTrvprojectEmplMapping']] = relationship('PublicEMPTrvprojectEmplMapping', uselist=True, foreign_keys='[PublicEMPTrvprojectEmplMapping.CreatedBy]', back_populates='public_SYSUsers')
    public_EMPTrvprojectEmplMapping_: Mapped[List['PublicEMPTrvprojectEmplMapping']] = relationship('PublicEMPTrvprojectEmplMapping', uselist=True, foreign_keys='[PublicEMPTrvprojectEmplMapping.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_EMPTrvprojectEmplMapping: Mapped[List['PublicEMPTrvprojectEmplMapping']] = relationship('PublicEMPTrvprojectEmplMapping', uselist=True, foreign_keys='[PublicEMPTrvprojectEmplMapping.OrganizationId]', back_populates='public_STPOrganization')
    public_EMPTrvprojectEmplMapping_: Mapped[List['PublicEMPTrvprojectEmplMapping']] = relationship('PublicEMPTrvprojectEmplMapping', uselist=True, foreign_keys='[PublicEMPTrvprojectEmplMapping.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicSTPProjects(Base):
    ...
    public_EMPTrvprojectEmplMapping: Mapped[List['PublicEMPTrvprojectEmplMapping']] = relationship('PublicEMPTrvprojectEmplMapping', uselist=True, back_populates='public_STPProjects')


class PublicEMPTrvprojectEmplMapping(Base):
    __tablename__ = 'public.EMPTrvprojectEmplMapping'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='EMPTrvprojectEmplMapping_fk2'),
        ForeignKeyConstraint(['EmployeeId'], ['public.EMPEmployees.Id'], name='EMPTrvprojectEmplMapping_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='EMPTrvprojectEmplMapping_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPTrvprojectEmplMapping_fk4'),
        ForeignKeyConstraint(['ProjectId'], ['public.STPProjects.ProjectId'], name='EMPTrvprojectEmplMapping_fk0'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPTrvprojectEmplMapping_fk5'),
        PrimaryKeyConstraint('RecId', name='EMPTrvprojectEmplMapping_pk'),
        UniqueConstraint('ProjectEmployeeMappingId', name='public.EMPTrvprojectEmplMapping_ProjectEmployeeMappingId_key'),
        Index('TrvEmplMapping_EmployeeId_index', 'EmployeeId', 'OrganizationId', 'SubOrganizationId'),
        Index('TrvEmplMapping_ProjectId_index', 'ProjectId', 'OrganizationId', 'SubOrganizationId')
    )
    ...
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    ProjectEmployeeMappingId = mapped_column(String(20), server_default=text("('PEM-'::text || (nextval('projectemployeemappingid_id_seq'::regclass))::text)"))
    EmployeeName = mapped_column(String(120))
    EffectiveFrom = mapped_column(Date)
    EffectiveTo = mapped_column(Date)
    AllowExpenseRegistration = mapped_column(Boolean, server_default=text('true'))
    CreatedBy = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_EMPTrvprojectEmplMapping')
    public_EMPEmployees: Mapped['PublicEMPEmployees'] = relationship('PublicEMPEmployees', back_populates='public_EMPTrvprojectEmplMapping')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_EMPTrvprojectEmplMapping_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_EMPTrvprojectEmplMapping')
    public_STPProjects: Mapped['PublicSTPProjects'] = relationship('PublicSTPProjects', back_populates='public_EMPTrvprojectEmplMapping')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_EMPTrvprojectEmplMapping_')
