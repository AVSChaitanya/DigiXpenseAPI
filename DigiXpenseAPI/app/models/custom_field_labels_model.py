...
class PublicSTPLanguageGlobal(Base):
    ...
    public_STPCustomFieldLabels: Mapped[List['PublicSTPCustomFieldLabels']] = relationship('PublicSTPCustomFieldLabels', uselist=True, back_populates='public_STPLanguageGlobal')
...
class PublicSYSUsers(Base):
    ...
    public_STPCustomFields: Mapped[List['PublicSTPCustomFields']] = relationship('PublicSTPCustomFields', uselist=True, foreign_keys='[PublicSTPCustomFields.CreatedBy]', back_populates='public_SYSUsers')
    public_STPCustomFields_: Mapped[List['PublicSTPCustomFields']] = relationship('PublicSTPCustomFields', uselist=True, foreign_keys='[PublicSTPCustomFields.ModifiedBy]', back_populates='public_SYSUsers_')
    public_STPCustomFieldLabels: Mapped[List['PublicSTPCustomFieldLabels']] = relationship('PublicSTPCustomFieldLabels', uselist=True, foreign_keys='[PublicSTPCustomFieldLabels.CreatedBy]', back_populates='public_SYSUsers')
    public_STPCustomFieldLabels_: Mapped[List['PublicSTPCustomFieldLabels']] = relationship('PublicSTPCustomFieldLabels', uselist=True, foreign_keys='[PublicSTPCustomFieldLabels.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPCustomFields: Mapped[List['PublicSTPCustomFields']] = relationship('PublicSTPCustomFields', uselist=True, foreign_keys='[PublicSTPCustomFields.OrganizationId]', back_populates='public_STPOrganization')
    public_STPCustomFields_: Mapped[List['PublicSTPCustomFields']] = relationship('PublicSTPCustomFields', uselist=True, foreign_keys='[PublicSTPCustomFields.SubOrganizationId]', back_populates='public_STPOrganization_')
    public_STPCustomFieldLabels: Mapped[List['PublicSTPCustomFieldLabels']] = relationship('PublicSTPCustomFieldLabels', uselist=True, foreign_keys='[PublicSTPCustomFieldLabels.OrganizationId]', back_populates='public_STPOrganization')
    public_STPCustomFieldLabels_: Mapped[List['PublicSTPCustomFieldLabels']] = relationship('PublicSTPCustomFieldLabels', uselist=True, foreign_keys='[PublicSTPCustomFieldLabels.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSTPCustomFields(Base):
    __tablename__ = 'public.STPCustomFields'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPCustomFileds_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPCustomFileds_fk2'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPCustomFileds_fk3'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPCustomFileds_fk4'),
        PrimaryKeyConstraint('RecId', name='STPCustomFileds_pk'),
        UniqueConstraint('FieldId', name='public.STPCustomFileds_FieldId_key')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer, Sequence('public.STPCustomFileds_RecId_seq'))
    FieldId = mapped_column(String(20), server_default=text("('FI-'::text || (nextval('customfileds_id_seq'::regclass))::text)"))
    ObjectName = mapped_column(Enum('EXPExpenseCategories', 'EMPEmployee', 'EXPExpenseHeader', 'EXPExpenseTrans', name='ObjectName'))
    FieldName = mapped_column(Enum('Merchant', 'Category', 'Project', 'Paid With', 'Comment', 'Country', 'Vat Amount', 'Vat Percentage', name='fieldname'))
    FieldLabel = mapped_column(String(30))
    FieldType = mapped_column(Enum('Email', 'Date', 'Amount', 'Integer', 'Decimal', 'List', 'Url', 'Text', 'Date&Time', 'Percent', 'Checkbox', 'Long Integer', name='FieldType'))
    AllowDuplicates = mapped_column(Boolean, server_default=text('true'))
    ShowTooltip = mapped_column(Boolean, server_default=text('true'))
    Ismandatory = mapped_column(Boolean, server_default=text('true'))
    Tooltip = mapped_column(String(500))
    DefaultValue = mapped_column(String(60))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPCustomFields')
    ...
    public_STPCustomFieldLabels: Mapped[List['PublicSTPCustomFieldLabels']] = relationship('PublicSTPCustomFieldLabels', uselist=True, back_populates='public_STPCustomFields')


class PublicSTPCustomFieldLabels(Base):
    __tablename__ = 'public.STPCustomFieldLabels'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPCustomFieldLabels_fk2'),
        ForeignKeyConstraint(['FieldId'], ['public.STPCustomFields.FieldId'], name='STPCustomFieldLabels_fk0'),
        ForeignKeyConstraint(['LanguageId'], ['public.STPLanguageGlobal.LanguageId'], name='STPCustomFieldLabels_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPCustomFieldLabels_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPCustomFieldLabels_fk4'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPCustomFieldLabels_fk5'),
        PrimaryKeyConstraint('RecId', name='STPCustomFieldLabels_pk'),
        Index('CustomFiel_FieldId_index', 'FieldId', 'OrganizationId', 'SubOrganizationId', unique=True)
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    FieldId = mapped_column(String(20))
    LanguageId = mapped_column(String(20))
    ObjectName = mapped_column(String(20))
    FieldLabel = mapped_column(String(60))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPCustomFieldLabels')
    public_STPCustomFields: Mapped[Optional['PublicSTPCustomFields']] = relationship('PublicSTPCustomFields', back_populates='public_STPCustomFieldLabels')
    public_STPLanguageGlobal: Mapped[Optional['PublicSTPLanguageGlobal']] = relationship('PublicSTPLanguageGlobal', back_populates='public_STPCustomFieldLabels')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPCustomFieldLabels_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPCustomFieldLabels')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPCustomFieldLabels_')
