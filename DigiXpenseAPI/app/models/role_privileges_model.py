...
class PublicSYSUsers(Base):
    ...
    public_SYSFunctionalEntities: Mapped[List['PublicSYSFunctionalEntities']] = relationship('PublicSYSFunctionalEntities', uselist=True, foreign_keys='[PublicSYSFunctionalEntities.CreatedBy]', back_populates='public_SYSUsers')
    public_SYSFunctionalEntities_: Mapped[List['PublicSYSFunctionalEntities']] = relationship('PublicSYSFunctionalEntities', uselist=True, foreign_keys='[PublicSYSFunctionalEntities.ModifiedBy]', back_populates='public_SYSUsers_')
    public_SYSRoles: Mapped[List['PublicSYSRoles']] = relationship('PublicSYSRoles', uselist=True, foreign_keys='[PublicSYSRoles.CreatedBy]', back_populates='public_SYSUsers')
    public_SYSRoles_: Mapped[List['PublicSYSRoles']] = relationship('PublicSYSRoles', uselist=True, foreign_keys='[PublicSYSRoles.ModifiedBy]', back_populates='public_SYSUsers_')
    public_SYSRolePrivileges: Mapped[List['PublicSYSRolePrivileges']] = relationship('PublicSYSRolePrivileges', uselist=True, foreign_keys='[PublicSYSRolePrivileges.CreatedBy]', back_populates='public_SYSUsers')
    public_SYSRolePrivileges_: Mapped[List['PublicSYSRolePrivileges']] = relationship('PublicSYSRolePrivileges', uselist=True, foreign_keys='[PublicSYSRolePrivileges.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_SYSFunctionalEntities: Mapped[List['PublicSYSFunctionalEntities']] = relationship('PublicSYSFunctionalEntities', uselist=True, foreign_keys='[PublicSYSFunctionalEntities.OrganizationId]', back_populates='public_STPOrganization')
    public_SYSFunctionalEntities_: Mapped[List['PublicSYSFunctionalEntities']] = relationship('PublicSYSFunctionalEntities', uselist=True, foreign_keys='[PublicSYSFunctionalEntities.SubOrganizationId]', back_populates='public_STPOrganization_')
    public_SYSRoles: Mapped[List['PublicSYSRoles']] = relationship('PublicSYSRoles', uselist=True, foreign_keys='[PublicSYSRoles.OrganizationId]', back_populates='public_STPOrganization')
    public_SYSRoles_: Mapped[List['PublicSYSRoles']] = relationship('PublicSYSRoles', uselist=True, foreign_keys='[PublicSYSRoles.SubOrganizationId]', back_populates='public_STPOrganization_')
    public_SYSRolePrivileges: Mapped[List['PublicSYSRolePrivileges']] = relationship('PublicSYSRolePrivileges', uselist=True, foreign_keys='[PublicSYSRolePrivileges.OrganizationId]', back_populates='public_STPOrganization')
    public_SYSRolePrivileges_: Mapped[List['PublicSYSRolePrivileges']] = relationship('PublicSYSRolePrivileges', uselist=True, foreign_keys='[PublicSYSRolePrivileges.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSYSFunctionalEntities(Base):
    __tablename__ = 'public.SYSFunctionalEntities'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='SYSFunctionalEntities_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='SYSFunctionalEntities_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSFunctionalEntities_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSFunctionalEntities_fk3'),
        PrimaryKeyConstraint('RecId', name='SYSFunctionalEntities_pk'),
        UniqueConstraint('FunctionalEntityId', name='public.SYSFunctionalEntities_FunctionalEntityId_key'),
        UniqueConstraint('FunctionalEntityName', name='public.SYSFunctionalEntities_FunctionalEntityName_key'),
        Index('FunctionalEntities_FunctionalEntityName_index', 'FunctionalEntityName', 'OrganizationId', 'SubOrganizationId', unique=True)
    )

    FunctionalEntityName = mapped_column(String(30), nullable=False)
    FunctionalEntityDescription = mapped_column(Text, nullable=False)
    LinkedTables = mapped_column(String(40), nullable=False)
    RecId = mapped_column(Integer)
    FunctionalEntityId = mapped_column(String(30), server_default=text("('FUNC-'::text || (nextval('functionalentities_id_seq'::regclass))::text)"))
    EffectiveFrom = mapped_column(Date)
    EffectiveTo = mapped_column(Date)
    CreatedDatetime = mapped_column(DateTime)
    ModifiedDatetime = mapped_column(DateTime)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_SYSFunctionalEntities')
...
class PublicSYSRoles(Base):
    __tablename__ = 'public.SYSRoles'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='SYSRoles_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='SYSRoles_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSRoles_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSRoles_fk3'),
        PrimaryKeyConstraint('RecId', name='SYSRoles_pk'),
        UniqueConstraint('RoleId', name='public.SYSRoles_RoleId_key'),
        UniqueConstraint('RoleName', name='public.SYSRoles_RoleName_key'),
        Index('Roles_RoleId_index', 'RoleId', 'OrganizationId', 'SubOrganizationId', unique=True)
    )

    RoleId = mapped_column(String(20), nullable=False)
    RoleName = mapped_column(String(30), nullable=False)
    Description = mapped_column(String(250), nullable=False)
    RoleType = mapped_column(String(100), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    EffectiveFrom = mapped_column(Date)
    EffectiveTo = mapped_column(Date)
    IsSysAdmin = mapped_column(Boolean, server_default=text('true'))
    CreatedBy = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    SystemRole = mapped_column(String(50))
    IsActive = mapped_column(Boolean, server_default=text('true'))
    SubOrganizationId = mapped_column(Integer)

    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_SYSRoles')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_SYSRoles_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_SYSRoles')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_SYSRoles_')
    public_SYSRolePrivileges: Mapped[List['PublicSYSRolePrivileges']] = relationship('PublicSYSRolePrivileges', uselist=True, back_populates='public_SYSRoles')


class PublicSYSRolePrivileges(Base):
    __tablename__ = 'public.SYSRolePrivileges'
    __table_args__ = (
        ...
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSRolePrivileges_fk5'),
        PrimaryKeyConstraint('RecId', name='SYSRolePrivileges_pk'),
        UniqueConstraint('PrivilegeId', name='public.SYSRolePrivileges_PrivilegeId_key'),
        Index('RolePrivileges_FunctionalEntityId_index', 'FunctionalEntityId', 'OrganizationId', 'SubOrganizationId'),
        Index('RolePrivileges_RoleId_index', 'RoleId', 'OrganizationId', 'SubOrganizationId')
    )

    RecId = mapped_column(Integer)
    PrivilegeId = mapped_column(String(20), server_default=text("('PRIV-'::text || (nextval('roleprivileges_id_seq'::regclass))::text)"))
    RoleId = mapped_column(String(20))
    FunctionalEntityId = mapped_column(String(30))
    Read = mapped_column(Boolean, server_default=text('true'))
    Write = mapped_column(Boolean, server_default=text('true'))
    Update = mapped_column(Boolean, server_default=text('true'))
    Delete = mapped_column(Boolean, server_default=text('true'))
    CreatedBy = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ...
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_SYSRolePrivileges_')
