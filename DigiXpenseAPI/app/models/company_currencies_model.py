...
class PublicSTPGlobalCurrency(Base):
    ...
    public_STPCompanyCurrencies: Mapped['PublicSTPCompanyCurrencies'] = relationship('PublicSTPCompanyCurrencies', uselist=False, back_populates='public_STPGlobalCurrency')
...
class PublicSYSUsers(Base):
    ...
    public_STPCompanyCurrencies: Mapped[List['PublicSTPCompanyCurrencies']] = relationship('PublicSTPCompanyCurrencies', uselist=True, foreign_keys='[PublicSTPCompanyCurrencies.CreatedBy]', back_populates='public_SYSUsers')
    public_STPCompanyCurrencies_: Mapped[List['PublicSTPCompanyCurrencies']] = relationship('PublicSTPCompanyCurrencies', uselist=True, foreign_keys='[PublicSTPCompanyCurrencies.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPCompanyCurrencies: Mapped[List['PublicSTPCompanyCurrencies']] = relationship('PublicSTPCompanyCurrencies', uselist=True, foreign_keys='[PublicSTPCompanyCurrencies.OrganizationId]', back_populates='public_STPOrganization')
    public_STPCompanyCurrencies_: Mapped[List['PublicSTPCompanyCurrencies']] = relationship('PublicSTPCompanyCurrencies', uselist=True, foreign_keys='[PublicSTPCompanyCurrencies.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSTPCompanyCurrencies(Base):
    __tablename__ = 'public.STPCompanyCurrencies'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPCompanyCurrencies_fk2'),
        ForeignKeyConstraint(['CurrencyCode'], ['public.STPGlobalCurrency.CurrencyCode'], name='STPCompanyCurrencies_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPCompanyCurrencies_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPCompanyCurrencies_fk4'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPCompanyCurrencies_fk5'),
        PrimaryKeyConstraint('RecId', name='STPCompanyCurrencies_pk'),
        UniqueConstraint('CurrencyCode', name='public.STPCompanyCurrencies_CurrencyCode_key'),
        UniqueConstraint('CurrencyName', name='public.STPCompanyCurrencies_CurrencyName_key'),
        UniqueConstraint('CurrencySymbol', name='public.STPCompanyCurrencies_CurrencySymbol_key'),
        Index('Currencies_CurrencyCode_index', 'CurrencyCode', 'OrganizationId', 'SubOrganizationId', unique=True)
    )

    CurrencyCode = mapped_column(String(30), nullable=False)
    CurrencyName = mapped_column(String(30), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    CurrencySymbol = mapped_column(String(10))
    CurrencyFormat = mapped_column(String(30))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPCompanyCurrencies')
    public_STPGlobalCurrency: Mapped['PublicSTPGlobalCurrency'] = relationship('PublicSTPGlobalCurrency', back_populates='public_STPCompanyCurrencies')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPCompanyCurrencies_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPCompanyCurrencies')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPCompanyCurrencies_')
