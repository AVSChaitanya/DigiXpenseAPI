...
class PublicSYSUsers(Base):
    ...
    public_SYSDisplayFields: Mapped[List['PublicSYSDisplayFields']] = relationship('PublicSYSDisplayFields', uselist=True, foreign_keys='[PublicSYSDisplayFields.CreatedBy]', back_populates='public_SYSUsers')
    public_SYSDisplayFields_: Mapped[List['PublicSYSDisplayFields']] = relationship('PublicSYSDisplayFields', uselist=True, foreign_keys='[PublicSYSDisplayFields.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_SYSDisplayFields: Mapped[List['PublicSYSDisplayFields']] = relationship('PublicSYSDisplayFields', uselist=True, foreign_keys='[PublicSYSDisplayFields.OrganizationId]', back_populates='public_STPOrganization')
    public_SYSDisplayFields_: Mapped[List['PublicSYSDisplayFields']] = relationship('PublicSYSDisplayFields', uselist=True, foreign_keys='[PublicSYSDisplayFields.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicSYSRoles(Base):
    ...
    public_SYSDisplayFields: Mapped[List['PublicSYSDisplayFields']] = relationship('PublicSYSDisplayFields', uselist=True, back_populates='public_SYSRoles')


class PublicSYSDisplayFields(Base):
    __tablename__ = 'public.SYSDisplayFields'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='SYSDisplayFields_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='SYSDisplayFields_fk2'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSDisplayFields_fk3'),
        ForeignKeyConstraint(['RoleId'], ['public.SYSRoles.RoleId'], name='SYSDisplayFields_fk0'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSDisplayFields_fk4'),
        PrimaryKeyConstraint('RecId', name='SYSDisplayFields_pk'),
        UniqueConstraint('DisplayFieldId', name='public.SYSDisplayFields_DisplayFieldId_key')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    DisplayFieldId = mapped_column(String(20), server_default=text("('DISPLAY-'::text || (nextval('displayfields_id_seq'::regclass))::text)"))
    ...
    Visibility = mapped_column(Boolean, server_default=text('true'))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_SYSDisplayFields')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_SYSDisplayFields_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_SYSDisplayFields')
    public_SYSRoles: Mapped[Optional['PublicSYSRoles']] = relationship('PublicSYSRoles', back_populates='public_SYSDisplayFields')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_SYSDisplayFields_')
