...
class PublicSYSUsers(Base):
    ...
    public_STPOrgDocumentFileTypes: Mapped[List['PublicSTPOrgDocumentFileTypes']] = relationship('PublicSTPOrgDocumentFileTypes', uselist=True, foreign_keys='[PublicSTPOrgDocumentFileTypes.CreatedBy]', back_populates='public_SYSUsers')
    public_STPOrgDocumentFileTypes_: Mapped[List['PublicSTPOrgDocumentFileTypes']] = relationship('PublicSTPOrgDocumentFileTypes', uselist=True, foreign_keys='[PublicSTPOrgDocumentFileTypes.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPOrgDocumentFileTypes: Mapped[List['PublicSTPOrgDocumentFileTypes']] = relationship('PublicSTPOrgDocumentFileTypes', uselist=True, foreign_keys='[PublicSTPOrgDocumentFileTypes.OrganizationId]', back_populates='public_STPOrganization')
    public_STPOrgDocumentFileTypes_: Mapped[List['PublicSTPOrgDocumentFileTypes']] = relationship('PublicSTPOrgDocumentFileTypes', uselist=True, foreign_keys='[PublicSTPOrgDocumentFileTypes.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSTPOrgDocumentFileTypes(Base):
    __tablename__ = 'public.STPOrgDocumentFileTypes'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPOrgDocumentFileTypes_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPOrgDocumentFileTypes_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPOrgDocumentFileTypes_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPOrgDocumentFileTypes_fk3'),
        PrimaryKeyConstraint('RecId', name='STPOrgDocumentFileTypes_pk'),
        UniqueConstraint('OrgDocumentFileId', name='public.STPOrgDocumentFileTypes_OrgDocumentFileId_key'),
        Index('DocumentFile_OrgDocumentFileId_index', 'FileTypes', 'OrganizationId', 'SubOrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    OrgDocumentFileId = mapped_column(String(20), server_default=text("('ODFI-'::text || (nextval('odft_id_seq'::regclass))::text)"))
    FileTypes = mapped_column(String(20))
    Description = mapped_column(String(300))
    NativelyWebRendarable = mapped_column(String(300))
    FileExtension = mapped_column(String(50))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPOrgDocumentFileTypes')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPOrgDocumentFileTypes_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPOrgDocumentFileTypes')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPOrgDocumentFileTypes_')
