...
class PublicEMPEmployees(Base):
    ...
    public_EMPEmployeeBandMapping: Mapped[List['PublicEMPEmployeeBandMapping']] = relationship('PublicEMPEmployeeBandMapping', uselist=True, back_populates='public_EMPEmployees')
...
class PublicSYSUsers(Base):
    ...
    public_EMPEmployeeBandMapping: Mapped[List['PublicEMPEmployeeBandMapping']] = relationship('PublicEMPEmployeeBandMapping', uselist=True, foreign_keys='[PublicEMPEmployeeBandMapping.CreatedBy]', back_populates='public_SYSUsers')
    public_EMPEmployeeBandMapping_: Mapped[List['PublicEMPEmployeeBandMapping']] = relationship('PublicEMPEmployeeBandMapping', uselist=True, foreign_keys='[PublicEMPEmployeeBandMapping.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_EMPEmployeeBandMapping: Mapped[List['PublicEMPEmployeeBandMapping']] = relationship('PublicEMPEmployeeBandMapping', uselist=True, foreign_keys='[PublicEMPEmployeeBandMapping.OrganizationId]', back_populates='public_STPOrganization')
    public_EMPEmployeeBandMapping_: Mapped[List['PublicEMPEmployeeBandMapping']] = relationship('PublicEMPEmployeeBandMapping', uselist=True, foreign_keys='[PublicEMPEmployeeBandMapping.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicEMPEmployeeBands(Base):
    ...
    public_EMPEmployeeBandMapping: Mapped[List['PublicEMPEmployeeBandMapping']] = relationship('PublicEMPEmployeeBandMapping', uselist=True, back_populates='public_EMPEmployeeBands')


class PublicEMPEmployeeBandMapping(Base):
    __tablename__ = 'public.EMPEmployeeBandMapping'
    __table_args__ = (
        ForeignKeyConstraint(['BandId'], ['public.EMPEmployeeBands.BandId'], name='EMPEmployeeBandMapping_fk1'),
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='EMPEmployeeBandMapping_fk2'),
        ForeignKeyConstraint(['EmployeeId'], ['public.EMPEmployees.Id'], name='EMPEmployeeBandMapping_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='EMPEmployeeBandMapping_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmployeeBandMapping_fk4'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmployeeBandMapping_fk5'),
        PrimaryKeyConstraint('RecId', name='EMPEmployeeBandMapping_pk'),
        UniqueConstraint('BandMapppingId', name='public.EMPEmployeeBandMapping_BandMapppingId_key'),
        Index('BandMapping_BandId_index', 'BandId', 'OrganizationId', 'SubOrganizationId'),
        Index('BandMapping_EmployeeId_index', 'EmployeeId', 'OrganizationId', 'SubOrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    BandMapppingId = mapped_column(String(20), server_default=text("('BANDMAP-'::text || (nextval('employeebandmapping_id_seq'::regclass))::text)"))
    EmployeeId = mapped_column(String(20))
    BandId = mapped_column(String(20))
    EffectiveFrom = mapped_column(Date)
    EffectiveTo = mapped_column(Date)
    CreatedBy = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    ...
    public_EMPEmployeeBands: Mapped[Optional['PublicEMPEmployeeBands']] = relationship('PublicEMPEmployeeBands', back_populates='public_EMPEmployeeBandMapping')
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_EMPEmployeeBandMapping')
    public_EMPEmployees: Mapped[Optional['PublicEMPEmployees']] = relationship('PublicEMPEmployees', back_populates='public_EMPEmployeeBandMapping')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_EMPEmployeeBandMapping_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_EMPEmployeeBandMapping')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_EMPEmployeeBandMapping_')
