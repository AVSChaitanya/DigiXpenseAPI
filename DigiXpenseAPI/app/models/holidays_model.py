...
class PublicSTPCalendar(Base):
    ...
    public_STPHolidays: Mapped[List['PublicSTPHolidays']] = relationship('PublicSTPHolidays', uselist=True, back_populates='public_STPCalendar')


class PublicSTPHolidays(Base):
    __tablename__ = 'public.STPHolidays'
    __table_args__ = (
        ForeignKeyConstraint(['CalendarId'], ['public.STPCalendar.CalendarId'], name='STPHolidays_fk1'),
        PrimaryKeyConstraint('RecId', name='STPHoliday_pk'),
        UniqueConstraint('HolidayId', name='public.STPHolidays_HolidayId_key'),
        UniqueConstraint('HolidayName', name='public.STPHolidays_HolidayName_key')
    )

    HolidayId = mapped_column(String(20), nullable=False)
    HolidayDate = mapped_column(Date, nullable=False)
    HolidayName = mapped_column(String(20), nullable=False)
    RecId = mapped_column(Integer)
    ...
    public_STPCalendar: Mapped[Optional['PublicSTPCalendar']] = relationship('PublicSTPCalendar', back_populates='public_STPHolidays')
