...
class PublicSYSUsers(Base):
    ...
    public_SYSWorkflowTemplateLines: Mapped[List['PublicSYSWorkflowTemplateLines']] = relationship('PublicSYSWorkflowTemplateLines', uselist=True, foreign_keys='[PublicSYSWorkflowTemplateLines.CreatedBy]', back_populates='public_SYSUsers')
    public_SYSWorkflowTemplateLines_: Mapped[List['PublicSYSWorkflowTemplateLines']] = relationship('PublicSYSWorkflowTemplateLines', uselist=True, foreign_keys='[PublicSYSWorkflowTemplateLines.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_SYSWorkflowTemplateLines: Mapped[List['PublicSYSWorkflowTemplateLines']] = relationship('PublicSYSWorkflowTemplateLines', uselist=True, foreign_keys='[PublicSYSWorkflowTemplateLines.OrganizationId]', back_populates='public_STPOrganization')
    public_SYSWorkflowTemplateLines_: Mapped[List['PublicSYSWorkflowTemplateLines']] = relationship('PublicSYSWorkflowTemplateLines', uselist=True, foreign_keys='[PublicSYSWorkflowTemplateLines.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicSYSWorkflowTemplateTable(Base):
    ...
    public_SYSWorkflowTemplateLines: Mapped[List['PublicSYSWorkflowTemplateLines']] = relationship('PublicSYSWorkflowTemplateLines', uselist=True, back_populates='public_SYSWorkflowTemplateTable')


class PublicSYSWorkflowTemplateLines(Base):
    __tablename__ = 'public.SYSWorkflowTemplateLines'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='SYSWorkflowTempLines_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='SYSWorkflowTempLines_fk2'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSWorkflowTempLines_fk3'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSWorkflowTempLines_fk4'),
        ForeignKeyConstraint(['WorkflowTemplateId'], ['public.SYSWorkflowTemplateTable.WorkflowId'], name='SYSWorkflowTempLines_fk0'),
        PrimaryKeyConstraint('RecId', name='SYSWorkflowTempLines_pk'),
        Index('WorkTempLines_WorkflowTemplateId_index', 'WorkflowTemplateId', 'SubOrganizationId', 'OrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    ConditionType = mapped_column(Enum('AlwaysExecute', 'ConditionalBased', name='conditiontype'))
    CompletionPolicy = mapped_column(Enum('SingleApprover', 'AllApprovers', 'MajorityOfApprovers', name='completionpolicy'))
    SlaDurationUnit = mapped_column(Enum('Days', 'Weeks', 'Months', name='sladurationunit'))
    SlaDuration = mapped_column(Integer)
    SlaRemainderBefore = mapped_column(Integer)
    WorkflowTemplateId = mapped_column(String(20))
    StepNumber = mapped_column(Integer)
    LineNumber = mapped_column(Integer)
    ParticipantType = mapped_column(Enum('RoleBased', 'UserBased', name='participanttype'))
    ParticipantRole = mapped_column(String(50))
    ParticipantUser = mapped_column(String(50))
    CreatedBy = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    IsActive = mapped_column(Boolean, server_default=text('true'))
    SubOrganizationId = mapped_column(Integer)
    Condition = mapped_column(Text)

    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_SYSWorkflowTemplateLines')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_SYSWorkflowTemplateLines_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_SYSWorkflowTemplateLines')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_SYSWorkflowTemplateLines_')
    public_SYSWorkflowTemplateTable: Mapped[Optional['PublicSYSWorkflowTemplateTable']] = relationship('PublicSYSWorkflowTemplateTable', back_populates='public_SYSWorkflowTemplateLines')
