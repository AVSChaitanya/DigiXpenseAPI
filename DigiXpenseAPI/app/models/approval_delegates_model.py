...
class PublicSYSUsers(Base):
    ...
    public_STPApprovalDelegates: Mapped[List['PublicSTPApprovalDelegates']] = relationship('PublicSTPApprovalDelegates', uselist=True, foreign_keys='[PublicSTPApprovalDelegates.CreatedBy]', back_populates='public_SYSUsers')
    public_STPApprovalDelegates_: Mapped[List['PublicSTPApprovalDelegates']] = relationship('PublicSTPApprovalDelegates', uselist=True, foreign_keys='[PublicSTPApprovalDelegates.DelegatedUserId]', back_populates='public_SYSUsers_')
    public_STPApprovalDelegates1: Mapped[List['PublicSTPApprovalDelegates']] = relationship('PublicSTPApprovalDelegates', uselist=True, foreign_keys='[PublicSTPApprovalDelegates.ModifiedBy]', back_populates='public_SYSUsers1')
    public_STPApprovalDelegates2: Mapped[List['PublicSTPApprovalDelegates']] = relationship('PublicSTPApprovalDelegates', uselist=True, foreign_keys='[PublicSTPApprovalDelegates.UserId]', back_populates='public_SYSUsers2')
...
class PublicSTPOrganization(Base):
    ...
    public_STPApprovalDelegates: Mapped[List['PublicSTPApprovalDelegates']] = relationship('PublicSTPApprovalDelegates', uselist=True, foreign_keys='[PublicSTPApprovalDelegates.OrganizationId]', back_populates='public_STPOrganization')
    public_STPApprovalDelegates_: Mapped[List['PublicSTPApprovalDelegates']] = relationship('PublicSTPApprovalDelegates', uselist=True, foreign_keys='[PublicSTPApprovalDelegates.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSTPApprovalDelegates(Base):
    __tablename__ = 'public.STPApprovalDelegates'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPApprovalDelegates_fk2'),
        ForeignKeyConstraint(['DelegatedUserId'], ['public.SYSUsers.UserId'], name='STPApprovalDelegates_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPApprovalDelegates_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPApprovalDelegates_fk4'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPApprovalDelegates_fk5'),
        ForeignKeyConstraint(['UserId'], ['public.SYSUsers.UserId'], name='STPApprovalDelegates_fk6'),
        PrimaryKeyConstraint('RecId', name='STPApprovalDelegates_pk'),
        Index('ApprovalDelegates_DelegatedUserId_index', 'DelegatedUserId', 'OrganizationId', 'SubOrganizationId')
    )

    DelegatedUserId = mapped_column(String(20), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    DelegatedUserName = mapped_column(String(30))
    EffectiveFrom = mapped_column(Date)
    EffectiveTo = mapped_column(Date)
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ...
    IsActive = mapped_column(Boolean, server_default=text('true'))
    SubOrganizationId = mapped_column(Integer)
    UserName = mapped_column(String(120))
    UserId = mapped_column(String(20))

    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPApprovalDelegates')
    public_SYSUsers_: Mapped['PublicSYSUsers'] = relationship('PublicSYSUsers', foreign_keys=[DelegatedUserId], back_populates='public_STPApprovalDelegates_')
    public_SYSUsers1: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPApprovalDelegates1')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPApprovalDelegates')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPApprovalDelegates_')
    public_SYSUsers2: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[UserId], back_populates='public_STPApprovalDelegates2')
