...
from sqlalchemy import Boolean, Column, Date, DateTime, Enum, ForeignKeyConstraint, Index, Integer, LargeBinary, Numeric, PrimaryKeyConstraint, Sequence, String, Text, UniqueConstraint, text
...
class PublicSYSUsers(Base):
    ...
    public_STPOrganizationLogo: Mapped[List['PublicSTPOrganizationLogo']] = relationship('PublicSTPOrganizationLogo', uselist=True, foreign_keys='[PublicSTPOrganizationLogo.CreatedBy]', back_populates='public_SYSUsers')
    public_STPOrganizationLogo_: Mapped[List['PublicSTPOrganizationLogo']] = relationship('PublicSTPOrganizationLogo', uselist=True, foreign_keys='[PublicSTPOrganizationLogo.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPOrganizationLogo: Mapped[List['PublicSTPOrganizationLogo']] = relationship('PublicSTPOrganizationLogo', uselist=True, foreign_keys='[PublicSTPOrganizationLogo.OrgId]', back_populates='public_STPOrganization')
    public_STPOrganizationLogo_: Mapped[List['PublicSTPOrganizationLogo']] = relationship('PublicSTPOrganizationLogo', uselist=True, foreign_keys='[PublicSTPOrganizationLogo.OrganizationId]', back_populates='public_STPOrganization_')
    public_STPOrganizationLogo1: Mapped[List['PublicSTPOrganizationLogo']] = relationship('PublicSTPOrganizationLogo', uselist=True, foreign_keys='[PublicSTPOrganizationLogo.SubOrganizationId]', back_populates='public_STPOrganization1')


class PublicSTPOrganizationLogo(Base):
    __tablename__ = 'public.STPOrganizationLogo'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPOrganisationLogo_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPOrganisationLogo_fk1'),
        ForeignKeyConstraint(['OrgId'], ['public.STPOrganization.OrganizationId'], name='STPOrganisationLogo_fk4'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPOrganisationLogo_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPOrganisationLogo_fk3'),
        PrimaryKeyConstraint('RecId', name='STPOrganisationLogo_pk'),
        UniqueConstraint('OrganizationLogoId', name='public.STPOrganisationLogo_OrganizationLogoId_key')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer, Sequence('public.STPOrganisationLogo_RecId_seq'))
    OrganizationLogoId = mapped_column(String(20), server_default=text("('OL'::text || (nextval('organizationlogo_id_seq'::regclass))::text)"))
    Logo = mapped_column(LargeBinary)
    ImageType = mapped_column(String(100))
    DarkLogo = mapped_column(LargeBinary)
    Favicon = mapped_column(LargeBinary)
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPOrganizationLogo')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPOrganizationLogo_')
    public_STPOrganization: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[OrgId], back_populates='public_STPOrganizationLogo')
    public_STPOrganization_: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPOrganizationLogo_')
    public_STPOrganization1: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPOrganizationLogo1')
