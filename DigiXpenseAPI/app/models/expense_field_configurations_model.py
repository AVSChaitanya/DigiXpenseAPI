...
class PublicSYSUsers(Base):
    ...
    public_EXPExpenseFieldConfigurations: Mapped[List['PublicEXPExpenseFieldConfigurations']] = relationship('PublicEXPExpenseFieldConfigurations', uselist=True, foreign_keys='[PublicEXPExpenseFieldConfigurations.CreatedBy]', back_populates='public_SYSUsers')
    public_EXPExpenseFieldConfigurations_: Mapped[List['PublicEXPExpenseFieldConfigurations']] = relationship('PublicEXPExpenseFieldConfigurations', uselist=True, foreign_keys='[PublicEXPExpenseFieldConfigurations.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_EXPExpenseFieldConfigurations: Mapped[List['PublicEXPExpenseFieldConfigurations']] = relationship('PublicEXPExpenseFieldConfigurations', uselist=True, foreign_keys='[PublicEXPExpenseFieldConfigurations.OrganizationId]', back_populates='public_STPOrganization')
    public_EXPExpenseFieldConfigurations_: Mapped[List['PublicEXPExpenseFieldConfigurations']] = relationship('PublicEXPExpenseFieldConfigurations', uselist=True, foreign_keys='[PublicEXPExpenseFieldConfigurations.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicEXPExpenseFieldConfigurations(Base):
    __tablename__ = 'public.EXPExpenseFieldConfigurations'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='EXPExpenseFieldConfigurations_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='EXPExpenseFieldConfigurations_fk2'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='EXPExpenseFieldConfigurations_fk3'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='EXPExpenseFieldConfigurations_fk4'),
        PrimaryKeyConstraint('RecId', name='EXPExpenseFieldConfigurations_pk'),
        Index('FieldConfig_FunctionalArea_index', 'FunctionalArea', 'OrganizationId', 'SubOrganizationId', unique=True)
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    FunctionalArea = mapped_column(String(255))
    FieldName = mapped_column(String(125))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_EXPExpenseFieldConfigurations')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_EXPExpenseFieldConfigurations_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_EXPExpenseFieldConfigurations')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_EXPExpenseFieldConfigurations_')
