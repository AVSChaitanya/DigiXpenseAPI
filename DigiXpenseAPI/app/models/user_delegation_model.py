...
class PublicEMPEmployees(Base):
    ...
    public_STPUserDelegation: Mapped[List['PublicSTPUserDelegation']] = relationship('PublicSTPUserDelegation', uselist=True, back_populates='public_EMPEmployees')
...
class PublicSYSUsers(Base):
    ...
    public_STPUserDelegation: Mapped[List['PublicSTPUserDelegation']] = relationship('PublicSTPUserDelegation', uselist=True, foreign_keys='[PublicSTPUserDelegation.CreatedBy]', back_populates='public_SYSUsers')
    public_STPUserDelegation_: Mapped[List['PublicSTPUserDelegation']] = relationship('PublicSTPUserDelegation', uselist=True, foreign_keys='[PublicSTPUserDelegation.DelegatedUserID]', back_populates='public_SYSUsers_')
    public_STPUserDelegation1: Mapped[List['PublicSTPUserDelegation']] = relationship('PublicSTPUserDelegation', uselist=True, foreign_keys='[PublicSTPUserDelegation.ModifiedBy]', back_populates='public_SYSUsers1')
...
class PublicSTPOrganization(Base):
    ...
    public_STPUserDelegation: Mapped[List['PublicSTPUserDelegation']] = relationship('PublicSTPUserDelegation', uselist=True, foreign_keys='[PublicSTPUserDelegation.OrganizationId]', back_populates='public_STPOrganization')
    public_STPUserDelegation_: Mapped[List['PublicSTPUserDelegation']] = relationship('PublicSTPUserDelegation', uselist=True, foreign_keys='[PublicSTPUserDelegation.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSTPUserDelegation(Base):
    __tablename__ = 'public.STPUserDelegation'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPUserDelegation_fk3'),
        ForeignKeyConstraint(['DelegatedUserID'], ['public.SYSUsers.UserId'], name='STPUserDelegation_fk1'),
        ForeignKeyConstraint(['EmployeeID'], ['public.EMPEmployees.Id'], name='STPUserDelegation_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPUserDelegation_fk4'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPUserDelegation_fk5'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPUserDelegation_fk6'),
        PrimaryKeyConstraint('RecId', name='STPUserDelegation_pk'),
        UniqueConstraint('UserDelegationId', name='public.STPUserDelegation_UserDelegationId_key'),
        Index('Delegation_EmployeeID_index', 'EmployeeID', 'OrganizationId', 'SubOrganizationId'),
        Index('Delegation_UserDelegationId_index', 'UserDelegationId', 'OrganizationId', 'SubOrganizationId')
    )

    DelegatedUserName = mapped_column(String(30), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    UserDelegationId = mapped_column(String(20), server_default=text("('UDI-'::text || (nextval('userdelegation_id_seq'::regclass))::text)"))
    EmployeeID = mapped_column(String(20))
    EmployeeName = mapped_column(String(60))
    DelegatedUserID = mapped_column(String(20))
    EffectiveFrom = mapped_column(DateTime)
    EffectiveTo = mapped_column(DateTime)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPUserDelegation')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[DelegatedUserID], back_populates='public_STPUserDelegation_')
    public_EMPEmployees: Mapped[Optional['PublicEMPEmployees']] = relationship('PublicEMPEmployees', back_populates='public_STPUserDelegation')
    public_SYSUsers1: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPUserDelegation1')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPUserDelegation')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPUserDelegation_')
