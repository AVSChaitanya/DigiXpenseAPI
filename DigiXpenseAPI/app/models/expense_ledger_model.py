...
class PublicEMPEmployees(Base):
    ...
    public_STPCards: Mapped[List['PublicSTPCards']] = relationship('PublicSTPCards', uselist=True, back_populates='public_EMPEmployees')
    ...
    public_FINExpenseLedger: Mapped[List['PublicFINExpenseLedger']] = relationship('PublicFINExpenseLedger', uselist=True, back_populates='public_EMPEmployees')
...
class PublicSYSUsers(Base):
    ...
    public_STPBanktable: Mapped[List['PublicSTPBanktable']] = relationship('PublicSTPBanktable', uselist=True, foreign_keys='[PublicSTPBanktable.CreatedBy]', back_populates='public_SYSUsers')
    public_STPBanktable_: Mapped[List['PublicSTPBanktable']] = relationship('PublicSTPBanktable', uselist=True, foreign_keys='[PublicSTPBanktable.ModifiedBy]', back_populates='public_SYSUsers_')
    public_STPCardTypes: Mapped[List['PublicSTPCardTypes']] = relationship('PublicSTPCardTypes', uselist=True, foreign_keys='[PublicSTPCardTypes.CreatedBy]', back_populates='public_SYSUsers')
    public_STPCardTypes_: Mapped[List['PublicSTPCardTypes']] = relationship('PublicSTPCardTypes', uselist=True, foreign_keys='[PublicSTPCardTypes.ModifiedBy]', back_populates='public_SYSUsers_')
    public_STPCards: Mapped[List['PublicSTPCards']] = relationship('PublicSTPCards', uselist=True, foreign_keys='[PublicSTPCards.CreatedBy]', back_populates='public_SYSUsers')
    public_STPCards_: Mapped[List['PublicSTPCards']] = relationship('PublicSTPCards', uselist=True, foreign_keys='[PublicSTPCards.ModifiedBy]', back_populates='public_SYSUsers_')
    ...
    public_FINExpenseLedger: Mapped[List['PublicFINExpenseLedger']] = relationship('PublicFINExpenseLedger', uselist=True, foreign_keys='[PublicFINExpenseLedger.CreatedBy]', back_populates='public_SYSUsers')
    public_FINExpenseLedger_: Mapped[List['PublicFINExpenseLedger']] = relationship('PublicFINExpenseLedger', uselist=True, foreign_keys='[PublicFINExpenseLedger.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPBanktable: Mapped[List['PublicSTPBanktable']] = relationship('PublicSTPBanktable', uselist=True, foreign_keys='[PublicSTPBanktable.OrganizationId]', back_populates='public_STPOrganization')
    public_STPBanktable_: Mapped[List['PublicSTPBanktable']] = relationship('PublicSTPBanktable', uselist=True, foreign_keys='[PublicSTPBanktable.SubOrganizationId]', back_populates='public_STPOrganization_')
    public_STPCardTypes: Mapped[List['PublicSTPCardTypes']] = relationship('PublicSTPCardTypes', uselist=True, foreign_keys='[PublicSTPCardTypes.OrganizationId]', back_populates='public_STPOrganization')
    public_STPCardTypes_: Mapped[List['PublicSTPCardTypes']] = relationship('PublicSTPCardTypes', uselist=True, foreign_keys='[PublicSTPCardTypes.SubOrganizationId]', back_populates='public_STPOrganization_')
    public_STPCards: Mapped[List['PublicSTPCards']] = relationship('PublicSTPCards', uselist=True, foreign_keys='[PublicSTPCards.OrganizationId]', back_populates='public_STPOrganization')
    public_STPCards_: Mapped[List['PublicSTPCards']] = relationship('PublicSTPCards', uselist=True, foreign_keys='[PublicSTPCards.SubOrganizationId]', back_populates='public_STPOrganization_')
    ...
    public_FINExpenseLedger: Mapped[List['PublicFINExpenseLedger']] = relationship('PublicFINExpenseLedger', uselist=True, foreign_keys='[PublicFINExpenseLedger.OrganizationId]', back_populates='public_STPOrganization')
    public_FINExpenseLedger_: Mapped[List['PublicFINExpenseLedger']] = relationship('PublicFINExpenseLedger', uselist=True, foreign_keys='[PublicFINExpenseLedger.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicFINLedgerAccount(Base):
    ...
    public_FINExpenseLedger: Mapped[List['PublicFINExpenseLedger']] = relationship('PublicFINExpenseLedger', uselist=True, back_populates='public_FINLedgerAccount')


class PublicSTPBanktable(Base):
    __tablename__ = 'public.STPBanktable'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPBanktable_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPBanktable_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPBanktable_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPBanktable_fk3'),
        PrimaryKeyConstraint('RecId', name='STPBanktable_pk'),
        UniqueConstraint('AccountNumber', name='public.STPBanktable_AccountNumber_key'),
        UniqueConstraint('BankId', name='public.STPBanktable_BankId_key'),
        UniqueConstraint('BranchName', name='public.STPBanktable_BranchName_key'),
        Index('Bank_BankId_index', 'BankId', 'OrganizationId', 'SubOrganizationId', unique=True)
    )

    BankId = mapped_column(String(30), nullable=False)
    BankName = mapped_column(String(30), nullable=False)
    AccountNumber = mapped_column(String(40), nullable=False)
    BranchName = mapped_column(String(40), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    BranchAddress = mapped_column(String(300))
    CreatedDatetime = mapped_column(DateTime)
    ModifiedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedBy = mapped_column(String(20))
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPBanktable')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPBanktable_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPBanktable')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPBanktable_')
    public_STPCards: Mapped[List['PublicSTPCards']] = relationship('PublicSTPCards', uselist=True, back_populates='public_STPBanktable')


class PublicSTPCardTypes(Base):
    __tablename__ = 'public.STPCardTypes'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPCardTypes_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPCardTypes_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPCardTypes_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPCardTypes_fk3'),
        PrimaryKeyConstraint('RecId', name='STPCardTypes_pk'),
        UniqueConstraint('CardTypeId', name='public.STPCardTypes_CardTypeId_key')
    )

    CardTypeId = mapped_column(String(30), nullable=False)
    CardTypeName = mapped_column(String(30), nullable=False)
    Description = mapped_column(String(250), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    CreatedDatetime = mapped_column(DateTime)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPCardTypes')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPCardTypes_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPCardTypes')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPCardTypes_')
    public_STPCards: Mapped[List['PublicSTPCards']] = relationship('PublicSTPCards', uselist=True, back_populates='public_STPCardTypes')


class PublicSTPCards(Base):
    __tablename__ = 'public.STPCards'
    __table_args__ = (
        ForeignKeyConstraint(['BankId'], ['public.STPBanktable.BankId'], name='EMPCards_fk1'),
        ForeignKeyConstraint(['CardTypeId'], ['public.STPCardTypes.CardTypeId'], name='EMPCards_fk0'),
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='EMPCards_fk3'),
        ForeignKeyConstraint(['EmployeeId'], ['public.EMPEmployees.Id'], name='EMPCards_fk2'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='EMPCards_fk4'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPCards_fk5'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPCards_fk6'),
        PrimaryKeyConstraint('RecId', name='EMPCards_pk'),
        UniqueConstraint('CardId', name='public.STPCards_CardId_key'),
        UniqueConstraint('CardNumber', name='public.STPCards_CardNumber_key')
    )

    CardId = mapped_column(String(30), nullable=False)
    CardNumber = mapped_column(String(40), nullable=False)
    CardTypeId = mapped_column(String(30), nullable=False)
    BankId = mapped_column(String(30), nullable=False)
    ...
    public_STPBanktable: Mapped['PublicSTPBanktable'] = relationship('PublicSTPBanktable', back_populates='public_STPCards')
    public_STPCardTypes: Mapped['PublicSTPCardTypes'] = relationship('PublicSTPCardTypes', back_populates='public_STPCards')
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPCards')
    public_EMPEmployees: Mapped['PublicEMPEmployees'] = relationship('PublicEMPEmployees', back_populates='public_STPCards')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPCards_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPCards')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPCards_')
    public_FINExpenseLedger: Mapped[List['PublicFINExpenseLedger']] = relationship('PublicFINExpenseLedger', uselist=True, back_populates='public_STPCards')
...
class PublicEXPExpenseCategory(Base):
    ...
    public_FINExpenseLedger: Mapped[List['PublicFINExpenseLedger']] = relationship('PublicFINExpenseLedger', uselist=True, back_populates='public_EXPExpenseCategory')


class PublicFINExpenseLedger(Base):
    __tablename__ = 'public.FINExpenseLedger'
    __table_args__ = (
        ForeignKeyConstraint(['CardId'], ['public.STPCards.CardId'], name='FINExpenseLedger_fk3'),
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='FINExpenseLedger_fk4'),
        ForeignKeyConstraint(['EmployeeId'], ['public.EMPEmployees.Id'], name='FINExpenseLedger_fk1'),
        ForeignKeyConstraint(['ExpenseCategoryId'], ['public.EXPExpenseCategory.CategoryId'], name='FINExpenseLedger_fk2'),
        ForeignKeyConstraint(['LedgerAccountId'], ['public.FINLedgerAccount.LedgerAccountId'], name='FINExpenseLedger_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='FINExpenseLedger_fk5'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='FINExpenseLedger_fk6'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='FINExpenseLedger_fk7'),
        PrimaryKeyConstraint('RecId', name='FINExpenseLedger_pk'),
        UniqueConstraint('ExpenseLedgerId', name='public.FINExpenseLedger_ExpenseLedgerId_key'),
        Index('Ledger_EmployeeId_index', 'EmployeeId', 'OrganizationId', 'SubOrganizationId'),
        Index('Ledger_ExpenseCategoryId_index', 'ExpenseCategoryId', 'OrganizationId', 'SubOrganizationId'),
        Index('Ledger_LedgerAccountId_index', 'LedgerAccountId', 'OrganizationId', 'SubOrganizationId')
    )

    LedgerAccountId = mapped_column(String(40), nullable=False)
    EmployeeId = mapped_column(String(20), nullable=False)
    ExpenseDate = mapped_column(Date, nullable=False)
    Source = mapped_column(String(100), nullable=False)
    ReferenceId = mapped_column(String(20), nullable=False)
    ExpenseCategoryId = mapped_column(String(30), nullable=False)
    CardId = mapped_column(String(30), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    ExpenseLedgerId = mapped_column(String(20), server_default=text("('EL-'::text || (nextval('expenseledger_id_seq'::regclass))::text)"))
    DebitAmount = mapped_column(Double(53))
    CreditAmount = mapped_column(Double(53))
    ...
    public_STPCards: Mapped['PublicSTPCards'] = relationship('PublicSTPCards', back_populates='public_FINExpenseLedger')
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_FINExpenseLedger')
    public_EMPEmployees: Mapped['PublicEMPEmployees'] = relationship('PublicEMPEmployees', back_populates='public_FINExpenseLedger')
    public_EXPExpenseCategory: Mapped['PublicEXPExpenseCategory'] = relationship('PublicEXPExpenseCategory', back_populates='public_FINExpenseLedger')
    public_FINLedgerAccount: Mapped['PublicFINLedgerAccount'] = relationship('PublicFINLedgerAccount', back_populates='public_FINExpenseLedger')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_FINExpenseLedger_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_FINExpenseLedger')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_FINExpenseLedger_')
