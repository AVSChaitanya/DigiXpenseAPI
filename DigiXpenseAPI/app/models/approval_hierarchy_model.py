...
class PublicEMPEmployees(Base):
    ...
    public_SYSApprovalHierarchy: Mapped[List['PublicSYSApprovalHierarchy']] = relationship('PublicSYSApprovalHierarchy', uselist=True, back_populates='public_EMPEmployees')
...
class PublicSTPDimensionValues(Base):
    ...
    public_SYSApprovalHierarchy: Mapped[List['PublicSYSApprovalHierarchy']] = relationship('PublicSYSApprovalHierarchy', uselist=True, back_populates='public_STPDimensionValues')
...
class PublicSYSUsers(Base):
    ...
    public_SYSApprovalHierarchy: Mapped[List['PublicSYSApprovalHierarchy']] = relationship('PublicSYSApprovalHierarchy', uselist=True, foreign_keys='[PublicSYSApprovalHierarchy.CreatedBy]', back_populates='public_SYSUsers')
    public_SYSApprovalHierarchy_: Mapped[List['PublicSYSApprovalHierarchy']] = relationship('PublicSYSApprovalHierarchy', uselist=True, foreign_keys='[PublicSYSApprovalHierarchy.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_SYSApprovalHierarchy: Mapped[List['PublicSYSApprovalHierarchy']] = relationship('PublicSYSApprovalHierarchy', uselist=True, foreign_keys='[PublicSYSApprovalHierarchy.OrganizationId]', back_populates='public_STPOrganization')
    public_SYSApprovalHierarchy_: Mapped[List['PublicSYSApprovalHierarchy']] = relationship('PublicSYSApprovalHierarchy', uselist=True, foreign_keys='[PublicSYSApprovalHierarchy.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicEXPExpenseCategory(Base):
    ...
    public_SYSApprovalHierarchy: Mapped[List['PublicSYSApprovalHierarchy']] = relationship('PublicSYSApprovalHierarchy', uselist=True, back_populates='public_EXPExpenseCategory')


class PublicSYSApprovalHierarchy(Base):
    __tablename__ = 'public.SYSApprovalHierarchy'
    __table_args__ = (
        ForeignKeyConstraint(['ApproverId'], ['public.EMPEmployees.Id'], name='SYSApprovalHierarchy_fk1'),
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='SYSApprovalHierarchy_fk3'),
        ForeignKeyConstraint(['DimensionValueId'], ['public.STPDimensionValues.DimensionValueId'], name='SYSApprovalHierarchy_fk0'),
        ForeignKeyConstraint(['ExpenseCategoryID'], ['public.EXPExpenseCategory.CategoryId'], name='SYSApprovalHierarchy_fk2'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='SYSApprovalHierarchy_fk4'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSApprovalHierarchy_fk5'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='SYSApprovalHierarchy_fk6'),
        PrimaryKeyConstraint('RecId', name='SYSApprovalHierarchy_pk'),
        UniqueConstraint('HierarchyId', name='public.SYSApprovalHierarchy_HierarchyId_key')
    )

    DimensionValueId = mapped_column(String(30), nullable=False)
    ApproverId = mapped_column(String(20), nullable=False)
    ExpenseCategoryID = mapped_column(String(30), nullable=False)
    level = mapped_column(Integer, nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    HierarchyId = mapped_column(String(20), server_default=text("('HIER-'::text || (nextval('approvalhierarchy_id_seq'::regclass))::text)"))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ...
    public_EMPEmployees: Mapped['PublicEMPEmployees'] = relationship('PublicEMPEmployees', back_populates='public_SYSApprovalHierarchy')
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_SYSApprovalHierarchy')
    public_STPDimensionValues: Mapped['PublicSTPDimensionValues'] = relationship('PublicSTPDimensionValues', back_populates='public_SYSApprovalHierarchy')
    public_EXPExpenseCategory: Mapped['PublicEXPExpenseCategory'] = relationship('PublicEXPExpenseCategory', back_populates='public_SYSApprovalHierarchy')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_SYSApprovalHierarchy_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_SYSApprovalHierarchy')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_SYSApprovalHierarchy_')
