...
class PublicSYSUsers(Base):
    ...
    public_EMPEmployeeBands: Mapped[List['PublicEMPEmployeeBands']] = relationship('PublicEMPEmployeeBands', uselist=True, foreign_keys='[PublicEMPEmployeeBands.CreatedBy]', back_populates='public_SYSUsers')
    public_EMPEmployeeBands_: Mapped[List['PublicEMPEmployeeBands']] = relationship('PublicEMPEmployeeBands', uselist=True, foreign_keys='[PublicEMPEmployeeBands.ModifiedBy]', back_populates='public_SYSUsers_')
    ...
    public_FINExpenseLimit: Mapped[List['PublicFINExpenseLimit']] = relationship('PublicFINExpenseLimit', uselist=True, foreign_keys='[PublicFINExpenseLimit.CreatedBy]', back_populates='public_SYSUsers')
    public_FINExpenseLimit_: Mapped[List['PublicFINExpenseLimit']] = relationship('PublicFINExpenseLimit', uselist=True, foreign_keys='[PublicFINExpenseLimit.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_EMPEmployeeBands: Mapped[List['PublicEMPEmployeeBands']] = relationship('PublicEMPEmployeeBands', uselist=True, foreign_keys='[PublicEMPEmployeeBands.OrganizationId]', back_populates='public_STPOrganization')
    public_EMPEmployeeBands_: Mapped[List['PublicEMPEmployeeBands']] = relationship('PublicEMPEmployeeBands', uselist=True, foreign_keys='[PublicEMPEmployeeBands.SubOrganizationId]', back_populates='public_STPOrganization_')
    ...
    public_FINExpenseLimit: Mapped[List['PublicFINExpenseLimit']] = relationship('PublicFINExpenseLimit', uselist=True, foreign_keys='[PublicFINExpenseLimit.OrganizationId]', back_populates='public_STPOrganization')
    public_FINExpenseLimit_: Mapped[List['PublicFINExpenseLimit']] = relationship('PublicFINExpenseLimit', uselist=True, foreign_keys='[PublicFINExpenseLimit.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicEMPEmployeeBands(Base):
    __tablename__ = 'public.EMPEmployeeBands'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='EMPEmployeeBands_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='EMPEmployeeBands_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmployeeBands_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmployeeBands_fk3'),
        PrimaryKeyConstraint('RecId', name='EMPEmployeeBands_pk'),
        UniqueConstraint('BandId', name='public.EMPEmployeeBands_BandId_key'),
        UniqueConstraint('BandName', name='public.EMPEmployeeBands_BandName_key'),
        Index('Bands_BandId_index', 'BandId', 'OrganizationId', 'SubOrganizationId')
    )

    BandId = mapped_column(String(30), nullable=False)
    BandName = mapped_column(String(30), nullable=False)
    Description = mapped_column(String(250), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    CreatedDatetime = mapped_column(DateTime)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_EMPEmployeeBands')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_EMPEmployeeBands_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_EMPEmployeeBands')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_EMPEmployeeBands_')
    public_FINExpenseLimit: Mapped[List['PublicFINExpenseLimit']] = relationship('PublicFINExpenseLimit', uselist=True, back_populates='public_EMPEmployeeBands')
...
class PublicEMPEmployeeGrades(Base):
    ...
    public_FINExpenseLimit: Mapped[List['PublicFINExpenseLimit']] = relationship('PublicFINExpenseLimit', uselist=True, back_populates='public_EMPEmployeeGrades')
...
class PublicEXPExpenseCategory(Base):
    ...
    public_FINExpenseLimit: Mapped[List['PublicFINExpenseLimit']] = relationship('PublicFINExpenseLimit', uselist=True, back_populates='public_EXPExpenseCategory')


class PublicFINExpenseLimit(Base):
    __tablename__ = 'public.FINExpenseLimit'
    __table_args__ = (
        ForeignKeyConstraint(['BandId'], ['public.EMPEmployeeBands.BandId'], name='FINExpenseLimit_fk1'),
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='FINExpenseLimit_fk3'),
        ForeignKeyConstraint(['ExpenseCategoryId'], ['public.EXPExpenseCategory.CategoryId'], name='FINExpenseLimit_fk0'),
        ForeignKeyConstraint(['GradeId'], ['public.EMPEmployeeGrades.GradeId'], name='FINExpenseLimit_fk2'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='FINExpenseLimit_fk4'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='FINExpenseLimit_fk5'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='FINExpenseLimit_fk6'),
        PrimaryKeyConstraint('RecId', name='FINExpenseLimit_pk'),
        UniqueConstraint('ExpenseLimitId', name='public.FINExpenseLimit_ExpenseLimitId_key'),
        Index('ExpenseLimit_BandId_index', 'BandId', 'OrganizationId', 'SubOrganizationId'),
        Index('ExpenseLimit_ExpenseCategoryId_index', 'ExpenseCategoryId', 'OrganizationId', 'SubOrganizationId'),
        Index('ExpenseLimit_GradeId_index', 'GradeId', 'OrganizationId', 'SubOrganizationId')
    )

    ExpenseCategoryId = mapped_column(String(30), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    ExpenseLimitId = mapped_column(String(20), server_default=text("('EL-'::text || (nextval('expenselimit_id_seq'::regclass))::text)"))
    BandId = mapped_column(String(30))
    GradeId = mapped_column(String(30))
    ExpenseMaxLimit = mapped_column(Double(53))
    ExpenseMinLimit = mapped_column(Double(53))
    CreatedBy = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ...
    public_EMPEmployeeBands: Mapped[Optional['PublicEMPEmployeeBands']] = relationship('PublicEMPEmployeeBands', back_populates='public_FINExpenseLimit')
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_FINExpenseLimit')
    public_EXPExpenseCategory: Mapped['PublicEXPExpenseCategory'] = relationship('PublicEXPExpenseCategory', back_populates='public_FINExpenseLimit')
    public_EMPEmployeeGrades: Mapped[Optional['PublicEMPEmployeeGrades']] = relationship('PublicEMPEmployeeGrades', back_populates='public_FINExpenseLimit')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_FINExpenseLimit_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_FINExpenseLimit')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_FINExpenseLimit_')
