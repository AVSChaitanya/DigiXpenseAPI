...
class PublicEMPEmployees(Base):
    ...
    public_EMPEmployeeGradeHistory: Mapped[List['PublicEMPEmployeeGradeHistory']] = relationship('PublicEMPEmployeeGradeHistory', uselist=True, back_populates='public_EMPEmployees')
...
class PublicSYSUsers(Base):
    ...
    public_EMPEmployeeGradeHistory: Mapped[List['PublicEMPEmployeeGradeHistory']] = relationship('PublicEMPEmployeeGradeHistory', uselist=True, foreign_keys='[PublicEMPEmployeeGradeHistory.CreatedBy]', back_populates='public_SYSUsers')
    public_EMPEmployeeGradeHistory_: Mapped[List['PublicEMPEmployeeGradeHistory']] = relationship('PublicEMPEmployeeGradeHistory', uselist=True, foreign_keys='[PublicEMPEmployeeGradeHistory.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_EMPEmployeeGradeHistory: Mapped[List['PublicEMPEmployeeGradeHistory']] = relationship('PublicEMPEmployeeGradeHistory', uselist=True, foreign_keys='[PublicEMPEmployeeGradeHistory.OrganizationId]', back_populates='public_STPOrganization')
    public_EMPEmployeeGradeHistory_: Mapped[List['PublicEMPEmployeeGradeHistory']] = relationship('PublicEMPEmployeeGradeHistory', uselist=True, foreign_keys='[PublicEMPEmployeeGradeHistory.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicEMPEmployeeGradeHistory(Base):
    __tablename__ = 'public.EMPEmployeeGradeHistory'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='EMPEmployeeGradeHistory_fk1'),
        ForeignKeyConstraint(['EmployeeId'], ['public.EMPEmployees.Id'], name='EMPEmployeeGradeHistory_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='EMPEmployeeGradeHistory_fk2'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmployeeGradeHistory_fk3'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmployeeGradeHistory_fk4'),
        PrimaryKeyConstraint('RecId', name='EMPEmployeeGradeHistory_pk'),
        UniqueConstraint('HistoryId', name='public.EMPEmployeeGradeHistory_HistoryId_key'),
        Index('GradeHistory_EmployeeId_index', 'EmployeeId', 'OrganizationId', 'SubOrganizationId'),
        Index('GradeHistory_GradeId_index', 'GradeId', 'OrganizationId', 'SubOrganizationId')
    )

    EmployeeId = mapped_column(String(20), nullable=False)
    GradeId = mapped_column(String(30), nullable=False)
    StartDate = mapped_column(Date, nullable=False)
    EndDate = mapped_column(Date, nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    HistoryId = mapped_column(String(20), server_default=text("('EGH-'::text || (nextval('employeegradehistory_id_seq'::regclass))::text)"))
    CreatedBy = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_EMPEmployeeGradeHistory')
    public_EMPEmployees: Mapped['PublicEMPEmployees'] = relationship('PublicEMPEmployees', back_populates='public_EMPEmployeeGradeHistory')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_EMPEmployeeGradeHistory_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_EMPEmployeeGradeHistory')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_EMPEmployeeGradeHistory_')
