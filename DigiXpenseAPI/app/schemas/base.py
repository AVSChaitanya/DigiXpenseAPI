...
SCHEMA_ERROR_MSG_TEMPLATES: dict[str, str] = {
    # Type Errors
    'type_error.arbitrary_type': 'expected to be {expected_arbitrary_type} Example of',
    ...
    'type_error.enum_instance': '{value} is not a valid enumeration instance',
    'type_error.enum': 'Value is not a valid enumeration member; allowed：{permitted}',
    ...
    'type_error.json': 'JSON The object must be a string, byte or byte array',
...
class SchemaBase(BaseModel):
    class Config:
        ...
        # Error message template is invalid for model nesting
