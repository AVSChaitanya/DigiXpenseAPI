...
class PublicSTPDimensionValues(Base):
    ...
    public_STPDimensionHierarchyLines: Mapped[List['PublicSTPDimensionHierarchyLines']] = relationship('PublicSTPDimensionHierarchyLines', uselist=True, foreign_keys='[PublicSTPDimensionHierarchyLines.ChildDimensionValueId]', back_populates='public_STPDimensionValues')
    public_STPDimensionHierarchyLines_: Mapped[List['PublicSTPDimensionHierarchyLines']] = relationship('PublicSTPDimensionHierarchyLines', uselist=True, foreign_keys='[PublicSTPDimensionHierarchyLines.ParentDimensionValueId]', back_populates='public_STPDimensionValues_')
...
class PublicSTPDimensions(Base):
    ...
    public_STPDimensionHierarchyLines: Mapped[List['PublicSTPDimensionHierarchyLines']] = relationship('PublicSTPDimensionHierarchyLines', uselist=True, back_populates='public_STPDimensions')
...
class PublicSYSUsers(Base):
    ...
    public_STPDimensionHierarchyLines: Mapped[List['PublicSTPDimensionHierarchyLines']] = relationship('PublicSTPDimensionHierarchyLines', uselist=True, foreign_keys='[PublicSTPDimensionHierarchyLines.CreatedBy]', back_populates='public_SYSUsers')
    public_STPDimensionHierarchyLines_: Mapped[List['PublicSTPDimensionHierarchyLines']] = relationship('PublicSTPDimensionHierarchyLines', uselist=True, foreign_keys='[PublicSTPDimensionHierarchyLines.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPDimensionHierarchyLines: Mapped[List['PublicSTPDimensionHierarchyLines']] = relationship('PublicSTPDimensionHierarchyLines', uselist=True, foreign_keys='[PublicSTPDimensionHierarchyLines.OrganizationId]', back_populates='public_STPOrganization')
    public_STPDimensionHierarchyLines_: Mapped[List['PublicSTPDimensionHierarchyLines']] = relationship('PublicSTPDimensionHierarchyLines', uselist=True, foreign_keys='[PublicSTPDimensionHierarchyLines.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSTPDimensionHierarchyLines(Base):
    __tablename__ = 'public.STPDimensionHierarchyLines'
    __table_args__ = (
        ForeignKeyConstraint(['ChildDimensionValueId'], ['public.STPDimensionValues.DimensionValueId'], name='STPDimensionHierachyLines_fk1'),
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPDimensionHierachyLines_fk2'),
        ForeignKeyConstraint(['DimensionId'], ['public.STPDimensions.DimensionId'], name='STPDimensionHierachyLines_fk6'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPDimensionHierachyLines_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPDimensionHierachyLines_fk4'),
        ForeignKeyConstraint(['ParentDimensionValueId'], ['public.STPDimensionValues.DimensionValueId'], name='STPDimensionHierachyLines_fk0'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPDimensionHierachyLines_fk5'),
        PrimaryKeyConstraint('RecId', name='STPDimensionHierachyLines_pk'),
        UniqueConstraint('DimensionHierarchyId', name='public.STPDimensionHierachyLines_DimensionHierarchyId_key'),
        Index('HierachyLines_DimensionId_index', 'DimensionId', 'OrganizationId', 'SubOrganizationId')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer, Sequence('public.STPDimensionHierachyLines_RecId_seq'))
    DimensionHierarchyId = mapped_column(String(20), server_default=text("('DH-'::text || (nextval('dimensionhierachylines_id_seq'::regclass))::text)"))
    ParentDimensionValueId = mapped_column(String(30))
    ChildDimensionValueId = mapped_column(String(30))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    ...
    DimensionName = mapped_column(String(120))
    SequenceNumber = mapped_column(String(120))
    IsManadatory = mapped_column(Boolean, server_default=text('true'))

    public_STPDimensionValues: Mapped[Optional['PublicSTPDimensionValues']] = relationship('PublicSTPDimensionValues', foreign_keys=[ChildDimensionValueId], back_populates='public_STPDimensionHierarchyLines')
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPDimensionHierarchyLines')
    public_STPDimensions: Mapped[Optional['PublicSTPDimensions']] = relationship('PublicSTPDimensions', back_populates='public_STPDimensionHierarchyLines')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPDimensionHierarchyLines_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPDimensionHierarchyLines')
    public_STPDimensionValues_: Mapped[Optional['PublicSTPDimensionValues']] = relationship('PublicSTPDimensionValues', foreign_keys=[ParentDimensionValueId], back_populates='public_STPDimensionHierarchyLines_')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPDimensionHierarchyLines_')
