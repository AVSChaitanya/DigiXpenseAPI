...
class PublicEMPEmployees(Base):
    ...
    public_EMPEmployeeCardAssignment: Mapped[List['PublicEMPEmployeeCardAssignment']] = relationship('PublicEMPEmployeeCardAssignment', uselist=True, back_populates='public_EMPEmployees')
...
class PublicSYSUsers(Base):
    ...
    public_EMPEmployeeCardAssignment: Mapped[List['PublicEMPEmployeeCardAssignment']] = relationship('PublicEMPEmployeeCardAssignment', uselist=True, foreign_keys='[PublicEMPEmployeeCardAssignment.CreatedBy]', back_populates='public_SYSUsers')
    public_EMPEmployeeCardAssignment_: Mapped[List['PublicEMPEmployeeCardAssignment']] = relationship('PublicEMPEmployeeCardAssignment', uselist=True, foreign_keys='[PublicEMPEmployeeCardAssignment.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_EMPEmployeeCardAssignment: Mapped[List['PublicEMPEmployeeCardAssignment']] = relationship('PublicEMPEmployeeCardAssignment', uselist=True, foreign_keys='[PublicEMPEmployeeCardAssignment.OrganizationId]', back_populates='public_STPOrganization')
    public_EMPEmployeeCardAssignment_: Mapped[List['PublicEMPEmployeeCardAssignment']] = relationship('PublicEMPEmployeeCardAssignment', uselist=True, foreign_keys='[PublicEMPEmployeeCardAssignment.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicSTPCards(Base):
    ...
    public_EMPEmployeeCardAssignment: Mapped['PublicEMPEmployeeCardAssignment'] = relationship('PublicEMPEmployeeCardAssignment', uselist=False, back_populates='public_STPCards')


class PublicEMPEmployeeCardAssignment(Base):
    __tablename__ = 'public.EMPEmployeeCardAssignment'
    __table_args__ = (
        ForeignKeyConstraint(['CardId'], ['public.STPCards.CardId'], name='EMPEmployeeCardAssignment_fk0'),
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='EMPEmployeeCardAssignment_fk2'),
        ForeignKeyConstraint(['EmployeeId'], ['public.EMPEmployees.Id'], name='EMPEmployeeCardAssignment_fk1'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='EMPEmployeeCardAssignment_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmployeeCardAssignment_fk4'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='EMPEmployeeCardAssignment_fk5'),
        PrimaryKeyConstraint('RecId', name='EMPEmployeeCardAssignment_pk'),
        UniqueConstraint('AssignmentId', name='public.EMPEmployeeCardAssignment_AssignmentId_key'),
        UniqueConstraint('CardId', name='public.EMPEmployeeCardAssignment_CardId_key'),
        Index('CardAssignment_CardId_index', 'CardId', 'OrganizationId', 'SubOrganizationId'),
        Index('CardAssignment_EmployeeId_index', 'EmployeeId', 'OrganizationId', 'SubOrganizationId')
    )
    ...
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    AssignmentId = mapped_column(String(20), server_default=text("('ASSIGN-'::text || (nextval('employeecardassignment_id_seq'::regclass))::text)"))
    AssignmentType = mapped_column(String(40))
    ...
    public_STPCards: Mapped['PublicSTPCards'] = relationship('PublicSTPCards', back_populates='public_EMPEmployeeCardAssignment')
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_EMPEmployeeCardAssignment')
    public_EMPEmployees: Mapped['PublicEMPEmployees'] = relationship('PublicEMPEmployees', back_populates='public_EMPEmployeeCardAssignment')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_EMPEmployeeCardAssignment_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_EMPEmployeeCardAssignment')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_EMPEmployeeCardAssignment_')
