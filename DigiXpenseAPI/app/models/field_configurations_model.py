...
class PublicSYSUsers(Base):
    ...
    public_STPFieldConfigurations: Mapped[List['PublicSTPFieldConfigurations']] = relationship('PublicSTPFieldConfigurations', uselist=True, foreign_keys='[PublicSTPFieldConfigurations.CreatedBy]', back_populates='public_SYSUsers')
    public_STPFieldConfigurations_: Mapped[List['PublicSTPFieldConfigurations']] = relationship('PublicSTPFieldConfigurations', uselist=True, foreign_keys='[PublicSTPFieldConfigurations.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPFieldConfigurations: Mapped[List['PublicSTPFieldConfigurations']] = relationship('PublicSTPFieldConfigurations', uselist=True, foreign_keys='[PublicSTPFieldConfigurations.OrganizationId]', back_populates='public_STPOrganization')
    public_STPFieldConfigurations_: Mapped[List['PublicSTPFieldConfigurations']] = relationship('PublicSTPFieldConfigurations', uselist=True, foreign_keys='[PublicSTPFieldConfigurations.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicSTPCustomFields(Base):
    ...
    public_STPFieldConfigurations: Mapped[List['PublicSTPFieldConfigurations']] = relationship('PublicSTPFieldConfigurations', uselist=True, back_populates='public_STPCustomFields')


class PublicSTPFieldConfigurations(Base):
    __tablename__ = 'public.STPFieldConfigurations'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPFieldConfigurations_fk1'),
        ForeignKeyConstraint(['FieldId'], ['public.STPCustomFields.FieldId'], name='STPFieldConfigurations_fk5'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPFieldConfigurations_fk2'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPFieldConfigurations_fk3'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPFieldConfigurations_fk4'),
        PrimaryKeyConstraint('RecId', name='STPFieldConfigurations_pk')
    )
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPFieldConfigurations')
    public_STPCustomFields: Mapped[Optional['PublicSTPCustomFields']] = relationship('PublicSTPCustomFields', back_populates='public_STPFieldConfigurations')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPFieldConfigurations_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPFieldConfigurations')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPFieldConfigurations_')
