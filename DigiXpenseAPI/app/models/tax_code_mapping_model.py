...
class PublicSYSUsers(Base):
    ...
    public_TAXTaxCodeMapping: Mapped[List['PublicTAXTaxCodeMapping']] = relationship('PublicTAXTaxCodeMapping', uselist=True, foreign_keys='[PublicTAXTaxCodeMapping.CreatedBy]', back_populates='public_SYSUsers')
    public_TAXTaxCodeMapping_: Mapped[List['PublicTAXTaxCodeMapping']] = relationship('PublicTAXTaxCodeMapping', uselist=True, foreign_keys='[PublicTAXTaxCodeMapping.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicTAXTaxGroupsGlobal(Base):
    ...
    public_TAXTaxCodeMapping: Mapped[List['PublicTAXTaxCodeMapping']] = relationship('PublicTAXTaxCodeMapping', uselist=True, back_populates='public_TAXTaxGroupsGlobal')
...
class PublicSTPOrganization(Base):
    ...
    public_TAXTaxCodeMapping: Mapped[List['PublicTAXTaxCodeMapping']] = relationship('PublicTAXTaxCodeMapping', uselist=True, foreign_keys='[PublicTAXTaxCodeMapping.OrganizationId]', back_populates='public_STPOrganization')
    public_TAXTaxCodeMapping_: Mapped[List['PublicTAXTaxCodeMapping']] = relationship('PublicTAXTaxCodeMapping', uselist=True, foreign_keys='[PublicTAXTaxCodeMapping.SubOrganizationId]', back_populates='public_STPOrganization_')
...
class PublicTAXTaxCodes(Base):
    ...
    public_TAXTaxCodeMapping: Mapped[List['PublicTAXTaxCodeMapping']] = relationship('PublicTAXTaxCodeMapping', uselist=True, back_populates='public_TAXTaxCodes')


class PublicTAXTaxCodeMapping(Base):
    __tablename__ = 'public.TAXTaxCodeMapping'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='TAXTaxCodeMapping_fk2'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='TAXTaxCodeMapping_fk3'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='TAXTaxCodeMapping_fk4'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='TAXTaxCodeMapping_fk5'),
        ForeignKeyConstraint(['TaxCodeId'], ['public.TAXTaxCodes.TaxCode'], name='TAXTaxCodeMapping_fk1'),
        ForeignKeyConstraint(['TaxGroupId'], ['public.TAXTaxGroupsGlobal.TaxGroupId'], name='TAXTaxCodeMapping_fk0'),
        PrimaryKeyConstraint('RecId', name='TAXTaxCodeMapping_pk'),
        Index('CodeMapping_TaxCodeId_index', 'TaxCodeId', 'OrganizationId', 'SubOrganizationId'),
        Index('CodeMapping_TaxGroupId_index', 'TaxGroupId', 'OrganizationId', 'SubOrganizationId')
    )

    TaxGroupId = mapped_column(String(20), nullable=False)
    TaxCodeId = mapped_column(String(20), nullable=False)
    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    CreatedBy = mapped_column(String(20))
    CreatedDatetime = mapped_column(DateTime)
    ...
    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_TAXTaxCodeMapping')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_TAXTaxCodeMapping_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_TAXTaxCodeMapping')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_TAXTaxCodeMapping_')
    public_TAXTaxCodes: Mapped['PublicTAXTaxCodes'] = relationship('PublicTAXTaxCodes', back_populates='public_TAXTaxCodeMapping')
    public_TAXTaxGroupsGlobal: Mapped['PublicTAXTaxGroupsGlobal'] = relationship('PublicTAXTaxGroupsGlobal', back_populates='public_TAXTaxCodeMapping')
