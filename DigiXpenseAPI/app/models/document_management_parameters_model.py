...
class PublicSYSUsers(Base):
    ...
    public_STPDocumentMgmtParameters: Mapped[List['PublicSTPDocumentMgmtParameters']] = relationship('PublicSTPDocumentMgmtParameters', uselist=True, foreign_keys='[PublicSTPDocumentMgmtParameters.CreatedBy]', back_populates='public_SYSUsers')
    public_STPDocumentMgmtParameters_: Mapped[List['PublicSTPDocumentMgmtParameters']] = relationship('PublicSTPDocumentMgmtParameters', uselist=True, foreign_keys='[PublicSTPDocumentMgmtParameters.ModifiedBy]', back_populates='public_SYSUsers_')
...
class PublicSTPOrganization(Base):
    ...
    public_STPDocumentMgmtParameters: Mapped[List['PublicSTPDocumentMgmtParameters']] = relationship('PublicSTPDocumentMgmtParameters', uselist=True, foreign_keys='[PublicSTPDocumentMgmtParameters.OrganizationId]', back_populates='public_STPOrganization')
    public_STPDocumentMgmtParameters_: Mapped[List['PublicSTPDocumentMgmtParameters']] = relationship('PublicSTPDocumentMgmtParameters', uselist=True, foreign_keys='[PublicSTPDocumentMgmtParameters.SubOrganizationId]', back_populates='public_STPOrganization_')


class PublicSTPDocumentMgmtParameters(Base):
    __tablename__ = 'public.STPDocumentMgmtParameters'
    __table_args__ = (
        ForeignKeyConstraint(['CreatedBy'], ['public.SYSUsers.UserId'], name='STPDocumentMgmtParameters_fk0'),
        ForeignKeyConstraint(['ModifiedBy'], ['public.SYSUsers.UserId'], name='STPDocumentMgmtParameters_fk1'),
        ForeignKeyConstraint(['OrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPDocumentMgmtParameters_fk2'),
        ForeignKeyConstraint(['SubOrganizationId'], ['public.STPOrganization.OrganizationId'], name='STPDocumentMgmtParameters_fk3'),
        PrimaryKeyConstraint('RecId', name='STPDocumentMgmtParameters_pk')
    )

    OrganizationId = mapped_column(Integer, nullable=False)
    RecId = mapped_column(Integer)
    AWSConnString = mapped_column(Text)
    AzureBlobConnString = mapped_column(Text)
    MaxfileSizeInDB_MB_ = mapped_column('MaxfileSizeInDB(MB)', String(500))
    MaxFileSizeInFileSystem_MB_ = mapped_column('MaxFileSizeInFileSystem(MB)', String(500))
    CreatedDatetime = mapped_column(DateTime)
    CreatedBy = mapped_column(String(20))
    ModifiedDatetime = mapped_column(DateTime)
    ModifiedBy = mapped_column(String(20))
    IsActive = mapped_column(Boolean, server_default=text('true'))
    SubOrganizationId = mapped_column(Integer)
    StorageType = mapped_column(Enum('DataBase', 'Local Storage', 'AWS Storage', 'Azure Blob', name='storagetype'))

    public_SYSUsers: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[CreatedBy], back_populates='public_STPDocumentMgmtParameters')
    public_SYSUsers_: Mapped[Optional['PublicSYSUsers']] = relationship('PublicSYSUsers', foreign_keys=[ModifiedBy], back_populates='public_STPDocumentMgmtParameters_')
    public_STPOrganization: Mapped['PublicSTPOrganization'] = relationship('PublicSTPOrganization', foreign_keys=[OrganizationId], back_populates='public_STPDocumentMgmtParameters')
    public_STPOrganization_: Mapped[Optional['PublicSTPOrganization']] = relationship('PublicSTPOrganization', foreign_keys=[SubOrganizationId], back_populates='public_STPDocumentMgmtParameters_')
